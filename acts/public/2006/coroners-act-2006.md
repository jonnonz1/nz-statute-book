...
The chief coroner's main function is to help to ensure the integrity and effectiveness of the coronial system provided for by this Act, and, in order to carry out his or her main function, the chief coroner has the following additional functions:
  ...
  (j) to perform the functions of a Head of Bench under the Judicial Conduct Commissioner and Judicial Conduct Panel Act 2004 in relation to the exercise by coroners (except for those who are District Court Judges) of the judicial authority conferred on them by this Act:
  (k) to provide coroners and others with general information and advice to help planning and preparation for—
    (i) an emergency (as defined in the Civil Defence Emergency Management Act 2002); and
...
In this Act, unless the context otherwise requires,—
  ...
  - **specified recommendations or comments** means, in relation to a death, recommendations or comments by the designated coroner on either or both of the following:
    ...
    (b) the way in which any person should act in circumstances of that kind
...
(2) In the following sections, coroner does not include the chief coroner:
  ...
  (c) section 107 (concurrent office or employment):
...
(1) The designated coroner has an exclusive right to custody of the body concerned—
  (a) from the time when a death has been reported to him or her under section 15(2)﻿(a) or section 16(2)﻿(b); and
...
(1) This section applies to a body if—
  (a) a death has been reported to a coroner under section 15(2)﻿(a) or section 16(2)﻿(b); and
...
(2) No part or sample referred to in sections 53, 55, or 56 may be returned or disposed of under that section unless—
...
The Coroners Act 1988 is amended in the manner indicated in Schedule 1.
...
## Schedule 1 — Amendments to Coroners Act 1988 effective day after assent
