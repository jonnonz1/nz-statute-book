...
In this Act, unless the context otherwise requires,—
  ...
  - **holder of an authority** means the person to whom an authority is granted under section 14; and has a corresponding meaning
...
(1) Any person wanting to destroy, damage, or modify the whole or any part of—may, instead of making an application under section 11, make an application under this section for the grant of a general authority under section 14.
...
(2) Where the Trust has imposed a condition of a kind referred to in subsection (1), then, unless the Trust determines otherwise in any particular case, the authority shall not be exercised by the holder until the Trust has been advised in writing by that holder of the completion of the on-site archaeological investigation, and either—whichever is the later.
