...
Every territorial authority has power—
  ...
  (da) to the extent only that a national pest management plan or a national pathway management plan provides for—to make contributions towards the costs of the implementation of the plan, to make such contributions (from the authority's general funds or from any fund dedicated for the purpose):
...
(6) The application is made under section 291 of the Resource Management Act 1991 and regulations made under that Act.
