...
(1) After section BC 7(3), the following is added:Income tax liability of multi-rate PIEs
...
(1) Section BE 1(1) is replaced by the following:PAYE income payments
  (1) A person who makes a PAYE income payment must withhold an amount from the payment under the PAYE rules.
(2) Section BE 1(5) is replaced by the following:Employer's superannuation cash contributions
...
(1) Section CB 26 is replaced by the following:Disposal of certain shares by portfolio investment entitiesWhen this section appliesIncomeDefinition of items in formulaPositive result Defined in this Act: amount, company, dividend, excluded income, fully imputed, ICA company, income, pay, portfolio investment entity, share2007 No 97 s CB 26.
...
The heading before section CB 36 and section CB 36 are replaced by the following:Emissions units under Climate Change Response Act 2002Disposal of emissions unitsWhen this section appliesIncomeSurrender of unit: deemed sale at given valueSurrender of unit: emissions relating to post-1989 forest landSurrender of unit: deforestation of some pre-1990 forest landSurrender of post-1989 forest land unit: emissions not relating to post-1989 forest land Surrender of unit: free unit other than forest land unit Converted unit treated as soldExcluded income: post-1989 forest land emissions unitDefined in this Act: amount, convert, emissions unit, forest land emissions unit, income, Kyoto emissions unit, New Zealand emissions unit, pre-1990 forest land emissions unit, post-1989 forest land emissions unit, surrender.
...
(1) After section CC 8, the following is inserted:Certain commercial bills: non-resident holdersWhen this section appliesIncome: disposalIncome: redemptionDefined in this Act: amount, commercial bill, financial arrangements rules, income, non-resident, old financial arrangements rules2004 No 35 s CZ 8.
...
(1) After section CD 5(2), the following is added:When shares are cancelled
...
(3) After section CD 36(b), the following are inserted as subsections (2) and (3):Exclusion for interests in grey list companies Application of rule for certain managed funds
...
(1) After section CD 44(10) the following is inserted:Associated persons transactionsClose company liquidations
...
(3) After section CD 44(14), the following is inserted:Relationship with section CZ 9B
...
(1) Section CD 53(3), is replaced by the following:Non-taxable dividends
...
(3) After section CE 1(g), the following is inserted as subsection (2):Meaning of accommodation
...
(1) After section CH 10, the following is inserted:Income from voluntary activitiesIncome from voluntary activitiesIncomeRelationship with section CW 62BDefined in this Act: amount, income.
...
(1) Section CP 1 is replaced by the following:Attributed income of investors in multi-rate PIEsWhen this section appliesIncomeDefined in this Act: amount, income, income year, investor, multi-rate PIE, PIE2007 No 97 s CP 1.
...
(3) After section CQ 2(2), the following is inserted:Special rule: attributed CFC amount from personal services
...
(1) Section CQ 5(3) is replaced by the following:FIF income from CFC with FIF interest
...
(1) Sections CR 1 and CR 2 are replaced by the following:Policyholder base income of life insurerDefined in this Act: amount, income, income year, life insurer, policyholder base incomeShareholder base income of life insurerDefined in this Act: amount, income, income year, life insurer, shareholder base income.
...
(1) After section CR 3, the following is added:Income for general insurance outstanding claims reserveWhat this section applies toFormula for insurer's OCR incomeDefinition of items in formulaDefined in this Act: amount, general insurance contract, IFRS 4, income, income year, insurer, life insurer, outstanding claims reserve.
...
(2) After section CW 9(2), the following is added:Non-application to dividends derived by certain PIEs
  (3) This section does not apply to a dividend derived by a portfolio tax rate entity.
(3) Section CW 9 is replaced by the following:Dividend derived from foreign companyExempt incomeExclusionsNon-application to dividends derived by certain PIEsDefined in this Act: company, dividend, deductible foreign equity distribution, exempt income, fixed-rate foreign equity, portfolio tax rate entity, resident in New Zealand.
  (1) A dividend from a foreign company is exempt income if derived by a company that is resident in New Zealand.
...
(1) After section CW 17(3), the following is added:Depreciation loss includedRelationship with sections CW 17B and CW 17C
...
After section CW 17, the following are inserted:Relocation paymentsExempt incomeActual expenditureTime limitMeaning of work-related relocationExemption from distance testDeterminationsDefined in this Act: amount, Commissioner, employee, employer, exempt income, tax year, work-related relocationPayments for overtime meals and certain other allowancesExempt income: overtime mealsExempt income: certain sustenance allowancesEligibility requirements: overtime mealsEligibility requirements: sustenance allowancesActual cost or reasonable estimateMeaning of overtimeDefined in this Act: amount, employee, employer, exempt income, overtime, pay.
...
Insection CW 42(5), (7), (8), and (9), subsection (1)(b) is replaced by subsection (1)(c).

### 49 New section CW 59C inserted
(1) After section CW 59B, the following is inserted:Life reinsurance outside New ZealandDefined in this Act: amount, claim, deduction, exempt income, income, life insurer, life reinsurance, life reinsurance policy, New Zealand, premium.
...
(1) After section CW 62, the following is inserted:Voluntary activitiesExempt incomeEstimated expenditurePayments partly reimbursement and partly honorariumWho is a volunteer?HonorariaNature of reimbursement paymentRelationship with section RD 8(3)Defined in this Act: amount, exempt income, honorarium, income year, New Zealand, pay, PAYE rules, schedular payment, volunteer.
...
(1) Section CX 28 is replaced by the following:AccommodationDefined in this Act: accommodation, employee, employer, employment, fringe benefit.
...
(2) Section CX 47(3) is replaced by the following:Exclusion
...
Before section CX 49, the following is inserted:Government funding of film and televisionGovernment funding additional to government screen production paymentsWhen this section appliesExcluded incomeDefined in this Act: excluded income, government screen production payment, grant-related suspensory loan, pay, public authority.
...
(1) After section CX 48C, the following is inserted:Research and developmentTax credits for expenditure on research and developmentDefined in this Act: amount, excluded income, tax credit.
...
After section CX 51, the following is inserted:Emissions units under Climate Change Response Act 2002Disposal of pre-1990 forest land emissions unitsWho this section applies toExcluded income: disposalDefined in this Act: amount, emissions unit, excluded income, income, pre-1990 forest land, pre-1990 forest land emissions unit, surrender.
...
(1) Section CX 55 is replaced by the following:Proceeds from disposal of investment sharesWhat this section applies to Excluded incomeParticular company Non-participating redeemable shares Defined in this Act: actuarially determined, amount, arrangement, company, double tax agreement, excluded income, income year, life fund PIE, life insurer, non-participating redeemable share, policyholder base income, portfolio investment entity, resident in Australia, resident in New Zealand, share.
...
After section CX 56(3), the following is added:When trustees choose 19.5% portfolio investor rate
...
(1) Section CX 56 is replaced by the following:Attributed income of certain investors in multi-rate PIEsWhen this section appliesWhen this section does not applyExcluded incomeDefined in this Act: amount, attribution period, calculation period, excluded income, income, income tax liability, income year, investor, multi-rate PIE, pay, PIE, prescribed investor rate, quarterDistributions to investors in multi-rate PIEsDefined in this Act: amount, dividend, excluded income, income, investor, multi-rate PIEDistributions to investors by listed PIEsResident investorsImputed dividendsDefined in this Act: amount, dividend, excluded income, income year, investor, listed PIE, PIE, resident, return of income, trustee.
...
(1) Section CX 57 is replaced by the following:Credits for investment feesWhen this section appliesExcluded incomeDefined in this Act: amount, excluded income, investor, investor class, multi-rate PIE, PIE.
  (1) This section applies when—
...
After section CZ 9, the following is inserted:Available capital distribution amount: 1988 to 2010When this section appliesRelated person transactionsMeaning of related personLook-through relatives and nomineesLook-through interposed companiesDefined in this Act: amount, close company, company, liquidation, related person, share, shareholder, trustee.
...
After section DB 10, the following is inserted:Interest or expenditure connected to stapled debt securityNo deductionRelationship with sections DB 5 to DB 8Link with subpart DADefined in this Act: deduction, general permission, interest, pay, stapled debt security.
...
(1) Section DB 53 is replaced by the following:Attributed PIE losses of certain investors When this section appliesDeductionLink with subpart DA Defined in this Act: amount, attributed PIE loss, attribution period, deduction, exit period, general limitation, general permission, income tax liability, income year, investor, multi-rate PIE, PIE, quarter, tax year, zero-rated investor2007 No 97 s DB 53.
...
(1) Section DB 54 is replaced by the following:Treatment of credits for investment feesWhen this section appliesNo deductionLink with subpart DA Defined in this Act: amount, deduction, general permission, investor, investor class, investor interest, multi-rate PIE2007 No 97 s DB 54.
...
(1) Section DB 55(1) and (2) are replaced by the following:Deduction
...
The heading after section DB 59 and section DB 60 are replaced by the following:Emissions units and liabilities under Climate Change Response Act 2002Acquisition of emissions unitsWhen this section appliesNo deductionLink with subpart DADefined in this Act: amount, emissions unit, general permission, loss.
...
(1) After section DB 60, the following is inserted:Liabilities for emissionsWhen this section appliesNo deductionLink with subpart DADefined in this Act: amount, deduction, general permission, post-1989 forest land, pre-1990 forest land.
...
After section DF 4, the following is added:Government funding additional to government screen production paymentsWhen this section appliesNo deduction for expenditureDeduction for payments to public authorityLinks with subpart DADefined in this Act: capital limitation, deduction, excluded income, general limitation, general permission, government screen production payment, grant-related suspensory loan, pay, public authority.
...
(2) Section DN 2(f) and (g) are replaced by the following:
  ...
  (h) the CFC is not a non-attributing active CFC for the accounting period, under section EX 21B (Non-attributing active CFCs); and
  (i) the CFC is not a non-attributing Australian CFC for the accounting period, under section EX 22 (Non-attributing Australian CFCs).
(3) After section DN 2(i), the following is added as subsection (2):Special rule: Attributable CFC amount from personal services
...
(1) Section DN 6(3) is replaced by the following:FIF loss from CFC with FIF interest
...
(1) Sections DR 1 to DR 3 are replaced by the following:Policyholder base allowable deduction of life insurerDeductionNo cross-deducting: section EY 2Link with subpart DADefined in this Act: amount, deduction, general permission, income year, life fund PIE, life insurer, multi-rate PIE, policyholder base allowable deduction, policyholder base income, shareholder base incomeShareholder base allowable deduction of life insurerDeductionNo cross-deductingLink with subpart DADefined in this Act: amount, deduction, general permission, income year, life insurer, policyholder base income, shareholder base allowable deductionLife reinsurance outside New ZealandNo deductionDefined in this Act: amount, deduction, general permission, income year, life insurer, life reinsurance, life reinsurance policy, New ZealandLife insurers' claims reservesNo deduction on account of claimsDeduction for payments of current claimsLink with subpart DADefined in this Act: claim, deduction, general limitation, general permission, life insurance policy, life insurer.
...
(1) Section DS 2(4) is replaced by the following:Timing of deduction
...
(1) Before section DT 1, the following is inserted:Ring-fenced allocationsWhen this section appliesBasis for allocation of deductionsExcess allocations: carried forward and re-instated next yearRestriction on reinstating excess allocationsDefined in this Act: deduction, income year, loss balance, New Zealand, petroleum development expenditure, petroleum exploration expenditure, petroleum mining operation, residual expenditure, tax loss component.
...
(1) Section DT 5(1) and (2) is replaced by the following:DeductionTiming of deduction
...
(2) Section DV 2(6), other than the heading, is replaced by the following:
  (6) The expenditure is treated as being incurred by the master superannuation fund as follows:
    ...
    (b) for other master funds, in the same income year as that in which it was incurred by the member superannuation fund.
(3) After section DV 2(8), the following is inserted:Amount of deduction when master fund is portfolio tax rate entity
...
(1) After section DV 4(1), the following is inserted:What this section does not apply to
...
(2) Section DV 4(1B) is replaced by the following:What this section does not apply to
...
(1) After section DV 4, the following is inserted:Carry forward of expenditure by member funds investing in portfolio investment entitiesWhen this section appliesMember fund carrying expenditure forwardExpenditure as loss balanceDefined in this Act: amount, deduction, income year, loss balance, master fund, portfolio tax rate entity, tax year.
  (1) This section applies when—
...
(2) Section DV 4B is replaced by the following:Carry forward of expenditure by member funds investing in portfolio investment entitiesWhen this section appliesMember fund carrying expenditure forwardExpenditure as loss balanceDefined in this Act: amount, deduction, income year, loss balance, master fund, multi-rate PIE, tax year.
  (1) This section applies when—
...
(1) After section DV 5(7), the following is inserted:Amount of deduction when master fund is portfolio tax rate entity
...
(2) Section DV 5(7B) is replaced by the following:Amount of deduction when master fund is multi-rate PIE
...
(1) After section DV 6(4), the following is added:Portfolio tax rate entities
...
(2) Section DV 6(5) is replaced by the following:Multi-rate PIEs
...
(1) Section DV 7(1) is replaced by the following:When this section appliesMember fund carrying expenditure forward
...
(1) After section DW 3, the following is added:Deduction for general insurance outstanding claims reserveWhen this section appliesNo deduction on account of claimsFormula for insurer's OCR deductionDefinition of items in formulaDeduction for payments of current claimsLink with subpart DADefined in this Act: amount, deduction, general insurance contract, general limitation, general permission, IFRS 4, income year, insurer, life insurer, outstanding claims reserve.
  (1) This section applies for—
    (a) an insurer who––
      (i) uses IFRS 4, Appendix D for general insurance contracts:
      (ii) is a life insurer who has general insurance contracts; and
...
(1) After section EC 26, the following is inserted:Partnerships: cost price and national standard cost schemeEntering partners' cost baseWhen this section appliesExisting cost baseAddition to cost baseDefinition of items in formulaDefined in this Act: amount, cost price, dispose, income year, national standard cost scheme, partner, partner's interest, specified livestock.
...
(1) Section ED 1(5B) is replaced by the following:Certain emissions units not pooled with other types of emissions unitExceptions: types of emissions units pooled with other types
...
(2) After section ED 1(7), the following is inserted:Valuation of emissions units issued for zero price
...
After section ED 1, the following is inserted:Valuation of emissions units issued for zero priceWhat this section applies toValue at end of income yearValue if emissions unit period ends after end of income yearFormula based on emissionsDefinition of items in formulaHeld unitsIssued unitsRemaining quantityTotal quantityDefined in this Act: emissions unit, income year.
...
(1) Section EE 21(5) to (8) are replaced by the following:Starting adjusted tax valueEnding adjusted tax valueMonths
...
(1) Section EJ 12 is replaced by the following:Petroleum development expenditure: default allocation ruleWhen this section appliesDefault allocation ruleRelationship with other petroleum mining provisionsDefined in this Act: amount, deduction, income year, permit area, petroleum development expenditure, petroleum miner, petroleum mining developmentPetroleum development expenditure: reserve depletion methodWhen this section appliesChoice: first year of commercial production and later yearsReserve depletion method expense allocation ruleDefinition of items in formulaReserve expenditurePrevious expenditureReserve depletion for the yearProbable reservesRelationship with other petroleum mining provisionsDefined in this Act: amount, deduction, income year, permit area, petroleum development expenditure, petroleum miner, petroleum mining development.
...
(1) After section EJ 13, the following is inserted:Dry well drilledWhen this section appliesAllocationDefined in this Act: amount, deduction, income year, petroleum development expenditureWell not producingWhen this section appliesAllocationDefined in this Act: amount, deduction, income year, petroleum development expenditure.
  (1) This section applies when—
...
(1) Sections EJ 19 and EJ 20 are replaced by the following:Meaning of petroleum mining developmentMeaningActivities: inclusionsActivities: exclusionsDefined in this Act: permit area, petroleum, removal or restoration operations.
...
(2) Section EW 5(3B) is replaced by the following:Emissions unitNon-Kyoto greenhouse gas unit
...
After section EW 15B(2), the following is added:Functional currencyFinancial statements
...
(3) After section EW 15D(2), the following is inserted:Fair value method not used for certain financial arrangements
...
(4) After section EW 15E(3), the following is added:Modifications
...
(3) After section EW 15F(1), the following is inserted:Exception for some group members and financial arrangements
...
(3) After section EW 15G(1), the following is inserted:Exception for some group members and financial arrangements
...
(5) After section EW 15G(2), the following is inserted:Some financial arrangements with amounts allocated to equity reserves
...
After section EW 20, the following is inserted:Financial reporting methodDefined in this Act: amount, Commissioner, financial arrangement, income year.
...
(2) After section EW 25B(3), the following is added:Modification
...
(1) After the heading before section EX 18, the following is inserted:Scheme for finding person's attributed CFC income or lossFormula and rules for calculationDetermination of attributed CFC income or loss from attributable CFC amountNon-attributing active CFCsDefined in this Act: accounting period, attributable CFC amount, attributed CFC income, attributed CFC loss, CFC, non-attributing active CFC, non-attributing Australian CFC.
...
(1) After section EX 20, the following is inserted:Attributable CFC amount and net attributable CFC income or lossAttributable CFC amountAttributable CFC amountDefinition of items in formulaGrossArrangement incomeAttributable CFC amount: royaltiesAttributable CFC amount: rentAttributable CFC amount: exclusions from rentAttributable CFC amount: income from life insurance contractAttributable CFC amount: income from personal servicesExclusions from attributable CFC amount: sharesExclusions from attributable CFC amount: telecommunications services in New ZealandExclusions from attributable CFC amount: income from financial arrangements other than derivative instrumentsRoyalties: property linked to New ZealandSituations creating link with New ZealandSituations breaking link with New ZealandDefined in this Act: accounting period, agreement for the sale or purchase of property or services, associated, associated non-attributing active CFC, attributable CFC amount, business, CFC, comparative value method, deductible foreign equity distribution, deduction, deemed rate of return method, depreciable property, derivative instrument, dividend, exempt income, fair dividend rate method, finance lease, financial arrangement, fixed-rate foreign equity, fully imputed, general insurance, hire purchase agreement, income, insurance contract, interest, land, life insurance, life insurance policy, loan, loss, money lent, New Zealand, New Zealand resident, non-attributing active CFC, non-resident, reinsurance contract, relative, resident in New Zealand, revenue account property, royalty, share, short-term agreement for sale and purchase, telecommunications serviceNet attributable CFC income or lossCFC's net attributable CFC income or lossFormula for net attributable CFC income or lossDefinition of items in formulaAttributable CFCLimited funding costsDefinition of items in formulaFinancial arrangements and shares contributing to funding costsFractionOther deductionsProportion by value of assets producing attributable CFC amountDefinition of items in formulaDetermining debts and assets of CFCDefined in this Act: accounting period, attributable CFC amount, CFC, deductible foreign equity distribution, deduction, financial arrangement, fixed-rate foreign equity, generally accepted accounting practice, income interest, interest, loss, net attributable CFC income, net attributable CFC loss, shareAdjustment of fraction for excessively debt funded CFCWhen this section appliesExcessive debt fundingCalculations for CFCFormula for debt-asset ratio of CFCDefinition of items in formulaTotal CFC's debtsGroup fundingTotal CFC's assetsFraction for excessively debt funded CFCFormula for fraction Definition of items in formulaAttributable CFC assetsTotal CFC assetsDefined in this Act: accounting period, CFC, deductible foreign equity distribution, deduction, excess debt outbound company, financial arrangement, fixed-rate foreign equity, New Zealand residentRelative debt-asset ratio for CFCWhat this section doesMembers of CFC's group and calculations for groupFormula for CFC's group debt-asset ratioDefinition of items in formulaTotal group debtsTotal group assetsFormula for CFC's relative debt-asset ratioDefinition of items in formulaDefined in this Act: accounting period, CFC, deductible foreign equity distribution, deduction, excess debt outbound company, financial arrangement, fixed-rate foreign equity, New Zealand resident.
  ...
  (2) The amount of a CFC's net attributable CFC income or loss for an accounting period is calculated using the rules in section EX 21 and the formula—attributable CFC – (limited funding costs × fraction) – other deductions.
  ...
  (5) Limited funding costs is—
    ...
    (b) if the item funding in subsection (6)(b) is not zero and the interest holder chooses to rely on this paragraph, the amount calculated using the formula—funding costs ×funding – group fundingfunding.
  ...
  (10) The amount referred to in subsection (8)(a) and (b)(i) is calculated using the formula—attributable CFC's assets – group fundingtotal CFC's assets – group funding.
...
The heading before section EX 21 is repealed.
...
(2) Section EX 21(1) is replaced by the following:Calculation rules for CFCCalculation rules for test group of CFCs
...
(9) Section EX 21(16) and (17) are replaced by the following:Dividends
...
(1) After section EX 21, the following is inserted:Non-attributing active CFCsNon-attributing active CFCsNon-attributing active CFCCFC meeting test in section EX 21D or EX 21EInsurer meeting requirements of determinationDefined in this Act: accounting period, CFC, non-attributing active CFCTests for non-attributing active CFCsApplicable accounting standards for section EX 21EApplicable accounting standardsGenerally accepted accounting practice with IFRS for CFCGenerally accepted accounting practice with IFRS for test groupIFRSEs for CFCIFRSEs for test groupGenerally accepted accounting practice without IFRS for CFCGenerally accepted accounting practice without IFRS for CFC's test groupAudit requirementsCompliance with accounting standardsDefined in this Act: accounting period, annual gross income, associated, attributable CFC amount, CFC, generally accepted accounting practice, IFRS, IFRSE, insurer, New Zealand resident, non-attributing active CFC, rent, royaltyNon-attributing active CFC: default test CFC as part of test groupThreshold ratioApplication of formulaFormulaDefinition of items in formulaAttributableAttributable adjustmentsGrossGross adjustmentsDefined in this Act: accounting period, annual gross income, associated non-attributing active CFC, attributable CFC amount, CFC, company, group of companies, income, interest, non-attributing active CFC, resident in New Zealand, royaltyNon-attributing active CFC: test based on accounting standardApplicable accounting standardCFC as part of test groupThreshold ratioApplication of formulaFormulaDefinition of items in formulaReported passiveAdded passiveRemoved passiveReported revenueAdded revenueRemoved revenueCompliance with accounting standardsDefined in this Act: accounting period, associated non-attributing active CFC, attributable CFC amount, CFC, company, dividend, financial arrangement, finance lease, group of companies, IFRS, income, life insurance policy, non-attributing active CFC, operating lease, premium, revenue account property, royalty.
...
(1) The heading before section EX 22 and section EX 22 are replaced by the following:Non-attributing Australian CFCsNon-attributing Australian CFCsCriteriaNo attributed CFC income or lossCFCs with interest in FIF: look-through approachDefined in this Act: accounting period, attributed CFC income, attributed CFC loss, CFC, double tax agreement, FIF, FIF income, FIF loss, income tax, non-attributing Australian CFC, resident in Australia.
...
In section EX 29(1)(b), EX 32 to EX 37 is replaced by EX 31 to EX 43.
...
Section EX 47 is replaced by the following:Method required for certain non-ordinary sharesDefined in this Act: attributing interest, comparative value method, deemed rate of return method, fair dividend rate method, FIF income, FIF loss, income year, market value, share.
...
(2) Section EX 51(7) and (8) are replaced by the following:Losses from some attributing interests not subject to ruleNo total FIF loss from other attributing interests
...
(4) After section EX 52(5), the following is inserted:Exclusion for certain managed funds
...
(9) After section EX 52(14B), the following is inserted:Treatment of attributing interests subject to returning share transfer
...
(4) In section EX 53(5), the words before paragraph (a) are replaced by the following:.
  (5) Opening value is the total of the market values of the FDR interests that—
(5) After section EX 53(5), the following is inserted:Exclusion for certain managed funds
  (5B) Subsection (5)(b) does not apply if—
...
(10) After section EX 53(16B), the following is inserted:Treatment of attributing interests subject to returning share transfer
...
(2) In section EX 56(4), the formula is replaced by the following:1.05 × preceding opening.
(3) In section EX 56(5), the formula is replaced by the following:1.05 × preceding opening + (increase × average cost).
(4) In section EX 56(6), the formula is replaced by the following:opening shareholding× 1.05 × preceding opening.preceding shareholding
(5) Section EX 56(9) is repealed.
(6) In section EX 56(15), the formula is replaced by the following:0.05 × peak holding differential × average cost.
...
(2) Section EX 58(6) is replaced by the following:Non-attributing Australian CFCs
...
(1) Section EX 59(1)(c) is replaced by the following:.
  (c) the fair dividend rate method:
(2) After section EX 59(1), the following is inserted:Exclusion for interests in grey list companies Application of rule for certain managed funds
...
(3) Section EX 59(1C)(b) is replaced by the following:
  (b) the FIF is a foreign PIE equivalent.
(4) After section EX 59(2), the following is inserted:Exception to subsection (2): fees rebate
...
(2) After section EX 62(8), the following is added:Change to fair dividend rate method in return for 2008–09, 2009–10 tax year
...
(1) After section EX 66, the following is inserted:Entities ceasing to be FIFsWhen this section appliesTreatment as sale and repurchaseCalculation of reduction in FIF income or lossDefinition of items in formulaDefined in this Act: accounting period, accounting profits method, amount, attributing interest, branch equivalent method, FIF, FIF income, FIF loss, market value, pay.
...
(1) Sections EY 1 to EY 5 are replaced by the following:What this subpart doesTwo basesSchedular policyholder base income and PIE schedular incomeCounting onceDefined in this Act: assessable income, deduction, income, life fund PIE, life insurance, life insurer, life reinsurance, memorandum account, multi-rate PIE, policyholder base, policyholder base income, schedular policyholder base income, shareholder base, tax creditPolicyholder basePolicyholder base incomePolicyholder base allowable deductionsSchedular policyholder base incomeCap on subtracting: ring-fencing policyholder base allowable deductionsExcess allocations: carrying forward and re-instating next yearExceptionDefined in this Act: amount, assessable income, income year, life fund PIE, life insurance, life insurer, multi-rate PIE, policyholder base allowable deduction, policyholder base income, profit participation policy, savings product policy, schedular income, schedular policyholder base incomeShareholder baseShareholder base incomeShareholder base allowable deductionsReservesDefined in this Act: deduction, life insurance, life insurance policy, life insurer, life risk, profit participation policy, shareholder base allowable deduction, shareholder base incomeApportionment of income of particular source or nature, and of tax creditsDefault basisMore equitable or reasonable basisDefined in this Act: actuarially determined, amount, class of policies, income, life insurer, policyholder base, policyholder base income, shareholder base, shareholder base income, tax creditPart-year tax calculationsPart-year tax calculationsFirst year part-year calculations: descriptionFirst year part-year calculations: effectPart-year calculations for transfersPart-year calculations for transfers: effectPart-year calculations for transfers: adjustmentsPart-year calculations: end of transitional adjustmentsDefined in this Act: amount, class of policies, deduction, early life regime application day, income, income tax liability, income year, life insurance, life insurance policies, life insurer, life reinsurance, outstanding claims reserve.
...
(1) Section EY 6 is replaced by the following:Actuarial advice and guidanceDefined in this Act: actuarially determined, actuary, Commissioner.
...
(1) Section EY 12(1) is replaced by the following:MeaningFully and partially
  (1) Life reinsurance—
...
(2) Section EY 12(4) is replaced by the following:Exclusion: financial arrangements and general insuranceOther definitionsRelationship with subject matter
...
(1) Sections EY 15 to EY 47 are replaced by the following:Policyholder baseNon-participation policiesPolicyholder base income: non-participation policiesWhat is includedCertain income: basis of apportionmentDefinition of items in formulaMore equitable or reasonable basis of apportionmentTreatment of de minimis life risk component amountsDefined in this Act: actuarially determined, amount, claim, income, income year, life insurance policy, life insurer, life reinsurance, life risk, life risk component, market value, premium, policyholder base income, profit participation policy, savings product policy, shareholder base income, surrender valuePolicyholder base allowable deductions: non-participation policiesWhat is includedBasis of apportionmentDefined in this Act: deduction, income year, life insurance policy, life insurer, policyholder base allowable deduction, policyholder base income, profit participation policy, shareholder base allowable deductionProfit participation policiesPolicyholder base income: profit participation policiesWhat is includedDefinition of items in formulaMeaning of supporting asset baseDefined in this Act: actuarially determined, amount, annual gross income, asset base, income year, life insurer, policyholder base income, present value (net), profit participation policy, supporting asset basePolicyholder base allowable deductions: profit participation policiesDefined in this Act: amount, annual total deduction, asset base, income year, life insurer, policyholder base allowable deduction, profit participation policyShareholder baseNon-participation policiesShareholder base income: non-participation policiesWhat is includedTreatment of de minimis life risk component amountsNo double-countingDefined in this Act: amount, actuarially determined, claim, income year, life insurer, life insurance policy, life reinsurance, life risk, life risk component, policyholder base income, premium, profit participation policy, shareholder base incomeShareholder base allowable deductions: non-participation policiesWhat is includedNo double-countingDefined in this Act: amount, claim, deduction, income year, life insurer, life insurance policy, life reinsurance, life risk component, policyholder base allowable deduction, premium, premium payback amount, profit participation policy, shareholder base allowable deduction, shareholder base incomeProfit participation policiesShareholder base income: profit participation policiesWhat is includedDefinition of items in formulaDefined in this Act: actuarially determined, amount, annual gross income, asset base, income, income year, life insurer, present value (net), profit participation policy, shareholder base income, supporting asset baseShareholder base allowable deductions: profit participation policiesDefined in this Act: amount, annual total deduction, asset base, income year, life insurer, profit participation policy, shareholder base allowable deductionNon-participation policies: reservesReserving amounts for life insurers: non-participation policiesReservesActuarial determinationPositive and negative amounts: shareholder base income or shareholder base allowable deductionWhich reserve can be used when?ChoiceMeaning of PSR periodDefined in this Act: actuarially determined, amount, class of policies, deduction, income year, life insurance policy, life insurer, life risk, life risk component, premium, profit participation policy, PSR period, shareholder base allowable deduction, shareholder base incomeOutstanding claims reserving amount: non-participation policies not annuitiesCalculation of reserving amountDefinition of items in formulaOutstanding claims reserve calculationDefinition of items in formulaDefined in this Act: amount, best estimate assumptions, claim, class of policies, income year, life insurer, life reinsurance, life risk, life risk component, mortality profit, present value (gross)Premium smoothing reserving amount: non-participation policies not annuitiesCalculation of reserving amountDefinition of items in formulaPremium smoothing reserve calculation: principlesBest estimate assumptions for PSRSpecial grouping rule for the purposes of best estimate assumptionsMeaning of expected life risk proportionDefined in this Act: amount, actuarially determined, best estimate assumptions, class of policies, expected life risk proportion, income year, life insurance policy, life insurer, life risk, life risk component, premium, PSR periodUnearned premium reserving amount: non-participation policies not annuitiesCalculation of reserving amountDefinition of items in formulaUnearned premium reserveDefined in this Act: amount, class of policies, income year, life insurer, life reinsurance, life risk componentCapital guarantee reserving amount: non-participation policies not annuitiesCalculation of reserving amountDefinition of items in formulaCapital guarantee reserveReflex in policyholder baseReflex in policyholder base: exceptionDefined in this Act: amount, class of policies, income year, life insurer, pay, policyholder base, policyholder base allowable deduction, policyholder base incomeShareholder base other profit: profit participation policiesShareholder base other profit: profit participation policies that are existing businessCalculation of incomeDefinition of items in formulaFormula: negative amounts and positive amountsOther profitDefinition of items in formulaMeaning of policy liabilitiesBasis of best estimate assumptions in actuarially determining itemsMeaning of existing businessDefined in this Act: actuarially determined, amount, best estimate assumptions, claim, existing business, income year, life insurance, life insurance policy, life insurer, life reinsurance, premium, present value (net), profit participation policyShareholder base other profit: profit participation policies that are new businessCalculation of incomeDefinition of items in formulaFormula: negative amounts and positive amountsNegative amounts: carry forwardOther profitDefinition of items in formulaMeaning of valuation premiumsMeaning of policy liabilitiesBasis of best estimate assumptions in actuarially determining itemsMeaning of new businessDefined in this Act: actuarially determined, amount, best estimate assumptions, claim, existing business, income year, life insurance policy, life insurer, life reinsurance, new business, premium, present value (net), profit participation policy, valuation premiumsTransitional adjustments and annuitiesTransitional adjustments: life riskWhen this section applies: treatment of old and new policiesLife insurance policiesGroup life master policiesCredit card repayment insurance and employer sponsored group policiesRequirements and periods for which this section appliesWhen this section does not apply: once-only opt outAdjustmentDefinition of items in formulaNegative amountsMeaning of cover review periodMeaning of credit card repayment insuranceMeaning of employer sponsored group policiesMeaning of grandparenting start dayMeaning of group life master policiesDefined in this Act: amount, Commissioner, cover review period, credit card repayment insurance, class of policies, early life regime application day, employer sponsored group policy, grandparenting start day, group life master policy, income year, life insurance, life insurer, life reinsurance, policyholder base allowable deduction, policyholder base income, shareholder base allowable deduction, shareholder base incomeAnnuitiesWhen this section appliesAdjustmentDefinition of items in formulaPositive and negative amountsDefined in this Act: amount, income year, life insurer, life insurance policy, shareholder base allowable deduction, shareholder base income.
...
(2) Section EY 43B(2) is replaced by the following:When has life insurer indirectly invested in multi-rate PIE?
...
(3) In section EY 43B, in the list of defined terms,—
  (a) portfolio investment-linked life fund is omitted; and
  (b) multi-rate PIE and PIE are inserted.
(4) Subsections (1) and (2) apply for the 2010–11 income year.

### 192 Policyholder income formula: PILF adjustment
(1) In section EY 43C(1), the words before paragraph (a) and paragraph (a) are replaced by the following:.
...
(2) Section EY 43C(2) is replaced by the following:When has life insurer invested directly in multi-rate PIE?
  (2) For the purposes of subsection (1), a life insurer is treated as investing directly in a multi-rate PIE (PIE A) when a multi-rate PIE has invested in PIE A and the investment may be traced through an unbroken chain of investments in multi-rate PIEs to a direct investment by the life insurer in a multi-rate PIE.
(3) Section EY 43C(3)(b)(ii) is replaced by the following:
...
(4) Section EY 43C(9)(c)(ii) is replaced by the following:
...
(5) In section EY 43C, in the list of defined terms,—
  (a) portfolio investment-linked life fund is omitted; and
  (b) life fund PIE, multi-rate PIE, and PIE are inserted.
...
(1) Section EY 48(3) is replaced by the following:Shareholder base and policyholder base
...
(2) In section EY 48(4), other than under a formula referred to in subsection (3) is replaced by other than under the provisions of this subpart.
(3) Subsections (1) and (2) apply––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.

### 194 Deductions for disposal of property: 1982–83 and 1989–90 income years
(1) In the heading to section EZ 2(1), Section EY 47(2)(b) is replaced by Deduction.
(2) In section EZ 2(1), section EY 47(2)(b) (Deductions for disposal of property) is replaced by this Act.
(3) In the heading to section EZ 2(2), Section EY 47(2)(c) is replaced by Deduction.
(4) In section EZ 2(2), section EY 47(2)(c) is replaced by this Act.
(5) Subsections (1) to (4) apply––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.

### 195 Section EZ 31 repealed
(1) Section EZ 31 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 196 Section EZ 32B repealed
Section EZ 32B is repealed.

### 197 Income and expenditure where financial arrangement redeemed or disposed of
(1) In section EZ 38(6)(a)(iii), section EZ 41(8)(c)(ii) is replaced by subsection (8)(c)(ii).
(2) Subsection (1) applies for the 2008–09 and later income years.

### 198 New section EZ 52B added
After section EZ 52, the following is added:Consistency of use of IFRS method: Determination G3 change allowedWhen this section appliesException modifiedDefined in this Act: creditor workout, financial arrangement, IFRS, income year.
  ...
  (2) For the purposes of the exception in section EW 25B(2) (Consistency of use of IFRS method), the person may change a method for IFRS for the financial arrangement if—
    (a) the method they change to or from is Determination G3 under section EW 15E(2)(aa) (Determination alternatives); and
    (b) that method is available to them to use.

### 199 New headings and sections EZ 53 to EZ 62 added
(1) After section EZ 52B, the following is added:Life insurance transitional adjustment: expected death strainExpected death strain formulasHow expected death strain is calculatedCalculation of expected death strain: stepsExpected death strain formula (life)Expected death strain formula (active annuities)Defined in this Act: business, income year, life insurance, life insurance policy, life insured, life insurer, payExpected death strain formulasExpected death strain formula (life) Expected death strain formula (active annuities)Definition of items in formulasClaim probabilityOpening sum assuredOpening actuarial reserves Defined in this Act: actuarial reserves, amount, claim, income year, life insured, life insurer, payExpected death strain formulas: option when more than 1 life insured When this section appliesClaim probabilityFeatures of common factorDefined in this Act: actuarial reserves, amount, claim, income year, life insurance policy, life insured, life insurerExpected death strain formula (life): when annuity payable on deathWhen this section appliesOpening sum assuredDefined in this Act: actuarial reserves, income year, life insurance policy, life insured, life insurer, payment, present value (net)Expected death strain formulas: when annuity payable on survival to date or age specified in policyWhen this section appliesClaim probabilityOpening sum assuredDefined in this Act: actuarial reserves, income year, life insurance policy, life insured, life insurer, pay, payment, present value (net)Expected death strain formula (life): when partial reinsurance existsWhen this section appliesOpening sum assuredDefined in this Act: claim, life insurance policy, life insured, life insurer, life reinsurance policy, partial reinsuranceActuarial reservesMeaning of actuarial reservesActuarial reserves generallyClosing actuarial reserves for annuitiesLink between actuarial reserves and life insurerDefined in this Act: actuarial reserves, life insurance policy, life insurerActuarial reserves: calculationCalculation by actuaryAll reserves or 1 or more amountsInterest, mortality, and other assumptions and bases of calculationReserves for policy never negativeReserves for all policies never less than total of surrender valuesReserves for policies same at end of one, and start of next, income yearEffect of partial reinsuranceDefined in this Act: actuarial reserves, actuary, amount, income year, life insurance policy, life insurer, life reinsurance policy, partial reinsurance, payment, shareholder, superannuation schemeEntry to new life insurance regime: transitional and miscellaneous provisionsAllowance for cancelled amount: spreadingPolicyholder base allowable deductionAvailable concession amountDefinition of items in formulaDefined in this Act: amount, Commissioner, income year, life insurer, net loss, policyholder base, policyholder base allowable deduction, return of income, schedular policyholder base income, tax loss, tax year, taxable incomeReinsurance transition: life financial reinsurance may be life reinsuranceMeaning of reinsurance grandparenting start dayDefined in this Act: early life regime application day, income year, life financial reinsurance, life insurer, life reinsurance, reinsurance grandparenting start day.
...
Before the heading to Part F, the following is inserted:Disposal and acquisition upon entryWhen this section appliesDisposal and acquisition upon entryExclusionDefined in this Act: actuarial reserves, amount, dispose, early life regime application day, income year, life insurer, listed PIE, market value, PIE, portfolio-listed company.
...
(1) Section FA 2(3) is repealed.
(2) Section FA 2(4), other than the heading, is replaced by the following:
...
(3) In section FA 2(4)(b)(iii), date). is replaced by date): and the following is added:
  (c) does not include a debenture treated as a share under section FA 2B (Stapled debt securities).
(4) Section FA 2(5), other than the heading, is replaced by the following:
...
(5) In section FA 2(5)(c), note. is replaced by note: and the following is added:
  (d) does not include a debenture treated as a share under section FA 2B.
(6) Section FA 2(6) is repealed.
(7) Section FA 2(7), other than the heading, is replaced by the following:
...
(1) After section FA 2, the following is inserted:Stapled debt securitiesWhen subsection (2) appliesStapled debt treated as equityStapled securities aggregatedMeaning of debt securityMeaning of stapledExclusion: small company shareholder agreementsExclusion: stapling before 25 February 2008Defined in this Act: amount, associated person, company, debt security, deduction, dividend, financial arrangement, fixed-rate share, interest, non-contingent fee, share, shareholder agreement, stapled, widely-held company.
  ...
  (3) A stapled debt security and a share to which it is stapled are treated as a single share for the purposes of applying—
    ...
    (b) the definition of fixed-rate share in section LL 9 (Some definitions); and
...
(1) Section FB 9, other than the heading and list of defined terms, is replaced by the following:
...
Section FC 2(2), other than the heading, is replaced by the following:
...
(1) Section FC 4(1), other than the heading, is replaced by the following:
...
(2) Section FC 4(1), other than the heading, is replaced by the following:
  (1) This section applies in the circumstances described in section FC 1(1)(b) when tax-base property is transferred on a person's death when the only beneficiaries of the deceased person are—
    (a) a close relative of the deceased person:
    (b) a person exempt under section CW 43 (Charitable bequests).
(3) In section FC 4(2), The transfer, including any intervening transfer to an executor or administrator, is treated is replaced by The transfer is treated.
(4) In section FC 4, in the list of defined terms, tax base property is replaced by tax-base property.
(5) Subsection (1) applies for the 2008–09 and later income years.

### 206 What this subpart does
(1) Section FE 1(1)(a)(i) is replaced by the following:.
...
(2) In section FE 1, in the list of defined terms, CFC and income interest are inserted.
(3) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 207 When this subpart applies
(1) In section FE 2(1)(d), trust. is replaced by trust:, and the following is added:
...
(2) In section FE 2, in the list of defined terms, CFC and income interest are inserted.
(3) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 208 Section FE 3 replaced
(1) Section FE 3 is replaced by the following:Interest apportionment for individualsNatural persons and trustees: inbound, not described in section FE 2(1)(g)Natural persons and trustees: outbound, described in section FE 2(1)(g)Defined in this Act: amount, associated person, business, CFC, double tax agreement, fixed establishment, generally accepted accounting practice, group of companies, income interest, natural person, New Zealand, resident in New Zealand, source in New Zealand, total group assets, total group debt, trustee.
...
(1) In section FE 4, after the definition of excess debt entity, the following is inserted:.
...
(2) In section FE 4, the definition of reporting bank is replaced by the following:
...
(3) In section FE 4, in the list of defined terms, registered bank is omitted.
(4) Subsection (1) applies for all income years beginning on or after 1 July 2009.
...
(1) After section FE 5(1), the following is inserted:Exceptions for excess debt outbound companiesNatural persons' worldwide group total assets
...
(2) In section FE 5, in the list of defined terms, CFC, excess debt outbound company, income interest, and total group assets are inserted.
(3) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 211 Apportionment of interest by excess debt entity
(1) Section FE 6(1) is replaced by the following:Who this section applies to
...
(2) In section FE 6(2), in the formula, total deduction is replaced by (total deduction + FRD – adjust).
(3) In section FE 6(3)(a), sections DB 6 to DB 8 is replaced by sections DB 6 to DB 8 (which relate to deductions for interest expenditure).
(4) After section FE 6(3)(a), the following is inserted:.
  ...
  (ac) adjust is—
    ...
    (ii) the total amount of the items total deduction and FRD (the finance cost), if the finance cost is $1,000,000 or less and subparagraph (i) does not apply; or
...
(5) In section FE 6, in the list of defined terms, fixed-rate foreign equity and fixed-rate share are inserted.
...
(1) In section FE 12(1), the second sentence is replaced by A natural person must calculate their debt percentage under the rules set out in sections FE 13 to FE 16 and FE 18.
(2) In section FE 12(2), or natural person is omitted.
(3) Section FE 12(5) is replaced by the following:Membership of company’s worldwide group
...
(4) Section FE 12(6) is replaced by the following:Natural persons: membership of New Zealand groupsTrustees: membership of New Zealand and worldwide groups
...
(5) In section FE 12, in the list of defined terms, excess debt outbound company is inserted.
(6) Subsections (1) to (4) apply for all income years beginning on or after 1 July 2009.

### 213 Financial arrangements entered into with persons outside group
(1) Section FE 13(1), other than the heading, is replaced by the following:
...
(2) In section FE 13(2), and a worldwide group is inserted after New Zealand group.
(3) Section FE 13(3)(a) is replaced by the following:.
...
(4) In section FE 13, in the list of defined terms, double tax agreement and source in New Zealand are inserted.
(5) Subsection (3) applies for all income years beginning on or after 1 July 2009.

### 214 Consolidation of debts and assets
(1) Section FE 14(2) and (3) are replaced by the following:Natural persons' and trustees' calculationWhen member not resident
...
(2) In section FE 14, in the list of defined terms, double tax agreement and source in New Zealand are inserted.
(3) Subsection (1) applies for all income years beginning on or after 1 July 2009.
...
(2) Section FE 15(1) and (2) are replaced by the following:MeaningExchange rate fluctuations
...
(3) In section FE 15, in the list of defined terms, proportional-stapling company, resident in New Zealand, stapled, and stapled debt security are inserted.
(4) In section FE 15, in the list of defined terms, fixed-rate foreign equity is inserted.
(5) Subsection (2) applies for all income years beginning on or after 1 July 2009.

### 216 Total group assets
(1) After section FE 16(1), the following is inserted:CFC investments excludedWhen member not resident
  ...
  (1C) If the excess debt entity or another member of a New Zealand group is not resident in New Zealand, the assets of the entity or member are included in the calculation and measurement of total group assets under this section only to the extent to which the assets are for the entity or member to—
    (a) carry on business in New Zealand through a fixed establishment in New Zealand:
    (b) derive income that has a source in New Zealand and for which relief from New Zealand tax under a double tax agreement is unavailable.
(2) In section FE 16, in the list of defined terms, CFC, double tax agreement, income interest, and source in New Zealand are inserted.
(3) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 217 Measurement of debts and assets of worldwide group
(1) In section FE 18(1), the words before paragraph (a) are replaced by the following:.
...
(2) Section FE 18(2) and (3) are replaced by the following:Date of measurementMeasurement of amounts
...
(3) In section FE 18(4), the first sentence is replaced by If an excess debt entity is unable to calculate the debt percentage of their worldwide group for an income year, they may ask the Commissioner to estimate the percentage under this subpart.
(4) In section FE 18(5), the words before paragraph (a) and paragraph (a) are replaced by the following:.
...
(5) In section FE 18, in the list of defined terms, natural person is omitted.
(6) Subsections (1) to (4) apply for all income years beginning on or after 1 July 2009.

### 218 Banking group's New Zealand net equity
(1) Section FE 21(3)(d)(ii) is replaced by the following:.
...
(2) Section FE 21(3)(d)(ii) is replaced by the following:.
...
(3) In section FE 21(4), the words before paragraph (a) are replaced by the following:.
  (4) Adjustment 1 is the financial value of fixed-rate foreign equities or fixed-rate shares that are—
(4) After section FE 21(4), the following is inserted:Stapled debt securities
...
(5) Section FE 21(7)(a)(i) and (ii) are replaced by the following:.
...
(6) Section FE 21(7)(a)(i) and (ii) are replaced by the following:.
...
(7) Section FE 21(8), other than the heading, is replaced by the following:
  (8) Adjustment 5 is the total amount of capital gain arising for the 2004–05 income year or a later income year from a transfer of an intangible asset between a member of the group and a person who is associated with a member of the group under the parts of subpart YB that apply for the purposes of the whole Act (excluding the 1973, 1988, and 1990 version provisions) or the 1988 version provisions.
(8) Section FE 21(8), other than the heading, is replaced by the following:
...
(9) In section FE 21, in the list of defined terms, proportional-stapling company, stapled, and stapled debt security are inserted.
...
(1) In section FE 25(2), company is replaced by company. However, section FE 30 does not apply to an excess debt outbound company.
(2) In section FE 25, in the list of defined terms, excess debt outbound company is inserted.
(3) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 220 Identifying New Zealand parent
(1) Section FE 26(2)(b)(ii) is replaced by the following:
...
(2) In section FE 26(2)(b), more. is replaced by more; or and the following is added:
...
(3) The heading to section FE 26(3) is replaced by Top tier New Zealand resident company if not excess debt outbound company.
(4) In section FE 26(3), the words before the paragraphs are replaced by the following:.
...
(5) In section FE 26(3)(a)(ii), New Zealand; and is replaced by New Zealand; or and the following is added:.
...
(6) In section FE 26(4)(a)(ii), New Zealand; and is replaced by New Zealand; or and the following is added:.
  (iii) not resident in New Zealand but deriving income that has a source in New Zealand and for which relief from New Zealand tax under a double tax agreement is unavailable; and
(7) After section FE 26(4), the following is inserted:Top tier New Zealand resident company for excess debt outbound company
...
(8) Section FE 26(6), other than the heading, is replaced by the following:
...
(9) Section FE 26(7), other than the heading, is replaced by the following:
...
(10) In section FE 26, in the list of defined terms, double tax agreement, excess debt outbound company, and source in New Zealand are inserted.
(11) Subsections (1) to (9) apply for all income years beginning on or after 1 July 2009.

### 221 Section FE 28 replaced
(1) Section FE 28 is replaced by the following:Identifying members of New Zealand groupNew Zealand parent's groupSpecial rule for some entity's groupAnother special rule for some other entity’s groupDefined in this Act: business, company, control, double tax agreement, excess debt entity, excess debt outbound company, fixed establishment, New Zealand, New Zealand banking group, registered bank, resident in New Zealand, source in New Zealand.
  ...
  (2) Despite subsection (1), if the excess debt entity is not an excess debt outbound company and is not a company identified under section FE 27 as being under the control of the New Zealand parent because the threshold is not met, the New Zealand group is made up of the entity and a company—
    ...
    (b) that is a company that—
      ...
      (iii) would be identified under section FE 27 as under the control of a company (company B) included in the entity's New Zealand group under subparagraph (ii), if company B were treated as the New Zealand parent; or
      (iv) is not a member of the New Zealand banking group of a registered bank.
...
(1) Section FE 29 is replaced by the following:Combining New Zealand groups owned by natural persons and trusteesWhen this section appliesGroups combineDefined in this Act: excess debt outbound company, New Zealand.
...
(1) Section FE 30(1)(b) and (c) are replaced by the following:.
  ...
  (c) company A is—
    ...
    (iii) deriving income that has a source in New Zealand and for which relief from New Zealand tax under a double tax agreement is unavailable; and
(2) Section FE 30(3)(b) is replaced by the following:.
  (b) company B is—
    (i) resident in New Zealand:
    (ii) carrying on business in New Zealand through a fixed establishment in New Zealand:
    (iii) deriving income that has a source in New Zealand and for which relief from New Zealand tax under a double tax agreement is unavailable; and
(3) In section FE 30, in the list of defined terms, double tax agreement, excess debt outbound company, and source in New Zealand are inserted.
(4) Subsections (1) and (2) apply for all income years beginning on or after 1 July 2009.

### 224 Worldwide group for corporate excess debt entity
(1) The heading to section FE 31 is replaced by Worldwide group for corporate excess debt entity if not excess debt outbound company.
(2) In section FE 31(1), the words before the paragraphs and paragraph (a) are replaced by the following:.
  (1) For an income year, for an excess debt entity that is a company and is not an excess debt outbound company, a worldwide group is made up of—
    (a) the entity; and
(3) In section FE 31, in the list of defined terms, excess debt outbound company is inserted.
(4) Subsections (1) and (2) apply for all income years beginning on or after 1 July 2009.

### 225 New sections FE 31B and FE 31C inserted
(1) After section FE 31, the following is inserted:Worldwide group for excess debt outbound companiesMembers of worldwide groupWorldwide GAAP groupDefined in this Act: excess debt outbound company, generally accepted accounting practice, income year, non-residentCFCs in worldwide group for natural persons or trustees described in section FE 2(1)(g)When this section appliesTransferOwnership interestsDefined in this Act: CFC, excess debt outbound company, income interest, New Zealand, non-resident.
...
(1) Section FE 32 is replaced by the following:Joint venture partiesWhat this section applies toExclusion of excluded joint venturerOwnership interestsDefined in this Act: company, excess debt entity, income year.
...
(1) Section FE 36(3), other than the heading, is replaced by the following:
...
(2) In section FE 36(4)(a), ultimate parent; and is replaced by ultimate parent:.
(3) In section FE 36(5)(a), ultimate parent; and is replaced by ultimate parent:.
(4) In section FE 36(6)(a), ultimate parent; and is replaced by ultimate parent:.
(5) Subsections (1) to (4) apply for the 2008–09 and later income years.

### 228 Subpart FF repealed
(1) Subpart FF is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 229 Consolidation rules
(1) Section FM 2(2)(g) is replaced by the following:
  (g) section 74 of the Tax Administration Act 1994.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 230 Some general rules for treatment of consolidated groups
(1) Section FM 6(3)(b) is repealed.
(2) Section FM 6(3)(c) is replaced by the following:.
  (c) sections FM 8(3)(c), FM 27 to FM 30, GB 38, GB 40, and OP 3 to OP 50 (which relate to dividends and consolidated groups):
(3) Section FM 6(3)(e) is replaced by the following:
  (e) section 74 of the Tax Administration Act 1994.
(4) In section FM 6(5), YA 2(2)(e) is replaced by YA 2(7).
(5) Section FM 6(5) is replaced by the following:Balance of imputation credit account
...
(6) In section FM 6, in the list of defined terms, FDP account and FDP rules are omitted.
...
(1) Sections FM 24 to FM 26 are repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 232 Eligibility rules
(1) Section FM 31(1), other than the heading, is replaced by the following:
...
(2) Section FM 31(3), other than the heading, is replaced by the following:
...
(3) In section FM 31, in the list of defined terms, income tax is inserted.
(4) Subsections (1) and (2) apply for the 2008–09 and later income years.

### 233 Imputation rules
In section FN 2(i), YA 2(2)(d) is replaced by YA 2(7)(b).

### 234 Trans-Tasman imputation groups and resident imputation subgroups
(1) Section FN 8(2), other than the heading, is replaced by the following:
...
(2) Section FN 8(3) is replaced by the following:Single company
...
(1) After section FO 16(1), the following is inserted: Treatment of amalgamating company
...
In section FZ 1(3), Despite section FA 2(3)(c), section is replaced by Section.

### 237 New sections GB 15B and GB 15C inserted
(1) After section GB 15, the following is inserted:Supplies affecting default test for non-attributing active CFCWhen this section appliesIncome from supply included in gross adjustmentDefined in this Act: CFCArrangements related to accounting test for non-attributing active CFCWhen this section appliesCFC not non-attributing active CFCPerson not non-attributing active CFC if type of financial arrangement involvedDefined in this Act: arrangement, associated, CFC, financial arrangement, loss, non-attributing active CFC.
...
(1) In section GB 27(2)(c), $60,000 is replaced by $70,000.
(2) In section GB 27(3)(d), entity. is replaced by entity: and the following is added:
...
(3) In section GB 27, in the list of defined terms, attributable CFC amount, attributed CFC income, attributed CFC loss, and CFC are inserted.
(4) Subsection (1) applies for the 2008–09 and later income years.
(5) Subsection (2) applies for all income years beginning on or after 1 July 2009.

### 239 Interpretation of terms used in section GB 27
(1) Section GB 28(2), other than the heading, is replaced by the following:
...
(2) Section GB 28(2), other than the heading, is replaced by the following:
...
(1) Section GB 39 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 241 Arrangements involving money not at risk
In section GB 45(3), in paragraph (f) of the definition of acceptable property, CE 1(d) is replaced by CE 1(1)(d).

### 242 Defined terms for sections GB 45 and GB 46
(1) Section GB 48(1)(b) is replaced by the following:
...
(2) Section GB 48(1)(b) is replaced by the following:
  (b) the persons are associated persons.
(3) In section GB 48(3)(d) and (e), under subpart YB is omitted in each place where it appears.
(4) Subsections (2) and (3) apply for the 2010–11 and later income years.

### 243 Disposals of trading stock at below market value
(1) In section GC 1(4)(c), share user. is replaced by share user: and the following is added:
  (d) in the surrender of an emissions unit under the Climate Change Response Act 2002.
(2) In section GC 1, in the list of defined terms,––
  (a) qualifying event is omitted:
  (b) emissions unit and surrender are inserted.

### 244 Section GC 4B repealed
Section GC 4B is repealed.

### 245 Leases for inadequate rent
(1) In section GC 5(5), in the definition of related company, the words before paragraph (a) are replaced by the following:.
  - **related company** means a company that is associated with—
(2) Subsection (1) applies for the 2010–11 and later income years.

### 246 Insufficient amount receivable by person
(1) Section GC 8(1)(b) is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 247 Compensating arrangement: person receiving more than arm's length amount
(1) Section GC 10(2)(b) is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 248 Requests for matching treatment
(1) Section GC 11(2)(b) is replaced by the following:
...
(2) In section GC 11, in the list of defined terms,—
  (a) branch equivalent income and branch equivalent loss are omitted:
  (b) net attributable CFC income and net attributable CFC loss are inserted.
(3) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 249 Section GC 12 replaced
(1) Section GC 12 is replaced by the following:Effect on person's withholding obligationsDefined in this Act: amount.
...
(1) After section GZ 1, the following is added:Arrangements involving cancellation of conduit tax relief creditsWhat this section applies toIncome tax liabilityDefined in this Act: amount, arrangement, company, CTR credit, CTR holding company, CTRA, income year, New Zealand resident, taxation law.
...
(1) After section HA 7(3), the following is added:Shareholder continuity requirements
...
(2) In section HA 7, in the list of defined terms, memorandum account is inserted.
(3) Subsection (1) applies for the 2008–09 and later income years.

### 252 New section HA 8B inserted
(1) After section HA 8, the following is inserted:No CFC income interests or FIF direct income interests of 10% or moreDefined in this Act: attributing interest, CFC, direct income interest, FIF, income interest, qualifying company.
...
(1) In section HA 9(2), order in Council is replaced by Order in Council.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 254 When requirements no longer met
(1) Section HA 11(5), other than the heading, is replaced by the following:
...
(1) In section HA 14(2), under section HA 15 is omitted.
(2) In section HA 14, in the list of defined terms, fully imputed is inserted.

### 256 Fully imputed distributions
(1) In section HA 15(1), the first sentence is replaced by This section applies when a qualifying company with an imputation credit account or foreign dividend payment (FDP) account pays a dividend.
(2) Section HA 15(9) is replaced by the following:Relationship with sections HA 14 and HA 16
...
(1) Section HA 16 is replaced by the following:Dividends paid by qualifying companies to trustee shareholdersWhen this section appliesExempt incomeDefined in this Act: dividend, exempt income, resident in New Zealand, trustee.
...
(1) Section HA 19(1), other than the heading, is replaced by the following:
...
(2) In section HA 19, in the list of defined terms, fully imputed is inserted.

### 259 Calculating qualifying company election tax
(1) In section HA 41(4)(c), relevant date: is replaced by relevant date. and paragraph (d) is repealed.
(2) Section HA 41(8)(c) is replaced by the following:
...
(3) In section HA 41, in the list of defined terms, FDP is omitted.
(4) Subsections (1) and (2) apply for all income years beginning on or after 1 July 2009.

### 260 Corpus of trust
(1) Section HC 4(5)(b) is repealed.
(2) Section HC 4(5)(c) is replaced by the following:
  (c) it would fall under paragraph (a) if the settlor were resident in New Zealand at the time of the settlement.
(3) In section HC 4, in the list of defined terms, FDP is omitted.
(4) Subsections (1) and (2) apply for all income years beginning on or after 1 July 2009.

### 261 Trustee income
(1) In section HC 7(2), section HC 33 is replaced by section HC 35.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 262 Taxable distributions from non-complying and foreign trusts
(1) Section HC 15(5)(a)(ii) is replaced by the following:.
...
(2) Section HC 15(5)(a)(ii) is replaced by the following:.
...
(1) In section HC 21(3), if the person receives the amount as beneficiary of the trust is omitted.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 264 Who is a settlor?
(1) Section HC 27(1)(e) is replaced by the following:
  (e) subpart YB (Associated persons and nominees) as modified by section YB 10 (Who is a settlor?).
(2) Section HC 27(3), other than the heading, is replaced by the following:
...
(1) In section HC 32(2), a beneficiary of a community trust is replaced by a person who derives an amount from a community trust.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 266 Beneficiary income of minors
(1) In section HC 35(4)(a), less than $1,000 is replaced by $1,000 or less.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 267 Trusts and minor beneficiary rule
(1) In section HC 36(5), the definition of associated person or person associated is replaced by the following:.
  - **associated person** or does not include a person associated only under sections YB 4 and YB 5 (which relate to relatives who are treated as associated persons)
(2) In section HC 36(5), in the definition of relative, paragraph (c) is replaced by paragraph (a) in each place where it appears.
(3) Subsections (1) and (2) apply for the 2010–11 and later income years.
...
(2) In section HD 14, in the list of defined terms, stapled debt security is inserted.

### 269 General provisions relating to disposals
(1) In section HG 3(2), if they choose that those sections do not apply by the small partnership furnishing a joint return of income that ignores the sections is replaced by if the entering partner, the exiting partner, and the partnership, furnish returns of income that ignore the sections.
(2) Section HG 3(3) is replaced by the following:Election in for specified livestock disposed of to entering partner
...
(1) Section HG 4 is replaced by the following:Disposal upon final dissolutionWhen this section appliesDisposal and re-acquisitionReceipt upon dissolutionExclusion: actual disposal to third partyExclusion: partnerships of persons in marriage, civil union, or de facto relationshipsRelationship with subject matterDefined in this Act: amount, associated person, dispose, partner, partner's interests, partnership, settlement of relationship property.
  ...
  (4) This section does not apply to the extent to which a partner of the partnership disposes of their partner's interests in the partnership to persons who are not associated with them. For the purposes of testing association, the partners' partnership capacity is ignored.
...
(1) Section HG 5(2)(c) is replaced by the following:.
...
(2) In section HG 5(7), if they choose that it does not apply, by the small partnership furnishing a joint return of income that ignores sections HG 5 to HG 9 is replaced by if section HG 3(2) applies.
(3) In section HG 5, in the list of defined terms, depreciable property, financial arrangement, and revenue account property are inserted.
...
(1) In section HG 6(6), if they choose that it does not apply, by the small partnership furnishing a joint return of income that ignores sections HG 5 to HG 9 is replaced by if section HG 3(2) applies.
(2) For a person who is not a limited partner of a limited partnership registered under the Limited Partnerships Act 2008, subsection (1) applies for income years starting on and after 1 April 2008.

### 273 Disposal of depreciable property
(1) In section HG 7(6), if they choose that it does not apply, by the small partnership furnishing a joint return of income that ignores sections HG 5 to HG 9 is replaced by if section HG 3(2) applies.
(2) For a person who is not a limited partner of a limited partnership registered under the Limited Partnerships Act 2008, subsection (1) applies for income years starting on and after 1 April 2008.

### 274 Disposal of financial arrangements and certain excepted financial arrangements
(1) In section HG 8(6), if they choose that it does not apply, by the small partnership furnishing a joint return of income that ignores sections HG 5 to HG 9 is replaced by if section HG 3(2) applies.
(2) For a person who is not a limited partner of a limited partnership registered under the Limited Partnerships Act 2008, subsection (1) applies for income years starting on and after 1 April 2008.

### 275 Disposal of short-term agreements for the sale and purchase of property or services
(1) In section HG 9,––
  (a) in the heading to section HG 9, short-term agreements for the sale and purchase of property or services is replaced by short-term agreements for sale and purchase:
  (b) in subsection (1), short-term agreement for the sale and purchase of property or services is replaced by short-term agreement for sale and purchase:
  (c) in subsection (2), short-term agreement for the sale and purchase of property or services is replaced by short-term agreement for sale and purchase:
  (d) in subsection (3), short-term agreement for the sale and purchase of property or services is replaced by short-term agreement for sale and purchase:
  (e) in subsection (4), short-term agreement for the sale and purchase of property or services is replaced by short-term agreement for sale and purchase:
  (f) in subsection (5), short-term agreement for the sale and purchase of property or services is replaced by short-term agreement for sale and purchase in both places where it appears.
(2) In section HG 9(6), if they choose that it does not apply, by the small partnership furnishing a joint return of income that ignores sections HG 5 to HG 9 is replaced by if section HG 3(2) applies.
(3) In section HG 9, in the list of defined terms, short-term agreement for the sale and purchase of property or services is replaced by short-term agreement for sale and purchase.
...
(1) Section HG 10 is replaced by the following:Disposal of livestockWhen this section appliesEntering partner's cost baseDefined in this Act: amount, cost price, dispose, income year, national standard cost scheme, partner, partner's interest, specified livestock.
  (1) This section applies when a person disposes of some or all of their partner's interests to an entering partner and section HG 3(3) applies, to the extent to which those interests include specified livestock and that specified livestock includes female breeding livestock and, for the income year, the partners use––
    ...
    (b) the cost price method for specified livestock, described in EC 25 (Cost price, replacement price, or market value).
...
In section HG 11(8)(b), under section HG 2 is omitted.

### 278 Scheme of subpart
(1) Section HL 2(2)(b)(i) is replaced by the following:.
...
(2) After section HL 2(2), the following is inserted:Portfolio listed company choosing to be portfolio tax rate entity
...
(1) Section HL 3(9), other than the heading, is replaced by the following:
...
(2) In section HL 3(11), HL 14(1) is replaced by HL 15(1).

### 280 Effect of failure to meet eligibility requirements for entities
(1) Section HL 4(1)(a) is replaced by the following:.
  (a) referred to in sections HL 2(2) and HL 3; and
(2) Section HL 4(2)(a) is replaced by the following:.
...
(3) In section HL 4(2)(b)(ii), paragraph (a)(ii) is replaced by paragraphs (a)(ii) and (ab)(ii).

### 281 Meaning of investor and portfolio investor class
(1) In section HL 5B(1)(a) and paragraph (d) does not apply is omitted.
(2) In section HL 5B(1)(b) paragraphs (c) and (d) do not apply is replaced by paragraph (c) does not apply.
(3) In section HL 5B(1)(c) and paragraph (d) does not apply is omitted.
(4) Section HL 5B(1)(d) is repealed.

### 282 Investor membership requirement
(1) Section HL 6(1)(a) is replaced by the following:.
  (a) 20 persons, treating all interests held by associated persons and included by subsection (4) as being held by 1 person:
(2) After section HL 6(1)(i), the following is inserted:.
  (ib) Auckland Regional Holdings:
  (ic) a community trust:
(3) In section HL 6(1)(j)(iii), entity: is replaced by entity. and section HL 6(1)(k) is repealed.
(4) Section HL 6(3) is replaced by the following:No investor membership requirement for public unit trustsNo investor membership requirement for certain superannuation funds and others
...
(5) Section HL 6(4)(a) and (b) are replaced by the following:.
...
After section HL 7(4), the following is added:Extending time limits
...
(1) Section HL 9(2) is replaced by the following:No investor interest size requirement for public unit trusts
...
(2) Section HL 9(4), other than the heading, is replaced by the following:
...
(3) Section HL 9(4)(o) is replaced by the following:
  (o) a community trust:
  (p) a person who meets the requirements of subsection (5).
(4) In section HL 9(5), subsection (4)(a) to (h) is replaced by subsection (4)(a) to (n).
(5) In section HL 9(5), subsection (4)(a) to (n) is replaced by subsection (4)(a) to (o).
(6) Section HL 9(6)(a) and (b) are replaced by the following:.
  (a) the investor is not listed in subsection (4)(a) to (n); and
  (b) the associated person is not listed in subsection (4)(a) to (n); and
(7) Section HL 9(6)(a) and (b) are replaced by the following:.
...
Section HL 10(2)(b)(iii) is replaced by the following:.
...
In section HL 12(1)(a), 100 shareholders is replaced by at least 100 shareholders.

### 287 Becoming portfolio investment entity
Section HL 13(1)(b) is replaced by the following:
...
(1) After section HL 17(2), the following is added:Relationship with section CS 1
...
In section HL 20(3), the formula is replaced by the following:class net income – class net loss – other loss used.

### 290 Credits received by portfolio tax rate entity or portfolio investor proxy
(1) In section HL 29(6)(a)(ii), HL 21 is replaced by HL 22.
(2) In section HL 29(7), the words before paragraph (a) are replaced by the following:.
...
(3) In section HL 29(11)(a)(i), late is replaced by later.
(4) Subsections (1) and (3) apply for the 2008–09 and later income years.

### 291 Portfolio entity formation loss
In section HL 30(7)(c), schedule 1, part A, clause 5 is replaced by schedule 1, part A, clause 2.

### 292 Subpart HL replaced by subpart HM
(1) Subpart HL is replaced by the following:Subpart HM—Portfolio investment entitiesIntroductory provisionsOutline of subpart and relationship with other PartsSubpart HMRelationship with Parts C and DRelationship with subpart LSDefined in this Act: amount, investor, investor class, multi-rate PIE, PIE, portfolio investment entity, tax credit2007 No 97 ss HL 1, HL 2What is a portfolio investment entity? MeaningPIE typesListed PIEs becoming multi-rate PIEsDefined in this Act: benefit fund PIE, Commissioner, company, investor, investor class, life fund PIE, listed PIE, multi-rate PIE, notify, PIE, portfolio investment entity2007 No 97 s YA 1 portfolio investment entityForeign PIE equivalentsDefined in this Act: company, investor, investor class, investor interest, resident in New Zealand, superannuation scheme, trustee, unit trust2007 No 97 s HL 5(1)Who is an investor?Defined in this Act: company, foreign PIE equivalent, investor, life fund PIE, life insurance policy, PIE, share, shareholder2007 No 97 s HL 5B(1)What is an investor class?Meaning of investor classEntitlement to distributionsSame investmentsSimilar proportionate entitlementDefined in this Act: arrangement, investor, investor class, investor interest, notified tax rate, pay2007 No 97 s HL 5B(2), (3)Intended effects for multi-rate PIEs and investorsIntended effects for entityIntended effects for investorsDefined in this Act: amount, assessable income, investor, investor interest, multi-rate PIE, pay, PIE, tax, trustee 2007 No 97 s HL 1(2)(a)Entry rulesRequirementsDefined in this Act: PIE2007 No 97 ss HL 2(2), HL 15(1), (2)RequirementsResidence in New ZealandDefined in this Act: double tax agreement, resident in New Zealand2007 No 97 s HL 3(10)Collective schemesDefined in this Act: company, life insurance policy, life insurer, superannuation scheme, trustee, unit trustExclusion: life insurance businessDefined in this Act: life fund PIE, life insurance2007 No 97 s HL 3(9)Investment typesDefined in this Act: excepted financial arrangement, financial arrangement, land2007 No 97 s HL 10(1)Income sourcesDefined in this Act: amount, associated person, attributed PIE income, dividend, FIF income, income, land, lessee, replacement payment, superannuation fund2007 No 97 s HL 10(2)Maximum shareholdings in investmentsWhen this section appliesVoting interests: companies other than unit trustsInvestments in unit trustsClass requirementsException for limited non-complying investmentsDefined in this Act: company, foreign PIE equivalent, investor class, land investment company, market value, PIE, share, unit trust, voting interest2007 No 97 s HL 10(3)–(5)Minimum number of investorsRequirement for entities other than listed companiesRequirements for listed companiesExceptionsDefined in this Act: company, investor, investor class, investor interest, listed company, listed PIE, New Zealand, recognised exchange, share2007 No 97 s HL 6(1A), (1), (2), (4)Maximum investors’ interestsRequirement for investors' interestsExceptionsDefined in this Act: investor, investor class2007 No 97 s HL 9(1), (6)Associates combinedDefined in this Act: associated person, investor, investor interest2007 No 97 s HL 9(6)Same rights to all investment proceedsWhat this section doesSame rights in relation to proceeds of investmentsCategory B income excludedDefined in this Act: category B income, investor interest, life fund PIE, PIE, portfolio investment2007 No 97 s HL 5CRequirements for listed PIEs: unlisted companiesChoosing to become listed PIE Two-year periodDefined in this Act: Commissioner, company, listed company, listed PIE, New Zealand, PIE, recognised exchange, shareholder2007 No 97 s HL 12Requirements for listed PIEs: fully crediting distributionsWhat this section doesFully crediting distributionsRelationship with section CX 56CDefined in this Act: amount, company, director, FDP credit, imputation credit, income, investor, investor class, life fund PIE, listed PIE, return of income, shareholder2007 No 97 s HL 8Re-entering as PIE: 5-year ruleDefined in this Act: PIE2007 No 97 s HL 3(11)Exceptions Exceptions for certain investorsInvestor classesCertain investors in non-listed PIEsCertain investors in listed PIEsTransitional provision for investors in listed PIEsNot combined associatesDefined in this Act: associated person, investor, investor class, listed PIE, PIE2007 No 97 ss HL 6(4), HL 9Exceptions for certain fundsPublic unit trustCertain superannuation fundsDefined in this Act: investor class, PIE, public unit trust, unit trust2007 No 97 ss HL 6(3), HL 9(2)Exceptions for foreign PIE equivalentsInvestor classes and investors' interestsShareholding in investmentsDefined in this Act: foreign PIE equivalent, investor, investor class, investor interest, PIE2004 No 35 ss HL 9(4), HL 10(4)Exit rulesEnding of New Zealand residenceDefined in this Act: PIE, resident in New Zealand2007 No 97 s HL 4(1)When entity no longer meets investment or investor requirementsEffectDate of loss of statusTransitional quarters disregardedDefined in this Act: investor class, PIE, quarter2007 No 97 s HL 4(2)Starting life insurance businessDefined in this Act: business, life fund PIE, life insurance, PIE2004 No 35 s HL 4(1)When multi-rate PIE no longer meets investor interest adjustment requirementsDefined in this Act: investor interest, multi-rate PIE, PIE2004 No 35 s HL 4(1)When listed PIE no longer meets crediting requirementDefined in this Act: listed PIE, PIE2004 No 35 s HL 4(1)Choosing to cancel statusDefined in this Act: Commissioner, notify, PIEWhen foreign PIE equivalent no longer meets requirements Commencing New Zealand residenceContinued failureDefined in this Act: foreign PIE equivalent, quarter, resident in New Zealand2007 No 97 s HL 5(2)Rules for multi-rate PIEsIntroductory provisionsRules for multi-rate PIEs RulesFurther provisions related to payment options, tax rates, and exit periodsFurther provisions relating to use of lossesDefined in this Act: exit level, exit period, investor, investor interest, multi-rate PIE, notified investor rate, pay, prescribed investor rate, tax, tax creditRules for and treatment of investors in multi-rate PIEs Tax ratesAttributed incomeDefined in this Act: amount, excluded income, income, investor, multi-rate PIE, notifyProxies for PIE investorsProxiesRoleDutiesDefined in this Act: amount, attribution period, Commissioner, income, income tax, investor, investor interest, multi-rate PIE, notify, PIEAttributing income to investorsAttribution periodsDefined in this Act: amount, attribution period, Commissioner, investor, investor class, multi-rate PIE, PIE, provisional tax, tax year2007 No 97 s HL 16(2)Determining net amounts and taxable amountsWhat this section applies toNet amountsDefinition of items in formulaNet income or net lossTaxable amountsDefinition of items in formulaTaxable income or tax lossUse of valuations or financial statementsDefined in this Act: amount, assessable income, attribution period, deduction, formation loss, income, investor class, investor interest, land loss, multi-rate PIE, net income, net loss, PIE, tax loss, taxable income2007 No 97 ss EG 3, HL 19, HL 20Calculating amounts attributed to investorsCalculating amountFormulaDefinition of items in formulaTreatment of attributed loss for PIEs paying provisional taxWhen derived or incurredDefined in this Act: amount, attributed PIE income, attributed PIE loss, attribution period, income, income year, investor, investor class, multi-rate PIE, PIE, provisional tax, tax loss, taxable income2007 No 97 s HL 26When income cannot be attributed When this section appliesSole investorRelationship with section CS 1Defined in this Act: income, investor, investor class, investor interest, multi-rate PIE2007 No 97 s HL 17(1)When superannuation fund investor has conditional entitlementWhen this section appliesAttributionWhen conditional entitlement existsModifications to certain vesting periodsDefined in this Act: attribution period, employer, income, investor interest, multi-rate PIE, PIE, superannuation fund, superannuation scheme2007 No 97 s HL 17(2)New investors in existing investor classesWhen this section appliesPerson treated as investorDefined in this Act: investor, investor class, multi-rate PIE, PIE2007 No 97 s HL 18Deductions for attributed PIE losses for zero-rated and exiting investorsWhen this section appliesDeductionDefined in this Act: amount, attributed PIE loss, attribution period, deduction, exit period, income year, investor, multi-rate PIE, PIE, tax year, zero-rated investor2007 No 97 s HL 27Calculating and paying tax liabilityOptions for calculation and payment of taxAvailable optionsDefault optionIncome tax liabilityDefined in this Act: amount, Commissioner, income tax liability, income year, multi-rate PIE, notify, pay, PIE, provisional tax, tax year, terminal tax2007 No 97 ss HL 16(3), HL 22–HL 24Exit calculation optionWhen this section applies Calculation for exiting investorsCalculations for investors for non-exit periodsPayment to CommissionerProvisional tax rulesDefined in this Act: amount, Commissioner, exit level, exit period, income tax liability, income year, investor, multi-rate PIE, pay, PIE, provisional tax, tax year2007 No 97 s HL 24(1)–(4)Quarterly calculation optionQuarterly calculationQuarterly paymentExiting investors: zero-ratedExiting investors: remaining value to CommissionerProvisional tax rulesDefined in this Act: amount, Commissioner, exit level, exit period, income tax liability, investor interest, multi-rate PIE, notice, pay, PIE, provisional tax, quarter, tax year, working day, zero-rated investor2007 No 97 s HL 22Provisional tax calculation optionWhen this section appliesApplication of subparts RB and RCTreatment of lossesDefined in this Act: income tax liability, income year, multi-rate PIE, notify, pay, PIE, provisional tax, tax year2007 No 97 s HL 23(1), (2)Voluntary paymentsWhen this section appliesVoluntary paymentTime of paymentDefined in this Act: amount, Commissioner, income tax, investor, investor class, investor interest, multi-rate PIE, pay, PIE, quarter2007 No 97 s HL 25Calculation processDefined in this Act: amount, attribution period, investor, investor class, multi-rate PIE, PIE2007 No 97 ss HL 19, HL 20Calculation of tax liability or tax credit of multi-rate PIEs What this section doesCalculating amountFormulaDefinition of items in formulaResult of formula: tax liability or tax creditDefined in this Act: amount, attribution period, calculation period, investor, investor class, investor interest, multi-rate PIE, PIE, tax credit2007 No 97 ss EG 3, HL 21Adjusting investors’ interestsAdjustments to investors’ interests or to distributions AdjustmentInvestor's choiceDate of adjustmentExtending time limitsDefined in this Act: amount, income year, investor, investor interest, multi-rate PIE, pay, PIE, prescribed investor rate, provisional tax, quarter, tax year2007 No 97 s HL 7Using tax creditsTax credits: when sections HM 50 to HM 55 applyWhen sections applyLimitationRelationship with Part L Defined in this Act: income tax, income tax liability, investor, multi-rate PIE, provisional tax, tax credit2007 No 97 s HL 29(1), (2)Attributing credits to investorsWhen this section applies Attributing amount to investorCalculation of amount Definition of items in formulaDefined in this Act: amount, attribution period, imputation credit, investor, investor class, multi-rate PIE, pay, PIE, tax credit2007 No 97 ss HL 29(3)–(5), YA 1 portfolio class fraction, portfolio investor interest fractionUse of foreign tax credits by PIEsWhen this section applies Using tax credit to satisfy income tax liabilityAmountUse under exit calculation optionUse under quarterly optionDefined in this section: amount, calculation period, income tax liability, investor, investor class, multi-rate PIE, PIE, quarter, tax credit, tax year, zero-rated investor2007 No 97 s HL 29(10)–(12)Use of foreign tax credits by zero-rated and certain exiting investorsWhen this section applies Using tax credit to satisfy income tax liabilityAmountAmount for PIEs or proxiesDefined in this Act: amount, attributed PIE income, attribution period, exit period, foreign tax, income tax liability, investor, multi-rate PIE, notified investor rate, notify, PIE, tax credit, tax year, zero-rated investor2007 No 97 s HL 29(7), (8)Use of tax credits other than foreign tax credits by PIEs When this section appliesUsing tax credit to satisfy income tax liabilityAmountDefined in this Act: amount, income tax liability, investor, investor class, multi-rate PIE, tax credit, tax year, zero-rated investor2007 No 97 s HL 29(13)Use of tax credits other than foreign tax credits by investorsWhen this section appliesUsing tax credit to satisfy income tax liabilityAmountDefined in this Act: amount, income tax liability, investor, multi-rate PIE, tax credit, tax year, zero-rated investor2007 No 97 s HL 29(7)(b)Tax credits for losses Defined in this Act: amount, multi-rate PIE, provisional tax, tax credit, tax year2007 No 97 s HL 28Prescribed and notified rates for investors in multi-rate PIEsPrescribed investor rates for investors generallyDefined in this Act: investor, multi-rate PIE, prescribed investor ratePrescribed investor rates for certain natural person investors: 19.5% Defined in this Act: amount, attributed PIE income, income year, investor, multi-rate PIE, prescribed investor rate, resident in New Zealand, tax year, taxable income, trustee2007 No 97 s YA 1 portfolio investor rate, prescribed investor rateOptional investor rates for trustees: 30%, 19.5%Defined in this Act: investor, multi-rate PIE, trusteePrescribed investor rates for certain investors: 0% Defined in this Act: amount, company, exempt income, investor, multi-rate PIE, PIE, prescribed investor rate, resident in New Zealand, superannuation fund, trustee2007 No 97 s YA 1 prescribed investor rateNotified rates Notifying PIETime of notificationApplication of rateWhen chosen rate lower than rate in sections HM 56 to HM 59When rate disregardedWhen no rate notifiedDefined in this Act: Commissioner, excluded income, income, investor, multi-rate PIE, notify, notified investor rate, pay, PIE, prescribed investor rate, tax file number2007 No 97 s YA 1 portfolio investor rate, prescribed investor rateCertain exiting investors zero-ratedDefined in this Act: income, investor, multi-rate PIE, pay, PIE, quarter2007 No 97 s YA 1 portfolio investor rate, prescribed investor rateExit levels and periodsExit levels for investorsDefined in this Act: exit level, investor, investor interest, multi-rate PIE, PIEExit periods When this section appliesExit period: exit calculationExit period: quarterly calculationVoluntary payments of taxDefined in this Act: exit level, investor, multi-rate PIE, pay, PIE, quarter, tax year, working day2007 No 97 s YA 1 portfolio investor exit periodTreatment of losses by PIEsLosses of certain multi-rate PIEsUse of investor classes’ lossesWhen this section applies Amount not carried forwardTax creditsDefined in this Act: amount, calculation period, investor class, land loss, loss balance, pay, PIE, tax credit, zero-rated investor2007 No 97 s HL 32(1)Use of land losses of investor classesWhen this section appliesAmount carried forwardMeaning of land lossDefined in this Act: amount, calculation period, investor class, investor interest, land, land investment company, land loss, loss balance, market value, multi-rate PIE, pay, PIE, quarter, share, tax loss, taxable income2007 No 97 s HL 32(2), (3)Formation lossesFormation losses carried forward to tax yearWhat this section applies toAmount carried forwardDefined in this Act: amount, formation loss, loss balance, multi-rate PIE, pay, PIE, quarter, tax, tax year2007 No 97 s HL 30(1), (2)Formation losses carried forward to first quarter When this section applies Amount carried forwardDefined in this Act: amount, formation loss, multi-rate PIE, pay, PIE, quarter2007 No 97 s HL 30(1)When formation losses carried forward are less than 5% of formation investment valueDefined in this Act: amount, attribution period, formation loss, investor class, market value, PIE, taxable amount2007 No 97 s HL 30(3)When formation losses carried forward are 5% or more of formation investment value: 3-year spreadWhat this section applies toAmountDefinition of items in formulaUnused formation lossesTreatment after 3-year periodDefined in this Act: amount, attribution period, formation loss, investor class, market value, PIE, tax year, taxable amount2007 No 97 s HL 30(4), (5)Maximum amount of formation losses allocated by multi-rate PIEs to investor classes Maximum amount for allocation Definition of items in formulaDefined in this Act: amount, attribution period, company, FDP credit, formation loss, imputation credit, investor class, Maori authority credit, net income, RWT2007 No 97 s HL 30(6), (7)Elections and consequencesChoosing to become PIE Defined in this Act: Commissioner, notify, PIE2007 No 97 s HL 11(1), (3)When elections take effectNotice of electionWhen entity does not meet basic requirementsNotice of cancellationDefined in this Act: Commissioner, notice, PIE2007 No 97 ss HL 11(2), (2B), (4), HL 13(1), (4), HL 15(2)Transition: provisional taxWhen this section appliesPenalties and interest Tax liabilityDefined in this Act: amount, Commissioner, income tax, income year, pay, PIE, provisional tax, tax year2007 No 97 s HL 14Transition: entities with non-standard income yearsWhen this section applies Consequential changes in balance dateDefined in this Act: Commissioner, non-standard income year, pay, PIE, quarter2007 No 97 s HL 13(2)Transition: treatment of shares held in certain companies When subsection (2) appliesDisposal and reacquisitionTiming When subsection (5) applies Disposal and reacquisitionTiming Defined in this Act: amount, company, exempt income, market value, PIE, returning share transfer, share, shareholder2007 No 97 ss HL 13(3), HL 15(3)Transition: FDPA companiesDefined in this Act: FDP account, FDPA company, PIE, tax year 2007 No 97 s HL 13(3B).
  ...
  (2) An entity that chooses to become a PIE must be 1 of the following types of entity:
    ...
    (d) a life fund PIE.
  (3) Despite subsection (2), an entity that chooses to become a listed PIE may choose to become a multi-rate PIE if it meets the requirements of the entry rules set out in sections HM 7 to HM 30.
  ...
  (2) The investment must carry voting interests in the company of no more than 20%. This subsection does not apply to a unit trust. Subsection (5) overrides this subsection.
  ...
  (1) If the entity is not a company listed on a recognised exchange in New Zealand, each investor class must include 20 or more persons.
  ...
  (3) Subsection (4) and sections HM 21(1) and HM 22 override subsection (1).
  (1) An investor in an investor class must not hold more than 20% of the total interests of investors in the class.
  (2) Sections HM 21(2) to (4), HM 22, and HM 22B override this section.
  ...
  (3) This section does not apply if the proceeds are category B income.
  ...
  An entity loses PIE status immediately if it is no longer resident in New Zealand.
  ...
  (2) The date of loss of PIE status is—
    ...
    (b) when subsection (1)(b)(i) does not apply, the last day of the second quarter.
  (3) Subsection (1) does not apply if—
    ...
    (b) the first quarter ends more than 3 months before an announcement by the entity to its investors that it, or the relevant investor class, is winding up within 12 months of the announcement.
  ...
  A listed PIE loses PIE status immediately if it fails to meet the requirements of section HM 19.
  ...
  (1) A foreign PIE equivalent loses its status immediately if it becomes resident in New Zealand.
  (2) A foreign PIE equivalent loses its status if it no longer meets the requirements set out in section HM 3(b) to (e) at the end of 2 consecutive quarters. The loss of status takes effect from the first day of the third quarter.
  ...
  (3) For the purposes of subsection (1), income derived under section CS 1 (Withdrawals) by a multi-rate PIE that is a superannuation fund is treated as income to which no investor has an investor interest.
  ...
  (2) In the investor's income year in which the end of the PIE's income year falls, the investor is allowed a deduction under section DB 53 (Attributed PIE losses of certain investors). The amount of the deduction is equal to the amount attributed for the income year or exit period.
  ...
  (1) This section applies when a multi-rate PIE chooses for a tax year to calculate its income tax liability for exiting investors and remaining investors. The PIE must notify the Commissioner under section 31B of the Tax Administration Act 1994 of this election.
  ...
  (1) This section applies when a multi-rate PIE pays an amount of tax under section HM 42 or HM 43 and an investor reduces their investor interest in an investor class of the PIE.
  ...
  (1) This section applies when a multi-rate PIE has—
    ...
    (c) a credit for tax paid in a foreign country or territory under subpart LJ (Tax credits for foreign income tax).
  ...
  (2) The PIE may use the tax credit under section LS 1 (Tax credits for multi-rate PIEs) to satisfy its income tax liability for the tax year in relation to the investor as a member of the class or of another investor class. A tax credit under this section is used only after the use of any credit under section HM 52.
  ...
  An investor in a multi-rate PIE has a prescribed investor rate of 30% unless sections HM 56 to HM 61 apply.
  An investor in a multi-rate PIE who is a natural person (other than a trustee) has a prescribed investor rate of 19.5% if—
    ...
    (b) they have, in either of the 2 income years immediately before the tax year,—
      ...
      (ii) a total amount of $60,000 or less of taxable income and attributed PIE income less any attributed PIE loss.
  An investor in a multi-rate PIE who is a trustee of a trust other than a trust referred to in section HM 59(b) may choose to have an investor rate of either 30% or 19.5%.
  An investor (a zero-rated investor) in a multi-rate PIE has a prescribed investor rate of 0% if they are resident in New Zealand and are—
    ...
    (f) a superannuation fund, unless the trustee chooses the 30% or 19.5% rate under section HM 58.
  (1) Despite sections HM 56 to HM 59, an investor who has provided their tax file number to a multi-rate PIE may notify the PIE of the investor rate to be applied for a period. Section 28B of the Tax Administration Act 1994 sets out the requirements for the notice.
  ...
  (4) If an investor notifies an investor rate that is lower than their prescribed investor rate that would apply under sections HM 56 to HM 59, income attributed to them by the PIE is not excluded income of the investor under sections CX 56 and CX 56B (which relate to attributed income of and distributions to certain investors in multi-rate PIEs).
  (5) The Commissioner may notify a PIE to disregard an investor rate notified by an investor if the Commissioner considers the rate is incorrect. The 30% default rate under section HM 56 then applies.
  (6) If an investor does not notify a multi-rate PIE of their investor rate, the rate applying for a period is 30%.
  ...
  (3) To the extent to which the amount relates to an investor other than a zero-rated investor, the PIE has a tax credit under section LS 1 (Tax credits for multi-rate PIEs). The amount of the credit is calculated under section HM 47(5).
  ...
  (2) The amount of formation loss may be carried forward under Part I (Losses) to the quarter in which the entity becomes a PIE.
  ...
  (5) After the end of the period of 3 years referred to in subsection (1), any residual formation loss may be carried forward to a tax year in which the entity is a PIE under section HM 66.
  ...
  (2) Despite subsection (1), an entity's election to become a PIE does not take effect if, in the period ending 12 months after the date on which the election would be effective,—
    ...
    (b) an event or situation arises that means the entity would lose PIE status under any of sections HM 24 to HM 28.
...
(1) Section HR 8(1) is replaced by the following:Provisions under which transitional resident treated as non-resident
...
(2) In section HR 8(2),—
  ...
  (b) in paragraph (b), section YD 1(2) to (4) is replaced by section YD 1(2) and (3), ignoring the rule in section YD 1(4),.
(3) In section HR 8(3),—
  (a) in paragraph (a), subsection (2)(b) is replaced by subsection (2)(a):
  (b) in paragraph (b)(ii), section YD 1(2) to (4) is replaced by section YD 1(2) and (3), ignoring the rule in section YD 1(4),.
(4) In section HR 8(4), may choose by notice under subsection (5) is replaced by may choose by notice to the Commissioner or by notice under subsection (5).
(5) After section HR 8(6), the following is added:Notice of election
...
(1) After section HR 8, the following is added:RMBS special purpose vehiclesRMBS special purpose vehicles are transparentDefined in this Act: arrangement, Inland Revenue Acts, registered bank, RMBS special purpose vehicleWhat happens when vehicle stops being RMBS special purpose vehicle?Property transferred and parties reconstitutedProperty transferred: market value Parties reconstituted: considerationDefinitionDefined in this Act: arrangement, company, consideration, dispose, liquidation, registered bank, residential mortgage backed securities, RMBS special purpose vehicle, trustee, unwind.
  For the purposes of the liabilities and obligations under an Inland Revenue Act of a registered bank described in the definition of RMBS special purpose vehicle, paragraph (b), and the relevant RMBS special purpose vehicle,––
    ...
    (d) the registered bank is treated as doing a thing and being entitled to a thing that the RMBS special purpose vehicle does or is entitled to, and the RMBS special purpose vehicle is treated as not doing that thing or being entitled to that thing.
  (1) When a company or a trustee of a trust (the vehicle) stops being an RMBS special purpose vehicle for any reason, other than on unwind, the following apply:
    (a) the relevant registered bank is treated as disposing of its property (the property) that has been subject to section HR 9(b) in relation to the vehicle immediately before the vehicle stops being an RMBS special purpose vehicle:
    ...
    (c) the relevant registered bank is treated as not being a party to an arrangement (the arrangement) that it was treated as being a party to under section HR 9(c) in relation to the vehicle immediately before the vehicle stops being an RMBS special purpose vehicle:
    (d) the vehicle is treated as being a party to the arrangement immediately after the vehicle stops being an RMBS special purpose vehicle.
  (2) The disposition of property in subsection (1)(a) and the acquisition of property in subsection (1)(b) are treated as occurring with a single third party for a payments equal to the property's market value.
  (3) At the time the registered bank or the vehicle becomes a party to an arrangement under subsection (1)(c) or (d), the market value, at that time, of consideration that has been paid, or is or will be payable, to or by the registered bank or vehicle (as applicable) for or under the arrangement, ignoring section HR 9(c), is treated as consideration that has been paid, or is or will be payable, to or by the registered bank or vehicle for or under the arrangement.
  (4) In this section, unwind means a process, ignoring section HR 9, by which––
    ...
    (b) interests described in the definition of RMBS special purpose vehicle, paragraph (b), are transferred to the registered bank; and
    (c) the vehicle is terminated, by liquidation or otherwise.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 295 New sections HZ 5 and HZ 6 added
(1) After section HZ 4, the following is added:Transitional provisions for PIE rulesIntention of new lawUsing old law as interpretation guideLimits to subsections (1) and (2)Defined in this Act: PIE rules, portfolio investment entitySaving of binding rules relating to portfolio investment entitiesWhen, and extent to which, this section appliesRuling about new lawNo confirmation rulingsDefined in this Act: arrangement, binding ruling, Commissioner, PIE rules, portfolio investment entity.
  ...
  (3) Subsections (1) and (2) do not apply in the case of—
    ...
    (b) a PIE rule that is amended after the commencement of section 292(2) of this Act, with effect from the date on which the amendment comes into force.
...
(2) In section IA 7(5), provisions that deal with this net loss is replaced by provisions that deal with this net loss, other than the surplus amount,.
(3) In section IA 7(6), IQ 3 is replaced by IQ 3(3).
(4) Section IA 7(10) is replaced by the following:Net losses of multi-rate PIEs
...
(6) In section IA 7, in the list of defined terms,—
  (a) portfolio tax rate entity is omitted:
  (b) multi-rate PIE, PIE, and provisional tax are inserted.
...
(2) Section IA 8(1)(a) is repealed.
...
(1) Section IC 3(2B)(b) is replaced by the following:
  (b) the other companies in the group are either portfolio tax rate entities or portfolio land companies.
(2) Section IC 3(2B) is replaced by the following:When multi-rate PIEs included in group
...
(3) In section IC 3, in the list of defined terms,—
  (a) portfolio land company and portfolio tax rate entity are omitted:
  (b) land investment company, multi-rate PIE, and voting interest are inserted.
(4) Subsection (1) applies for the 2008–09 and 2009–10 income years.
(5) Subsection (2) applies for the 2010–11 and later income years.

### 299 New section IC 13 added
After section IC 12, the following is added:Variation of requirements for development companies in NiueWhen this section appliesOrder in CouncilNamed companyApplication of orderDefined in this Act: business, commonality period, company, group of companies, income.
...
(1) Section ID 3(1), other than the heading, is replaced by the following:
...
(2) In section ID 3, in the list of defined terms, tax loss component is inserted.
(3) Subsection (1) applies for the 2008–09 and later income years.

### 301 When this subpart applies
(1) Section IP 1(1)(a) and (b) are replaced by the following:
...
(1) After section IQ 2(1), the following is inserted:Attributed CFC net losses from year after transitionAttributed CFC net losses from income year before transition
  (1B) If a person's attributed CFC net loss relates to an income year for which section IQ 2B applies to the person and is carried forward to the tax year, the amount used for the tax year in reducing the person's net income is equal to the amount subtracted under subsection (1).
...
(2) Section IQ 2(3), other than the heading, is replaced by the following:
...
(1) After section IQ 2, the following is inserted:Attributed CFC net loss from tax year before first affected yearWhen this section appliesWhat this section doesOption: loss not carried forwardPerson not resident group member: more jurisdictional BE incomePerson not resident group member: more jurisdictional attributed incomeResident group member: more jurisdictional BE incomeResident group member: more jurisdictional attributed income Election by person or group to fix jurisdictional income ratioSome definitionsOption to determine jurisdictional BE income from accountsDefined in this Act: attributed CFC income, attributed CFC loss, branch equivalent income, branch equivalent loss, CFC, group of companies, income interest, jurisdictional attributed income, jurisdictional BE income, jurisdictional income ratio, New Zealand resident, resident group member, tax year, wholly-owned group, wholly-owned group of companies.
  ...
  (2) In this section, subsection (3) gives the person an option that available BE loss for a jurisdiction not be carried forward and subsections (4) to (7) give, for whichever of the 4 possible alternative situations is relevant for the person,—
    ...
    (b) the amount (the equivalent CFC loss) of attributed CFC net loss that, for the purposes of the rest of this subpart, is treated as arising on the last day of the conversion year.
  ...
  (9) For a person or wholly-owned group and a tax year for which the person or members of the wholly-owned group have an income interest in a CFC that is resident in a country or territory (the jurisdiction),—
    ...
    - **jurisdictional BE income** means,—
      ...
      (b) for a wholly-owned group and the tax year, the amount that is the greater of zero and the amount calculated, treating losses as negative, by—
        ...
        (ii) consolidating the results for the purposes of the financial statements of the group
    - **jurisdictional income ratio** ,—
      ...
      (c) for a person or wholly-owned group that has made an election under subsection (8) for the tax year, means the amount given by subsection (8) for the person or group and the tax year
...
(2) After section IQ 3(2), the following is added:Treatment of excess
...
(3) In section IQ 3, in the defined terms list, attributed CFC income and CFC are inserted.
(4) Subsections (1) and (2) apply for the 2008–09 and later income years.

### 305 Group companies using attributed CFC net losses
(1) In section IQ 4(3)(a), the words before subparagraph (i) are replaced by the following:.
  (a) the amount of the tax loss that company A may make available to another group company (company B) in the tax year may not be greater than the amount that company B would require as attributed CFC net loss from the same income year or income years to produce a reduction in company B's net income for the tax year equal to the total of—
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 306 Group companies using FIF net losses
(1) Section IQ 5(3)(a) is replaced by the following:
...
(2) In section IQ 5, in the defined terms list, attributed CFC income and CFC are inserted.
(3) Subsection (1) applies for the 2008–09 and later income years.

### 307 Subpart IT replaced
(1) Subpart IT is replaced by the following:Cancellation of life insurer's lossesCancellation of life insurer's policyholder net lossesWhat this section applies toCancellation of life insurer's policyholder net lossesDefined in this Act: available tax loss, income year, life insurer, net income, policyholder net loss, ring-fenced tax loss, tax loss, tax loss component, tax yearCancellation of life insurer's tax loss when allowed into policyholder baseWhat this section applies toCancellation of life insurer's tax lossDefined in this Act: available tax loss, income year, life insurer, net income, policyholder base allowable deduction, tax loss, tax loss component, tax year.
...
(1) In section LA 6(1)(e), authority credits). is replaced by authority credits): and the following is added:
  (f) section LS 1 (Tax credits for portfolio tax rate entities and investors).
(2) In section LA 6(1)(f), (Tax credits for portfolio tax rate entities and investors) is replaced by (Tax credits for multi-rate PIEs).
(3) Subsection (2) applies for the 2010–11 and later income years.

### 309 Remaining refundable credits: tax credits for families
(1) In section LA 7, the heading is replaced by Remaining refundable credits: tax credits under social policy schemes.
(2) Section LA 7(1) is replaced by the following:What this section applies to
...
(1) After section LA 8, the following is inserted:General rules particular to life insurersApportionmentUnsatisfied income tax liabilityUse of creditsDefined in this Act: income tax liability, life insurer, policyholder base, schedular policyholder base income, shareholder base, shareholder base allowable deduction, shareholder base income, tax credit, tax year.
...
(1) In section LA 9, Section OZ 11 (Tax credits for imputation credits and FDP credits) may apply to modify this section. is omitted.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 312 Section LB 1 replaced
Section LB 1 is replaced by the following:Tax credits for PAYE income paymentsWhen this section appliesAmount of creditApplication to close companiesExclusionsDefined in this Act: amount, amount of tax, associated person, close company, Commissioner, employee, employer, employer monthly schedule, pay, PAYE income payment, tax credit.
...
(1) Section LB 3(3) is replaced by the following: Multi-rate PIEs and their investors
...
(2) In section LB 3, in the list of defined terms, portfolio tax rate entity is omitted and multi-rate PIE is inserted.
(3) Subsection (1) applies for the 2010–11 and later income years.

### 314 Tax credits for families
(1) In section LB 4, the following is inserted as a subsection heading:Tax credits under subparts MD and ME.
(2) In section LB 4, the following is added as subsection (2): Adjustments for credits used
...
(3) In section LB 4, in the list of defined terms, amount of tax, corresponding income year, and pay are inserted.
(4) In section LB 4, in the compare note, , MD 1(3A) is added.
...
(1) Section LB 7(4)(b) is replaced by the following:
...
(1) Section LB 8(3)(c) is replaced by the following:
...
(1) In section LC 4(4), in the formula, 0.020 is replaced by 0.20.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 318 Tax credits for housekeeping
In section LC 6(4), section LA 7 (Remaining refundable credits: tax credits for families) is replaced by section LA 7 (Remaining refundable credits: tax credits under social policy schemes).

### 319 Subpart LD heading replaced
The heading to subpart LD is replaced by Tax credits for gifts and donations.

### 320 New heading inserted
Before section LD 1, Charitable and other public benefit gifts is inserted as a cross heading.

### 321 Tax credits for charitable or other public benefit gifts
In section LD 1(5), section LA 7 (Remaining refundable credits: tax credits for families) is replaced by section LA 7 (Remaining refundable credits: tax credits under social policy schemes).

### 322 Exclusions
(1) In section LD 2, the words before paragraph (a) are replaced by Section LD 1 does not apply to—.
(2) In section LD 2(f), trusts). is replaced by trusts):, and the following is added:
...
After section LD 3, the following is added:Payroll donationsTax credits for payroll donationsWho this section applies toAmount of creditDefinition of item in formulaMaximum creditNon-refundable creditsNo refunds for donationsMeaning of pay for payroll donation purposesDefined in this Act: amount, amount of tax, employee, employer, employer monthly schedule, employment, non-refundable tax credit, pay, pay period, PAYE income payment, PAYE income payment form, payroll donation, salary or wages, tax creditCalculating amount of tax credit and filing particularsEmployer's responsibilityCredit extinguishedWhen matters correctedDefined in this Act: amount, Commissioner, employer, employer monthly schedule, pay period, PAYE income payment form, payroll donation, tax creditWhen donation is paid to ineligible recipient When this section appliesCredit extinguishedConsequences when credit extinguishedDefined in this Act: amount, amount of tax, donee organisation, employer, pay period, PAYE income payment, payroll donation, tax credit, tax yearWhen donation returned to personWhen this section appliesTreatment of creditConsequences when credit extinguishedDefined in this Act: amount, amount of tax, pay period, PAYE income payment, payroll donation, tax credit, tax yearMeaning and ranking of payroll donationMeaningPriorities of amounts withheld and other deductionsDefined in this Act: amount, donee organisation, pay, pay period, PAYE income payment, payroll donation.
  ...
  (2) The person has a tax credit for the pay period equal to an amount calculated using the formula—total donations × 3313%.
...
(1) In section LE 1(1), Section OZ 11 (Tax credits for imputation credits and FDP credits) may apply to modify this section. is added after tax year.
(2) After section LE 1(1), the following is inserted: Portfolio tax rate entities and their investors
...
(3) Section LE 1(1B), is replaced by the following:Multi-rate PIEs and their investors
...
(4) Section LE 1(4) is repealed.
(5) In section LE 1, in the list of defined terms, portfolio tax rate entity is omitted, and multi-rate PIE is inserted.
(6) Subsection (1) applies for the 2008–09 and later income years.
(7) Subsection (3) applies for the 2010–11 and later income years.

### 325 Use of remaining credits by companies and trustees
(1) Section LE 2(1) is replaced by the following:When this section applies
  (1) This section applies when––
...
(2) In section LE 2(2),––
  (a) in the words before the paragraphs, subsection (1) is replaced by subsection (1)(a):
  (b) in paragraph (a), company is replaced by company that is not a life insurer.
(3) In section LE 2(3), The person is replaced by The person or the life insurer, as applicable,.
(4) In section LE 2(4)(a), section LA 5(4) is replaced by section LA 5(4), but, for a life insurer, only to the extent to which the amount is for their shareholder base.
(5) In section LE 2, in the list of defined terms, life insurer and shareholder base are inserted.
(6) Subsections (1) to (4) apply––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.

### 326 New section LE 2B inserted
(1) After section LE 2, the following is inserted:Use of remaining credits by life insurer on policyholder baseWhen this section appliesPolicyholder base allowable deductionDefinition of items in formulaDefined in this Act: amount, deduction, income tax, income year, life insurer, policyholder base, policyholder base allowable deduction, tax credit, tax year.
...
(1) In section LE 3(1), section LE 2(2) is replaced by section LE 2(2) or a life insurer.
(2) In section LE 3, in the list of defined terms, life insurer is inserted.
(3) Subsection (1) applies––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.

### 328 Tax credits for FDP credits
(1) Section LF 1(4) is replaced by the following: Multi-rate PIEs and their investors
...
(2) In section LF 1, in the list of defined terms,—
  (a) portfolio tax rate entity is omitted:
  (b) multi-rate PIE is inserted.
(3) Subsection (1) applies for the 2010–11 and later income years.

### 329 Subpart LH—Tax credits for expenditure on research and development
In sections LH 1 to LH 17, the compare notes are repealed.

### 330 Who this subpart applies to
(1) After section LH 1(1)(a), the following is inserted:.
...
(2) After section LH 1(2)(a), the following is inserted:.
  (ab) a Crown entity, as that term is defined in the Crown Entities Act 2004:
(3) In section LH 1(2),––
  (a) in paragraph (b), paragraph (a) is replaced by paragraph (a) or (ab):
  (b) in paragraph (c), paragraph (a) or (b) is replaced by paragraph (a), (ab), or (b).
(4) After section LH 1(2), the following is added:Excluded income
  (3) A tax credit that a person has under this subpart is excluded income of the person.
(5) In section LH 1, in the list of defined terms, excluded income, group of companies, and New Zealand resident are inserted.
...
(1) After section LH 2(6), the following is added:Treatment when tax credit used under subsection (6)
...
### 332 Requirements
(1) After section LH 3(1)(a)(i), the following is inserted:.
...
(2) After section LH 3(5), the following is added:Groups of companies
...
(3) In section LH 3, in the list of defined terms, control, group of companies, and New Zealand resident are inserted.
(4) Subsections (1) and (2) apply for the 2008–09 and later income years.

### 333 Adjustments to eligible expenditure
(1) In section LH 5(4), paragraph (c) is replaced by the following:
...
(2) In section LH 5, in the list of defined terms, employee, employment income, and shareholder-employee are inserted.
(3) Subsection (1) applies for the 2008–09 and later income years.

### 334 New section LH 14B inserted
(1) After section LH 14, the following is inserted:Recovery of overpaid tax creditWhen this section appliesRecovery of overpaymentDefined in this Act: amount, Commissioner, income tax, pay, tax credit, tax year.
  (1) This section applies when the Commissioner considers the amount of a tax credit under this subpart that is used under sections LA 2, LA 6(2), or LH 2(6) (which relate to tax credits) for a tax year is more than the proper amount.
  (2) The Commissioner may recover the excess as if it were income tax payable by the person.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 335 What this subpart does
(1) Section LJ 1(3) is repealed.
(2) After section LJ 1(5), the following is added:Relationship with section YD 5
...
(1) Section LJ 2(2), other than the heading, is replaced by the following:
...
(2) Section LJ 2(5) is replaced by the following: Multi-rate PIEs and their investors
...
(3) After section LJ 2(5), the following is added:When subsection (7) appliesTax credit
...
(4) In section LJ 2, in the list of defined terms,—
  (a) portfolio tax rate entity is omitted:
  (b) multi-rate PIE is inserted.
(5) In section LJ 2, in the list of defined terms, attributing interest, FIF, FIF income, income, and tax credit are inserted.
...
Section LJ 3 is replaced by the following:Meaning of foreign income taxDefined in this Act: amount, income tax2004 No 35 s LC 1(1).
  For the purposes of this Part, foreign income tax means an amount of income tax of a foreign country.

### 338 Calculation of New Zealand tax
(1) In section LJ 5(4), in the formula, the denominator NZ tax under subsection (2) for all segments is replaced by NZ tax.
(2) After section LJ 5(4), the following is inserted:Definition of item in formula
  (4B) In the formula in subsection (4), NZ tax is the amount of New Zealand tax that would be calculated under subsection (2) if that subsection applied to all income of the person from all sources.
(3) Section LJ 5(6)(b) is replaced by the following:.
  (b) losses—
...
(4) In section LJ 5, in the list of defined terms, New Zealand is inserted.
(5) Subsections (1) to (3) apply for the 2008–09 and later income years.

### 339 Section LJ 7 replaced by new sections LJ 7 and LJ 8
(1) Section LJ 7 is replaced by the following:Repaid foreign tax: effect on income tax liabilityWho this section applies toWhen refund received before assessmentWhen refund received after assessmentDate for paymentAssociated personsDefined in this Act: amount, associated person, Commissioner, foreign income tax, income tax liability, New Zealand, New Zealand tax, pay, return of income, segment of foreign-sourced income, tax credit, tax year2004 No 35 ss LC 1(3A), (3B), LC 3Repaid foreign tax: effect on FDP liabilityWho this section applies toWhen refund received before calculation of FDPWhen subsection (4) appliesWhen refund received after calculation of FDPDate for paymentAssociated personsDefined in this Act: amount, associated person, Commissioner, FDP, foreign dividend, foreign dividend company, foreign income tax, income tax, pay, tax year2004 No 35 ss LC 1(3A), (3B), LC 3.
  ...
  (3) If the person receives the refund after they have assessed their income tax liability for a tax year, have used an amount of foreign tax credit in satisfying that liability, and have not taken the refund into account in that assessment, the person is liable to pay the Commissioner the lesser of—
    (a) the amount of the refund:
    (b) the amount of New Zealand tax payable on the foreign income calculated under section LJ 5.
  (4) In subsection (3), the date for payment is the later of—
    (a) the date on which the person receives the refund:
    (b) 30 days after the date on which the person's return of income for the tax year is filed.
...
(1) Section LK 1(1), other than the heading, is replaced by the following:
...
(2) In section LK 1(3),—
  (a) foreign country is replaced by foreign country or territory:
  (b) the second sentence is omitted.
(3) After section LK 1(4), the following are added:When subsection (7) appliesWhen refund received before assessmentCredit repayable or extinguishedWhen liability payableAssociated persons
  ...
  (8) The liability under subsection (7)(a) is treated as income tax payable 30 days after the later of the following dates:
    ...
    (b) the date on which the person who paid the tax, or a person associated with them, receives the refund.
...
(4) In section LK 1, in the list of defined terms, assessment, associated person, Commissioner, international tax rules, New Zealand tax, notice, NRWT, and segment of foreign-sourced income are inserted.
(5) In section LK 1, in the list of defined terms, conduit tax relief and CTR company are omitted.
...
(1) Section LK 2(2)(b) is replaced by the following:.
  (b) tax paid is the amount of income tax or foreign income tax paid or payable by the CFC for the accounting period corresponding to the tax year, including an amount withheld by another person and paid or payable on behalf of the CFC:
(2) Subsection (1) applies for the 2008–09 and later income years.

### 342 New section LK 5B inserted
(1) After section LK 5, the following is inserted:Credits from tax year before first affected yearWhen this section appliesWhat this section doesOption: tax credit not carried forwardPerson not resident group member: more jurisdictional BE incomePerson not resident group member: more jurisdictional attributed incomeResident group member: more jurisdictional BE incomeResident group member: more jurisdictional attributed incomeOption to determine jurisdictional BE income from accountsDefined in this Act: attributed CFC income, attributed CFC loss, branch equivalent income, branch equivalent loss, CFC, group of companies, income interest, jurisdictional attributed income, jurisdictional BE income, jurisdictional income ratio, New Zealand resident, resident group member, tax year, wholly-owned group, wholly-owned group of companies.
...
(1) Subpart LL is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 344 Use of remaining credits
(1) In section LP 3(5), subsection (3) is replaced by subsection (2) or (3).
(2) Subsection (1) applies for the 2008–09 and later income years.

### 345 Continuity rules for carrying credits forward
(1) Section LP 4(2), other than the heading, is replaced by the following:
...
(2) In section LP 4, in the list of defined terms, market value circumstance is inserted.
(3) Subsection (1) applies for the 2008–09 and later income years.

### 346 Sections LQ 1 to LQ 4 repealed
(1) Sections LQ 1 to LQ 4 are repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 347 Tax credits for certain investors in portfolio tax rate entities
(1) Section LS 2(1), other than the heading, is replaced by the following:
...
(2) In section LS 2(1)(a), section CX 56(1)(b) (Portfolio investor allocated income and distributions of income by portfolio investment entities) is replaced by section CX 56(1)(b) (Attributed income of certain investors in multi-rate PIEs).

### 348 Subpart LS replaced
(1) Subpart LS is replaced by the following:Tax credits for multi-rate PIEs and investorsTax credits for multi-rate PIEs Tax creditWhen this section does not applyAmount of creditTimingException: timing under exit calculation optionDefined in this Act: amount, calculation period, imputation credit, income tax liability, investor, multi-rate PIE, pay, PIE, provisional tax, tax credit, tax loss, tax year, zero-rated investor2007 No 97 s LS 1 Tax credits for investors in multi-rate PIEsWhen this section appliesAmount of creditDefined in this Act: amount, attributed PIE income, excluded income, income, income year, investor, multi-rate PIE, pay, PIE, prescribed investor rate, tax credit, tax year2007 No 97 s LS 2 Tax credits for zero-rated investors When this section appliesAmount of creditCredit for PIE's foreign taxCredit for PIE's other tax creditsTimingDefined in this Act: amount, attributed PIE income, income tax, income tax liability, income year, multi-rate PIE, pay, PIE, tax credit, tax year, zero-rated investor2007 No 97 s LS 3 Tax credits for certain exiting investors When this section appliesAmount of creditCredit for PIE's foreign taxCredit for PIE's other tax creditsTimingDefined in this Act: attributed PIE income, exit period, foreign income tax, income tax liability, income year, investor, investor interest, multi-rate PIE, pay, PIE, tax credit, tax year2007 No 97 s LS 4.
  ...
  (1) This section applies when—
    ...
    (c) the income is not excluded income of the investor because the test in section CX 56(1)(b) (Attributed income of certain investors in multi-rate PIEs) is not met.
  (2) The investor has a tax credit for the income year in which the PIE's tax year ends. The amount of the credit is equal to the amount of income tax paid by the PIE in relation to the attributed PIE income, and may be used to satisfy the investor's income tax liability for the tax year.
  (1) This section applies when a zero-rated investor has attributed PIE income from a multi-rate PIE for a tax year.
  (2) The investor has a tax credit that may be used to satisfy their income tax liability for the tax year equal to the amount of income tax paid by the PIE for the attributed income for the tax year.
  (3) A zero-rated investor also has a tax credit for the tax year for the amount determined under section HM 52 (Use of foreign tax credits by zero-rated and certain exiting investors) for foreign income tax paid by the PIE.
...
(1) In section MA 7(2), in the words before paragraph (a), the purposes of subsection (1)(a) is replaced by the purposes of subsection (1).
(2) In section MA 7(2)(b), subsection (1)(a) to (c) or to the extent described in subsection (1)(d) is replaced by subsection (1)(a) and (b).
(3) In section MA 7, in the list of defined terms, employment is inserted.
(4) Subsections (1) and (2) apply for the 2008–09 and later income years.

### 350 Some definitions for family scheme
In section MA 8, in the list of defined terms, full-time earner is omitted.

### 351 Adjustments for calculation of family scheme income
(1) Section MB 1(5) is replaced by the following:Investment income
...
(2) In section MB 1, in the list of defined terms,—
  (a) portfolio investor allocated income is omitted:
  (b) portfolio investment entity is inserted.
(3) Subsection (1) applies for the 2010–11 and later income years.

### 352 Family scheme income of major shareholders in close companies
(1) Section MB 4(1), other than the heading, is replaced by the following:
...
In section MC 1, in the compare note, ss KD A1, KD 1A is replaced by s KD 1A.

### 354 Third requirement: residence
(1) Section MC 5(1), other than the heading, is replaced by the following:
...
(1) Section MC 6(b)(ii) is repealed.
(2) In section MC 6, in the compare note, s KD 3(1) is replaced by s KD 3(1), qualifying person.
(3) Subsection (1) applies for the 2008–09 and later income years.

### 356 Continuing requirements
(1) In section MC 8, after the section heading, the following is inserted:Requirements for entitlement period.
(2) After section MC 8(f), the following is added as subsection (2):Relationship with section MD 6(2)
  (2) Section MD 6(2) (Second requirement: principal care) overrides this section in relation to the in-work tax credit.
(3) In section MC 8, in the list of defined terms, in-work tax credit is inserted.
(4) Subsections (1) and (2) apply for the 2008–09 and later income years.

### 357 Principal caregiver
(1) In section MC 10(4), subsection (2) is replaced by subsection (3).
(2) Subsection (1) applies for the 2008–09 and later income years.

### 358 Second requirement: principal care
(1) After section MD 6(2), the following is added:Relationship with section MC 8
  (3) Subsection (2) overrides section MC 8 (Continuing requirements).
(2) Subsection (1) applies for the 2008–09 and later income years.

### 359 Third requirement: residence
(1) Section MD 7(1), other than the heading, is replaced by the following:
...
(1) Section MD 9(2), other than the heading, is replaced by the following:
...
(2) In section MD 9(2)(c), profit. is replaced by profit; or and the following is added:
...
(3) Section MD 9(3), other than the heading, is replaced by the following:
...
(1) In section MD 10(3)(d)(ii), paragraph (a) is replaced by paragraph (i).
(2) Subsection (1) applies for the 2008–09 and later income years.

### 362 Meaning of employment for this subpart
In section ME 2, in the list of defined terms, full-time earner is inserted.

### 363 Meaning of net family scheme income
(1) In section ME 3(2), the formula is replaced by the following:adjusted income – adjusted liability + amount received – amount paid.
(2) Section ME 3(3)(a)(i) is replaced by the following:.
...
(1) Section MF 6 is replaced by the following:Overpayment or underpayment of tax creditWhen this section appliesOverpaymentUnderpaymentDefined in this Act: amount, Commissioner, family scheme, income tax liability, notice of entitlement, pay, tax, tax credit, tax year.
...
In section MK 1(1), the second sentence is replaced by Section MK 2 imposes some eligibility requirements for the year described in subsection (3) in relation to the person.

### 367 Eligibility requirements
In section MK 2(1), the words before paragraph (a) are replaced by the following:.
...
(1) In section MK 13(1)(a), section MK 12(1)(b) and (c) is replaced by section MK 12(1)(c) and (d).
(2) Subsection (1) applies for the 2008–09 and later income years.

### 369 What this subpart does
Section ML 1(2)(b)(i) to (iii) are replaced by the following:
...
Section ML 2 is replaced by the following:Tax credit for redundancy paymentsTax creditMaximum amountDefined in this Act: amount, redundancy payment, tax credit.
...
(1) After section MZ 2, the following is added:Exclusions from determination of family scheme incomeWhen this section appliesRefunds of main depositRefunds of adverse event depositTreatment of interestDefined in this Act: adverse event deposit, amount, family scheme, family scheme income, income year, interest, main deposit, tax credit 2004 No 35 s KD 1(1)(e)(i), (vi).
...
(1) Section OA 2(1)(f) is repealed.
(2) Subsection (1) applies––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.

### 373 Credits
(1) In section OA 5(2)(b), groups. is replaced by groups: and the following is inserted:
  (c) credited under section OZ 18 (Credit-back of PCA balance).
(2) Section OA 5(7) is repealed.
(3) In section OA 5, in the list of defined terms, policyholder credit is omitted.
(4) Subsections (1) and (2) apply––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.

### 374 Debits
(1) Section OA 6(7) is repealed.
(2) In section OA 6, in the list of defined terms, policyholder debit is omitted.
(3) Subsection (1) applies––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.

### 375 Opening balances of memorandum accounts
(1) Section OA 7(2)(f) is repealed.
(2) In section OA 7, in the list of defined terms, policyholder credit account is omitted.
(3) Subsection (1) applies––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.

### 376 Shareholder continuity requirements for memorandum accounts
(1) In section OA 8(2), Subsections (4) and (5) is replaced by Subsections (3B) to (5).
(2) After section OA 8(3), the following is inserted:Exclusions: qualifying companies
...
(3) Section OA 8(4) is replaced by the following:Exclusion: ASC accounts
  (4) Subsection (2) does not apply to a person who maintains an ASC account.
(4) In section OA 8, in the list of defined terms, policyholder credit account is omitted.

### 377 Section OA 12 repealed
(1) Section OA 12 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 378 General rules for companies with imputation credit accounts
(1) In section OB 1(1), Subsections (2) and (3) override is replaced by Subsection (2) overrides.
(2) Section OB 1(2)(a)(i) is repealed.
(3) Section OB 1(2)(f) is replaced by the following:
  (f) a multi-rate PIE.
(4) Section OB 1(3) is repealed.
(5) In section OB 1, in the list of defined terms, Australian ICA company and resident in Australia are omitted.
(6) In section OB 1, in the list of defined terms,—
  (a) portfolio tax rate entity is omitted:
  (b) multi-rate PIE is inserted.
...
(1) Section OB 2(1) is replaced by the following:Company resident in Australia
  (1) A company that is resident in Australia may choose to establish and maintain an imputation credit account.
(2) In section OB 2, in the list of defined terms, resident in New Zealand is omitted.
(3) Subsection (1) applies for the 2008–09 and later income years.

### 380 New section OB 3B inserted
(1) After section OB 3, the following is inserted:General rule for life insurer's policyholder baseDefined in this Act: imputation credit, imputation debit, life insurer, policyholder base.
...
(2) Section OB 4(3)(e) and (eb) are replaced by the following:.
...
(1) In section OB 8(1), by the company is replaced by by the company other than as policyholder base income.
(2) In section OB 8, in the list of defined terms, policyholder base income is inserted.
(3) Subsection (1) applies––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.

### 383 New section OB 9B inserted
After section OB 9, the following is inserted:ICA company allocated imputation credit with income from PTRECreditTable referenceCredit dateDefined in this Act: amount, ICA company, imputation credit, portfolio tax rate entity.
  (1) An ICA company that is an investor in a portfolio tax rate entity has an imputation credit for the amount of an imputation credit allocated to it under section HL 29(7)(b).
  (2) The imputation credit in subsection (1) is referred to in table O1: imputation credits, row 7B (imputation credit allocated with income from PTRE).
  (3) The credit date is the day the amount is allocated.

### 384 Section OB 9B replaced
(1) Section OB 9B is replaced by the following:ICA attributed PIE income with imputation creditCreditTable referenceCredit dateDefined in this Act: amount, attributed PIE income, ICA company, imputation credit, multi-rate PIE.
...
(1) Section OB 17 is repealed.
(2) Subsection (1) applies––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.

### 387 ICA transfer to master fund
(1) In section OB 19(1), the first sentence is replaced by An ICA company that is a master fund has an imputation credit for the transfer of an amount of expenditure under sections DV 5 to DV 7 (which relate to the transfer of expenditure to master funds).
(2) Subsection (1) applies for the 2008–09 and later income years.
...
(2) After section OB 32(6), the following is added:Relationship with section OB 37
...
(1) Section OB 33(1), other than the heading, is replaced by the following:
...
(2) After section OB 33(4), the following is added:Relationship with section OB 37
...
(1) Section OB 34(4) is replaced by the following:Debit date for companies other than qualifying companiesDebit date for qualifying companies
...
(2) In section OB 34, in the list of defined terms, company, imputation credit account, qualifying company, and tax year are inserted.
...
Section OB 35(4)(b) is replaced by the following:.
...
(1) After section OB 35, the following is inserted:ICA debit for transfer from tax pooling account for policyholder base liabilityDebitTable referenceDebit dateDefined in this Act: ICA company, imputation credit, imputation debit, life insurer, schedular income tax liability, schedular policyholder base income, tax year.
...
(1) Section OB 37(1) is replaced by the following:DebitExclusion: FDPA companies
  (1) An ICA company has an imputation debit for—
    ...
    (c) an amount used by the company under section LH 2(6) (Tax credits relating to expenditure on research and development) to pay an amount payable under an Inland Revenue Act to the extent to which the use does not lead to a refund of income tax.
...
(2) Section OB 37(3), other than the heading, is replaced by the following:
  (3) The debit date is—
...
(1) In section OB 39(1), and a CTR company is omitted.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 395 Section OB 39 repealed
(1) Section OB 39 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 396 Section OB 47 replaced
(1) Section OB 47 is replaced by the following:Debit for policyholder base imputation creditsDebitTable referenceDebit dateDefined in this Act: ICA company, imputation credit, imputation debit, life insurer, policyholder base, tax year.
...
(1) Section OB 61(7) is repealed.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 398 Imputation additional tax on leaving wholly-owned group
(1) Section OB 71(1)(b) is repealed.
(2) In section OB 71(4)(a), the amount is no more than the excess entitlement is replaced by the amount is no more than the excess tax payment for company A when company A has an excess entitlement.
(3) Section OB 71(5)(c) is replaced by the following:
...
(4) In section OB 71(9), section OB 13(5) is replaced by section OB 13(5). However, if subsections (3) or (4) apply to transfer a debit or treat an amount of tax as having been paid, company A must also provide a notice of agreement from company B in relation to the amount of excess tax payment.
(5) Subsections (1) to (4) apply for the 2008–09 and later income years.

### 399 Table O1: imputation credits
(1) In table O1, after row 7, the following is inserted: 7BImputation credit allocated with income from PTREday of allocationsection OB 9B
(2) Table O1, row 7B is replaced by the following: 7BAttributed PIE income with imputation credit day of attributionsection OB 9B
(3) Table O1, row 9 is repealed.
(4) In table O1, row 14, attributing company is replaced by qualifying company.
...
(2) Table O2, row 9 is replaced by the following:9Transfer, refund, or use of tax creditday of transfer, refund, or usesection OB 37
...
(1) In section OC 1(1), portfolio tax rate entity is replaced by multi-rate PIE.
(2) Section OC 1(3) is repealed.
(3) In section OC 1, in the list of defined terms,—
  (a) portfolio tax rate entity is omitted:
  (b) multi-rate PIE is inserted.
(4) Subsection (1) applies for the 2010–11 and later income years.
(5) Subsection (2) applies for all income years beginning on or after 1 July 2009.
...
(1) After section OC 2, the following is inserted:General rule for life insurer's policyholder baseDefined in this Act: FDP credit, FDP debit, life insurer, policyholder base.
...
(2) Section OC 16(3), other than the heading, is replaced by the following:
  (3) The debit date is the day the transfer or refund is made.
(3) Subsections (1) and (2) apply for the 2008–09 and later income years.

### 410 Section OC 20 replaced
(1) Section OC 20 is replaced by the following:Debit for policyholder base FDP creditsDebitTable referenceDebit dateDefined in this Act: FDP company, FDP credit, FDP debit, life insurer, policyholder base, tax year.
...
(1) Section OC 23 is repealed.
(2) Subsection (1) applies––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.

### 412 Heading before section OC 30 replaced
The heading before section OC 30 is replaced by Further income tax.

### 413 Payment of further FDP for closing debit balance
(1) In the heading to section OC 30, further FDP is replaced by further income tax.
(2) Section OC 30(1) and (2) are replaced by the following:LiabilityDue date
...
(3) Section OC 30(3) is repealed.
(4) In section OC 30, in the list of defined terms,—
  (a) FDP rules, further FDP, and income tax are omitted:
  (b) further income tax is inserted.
(5) Subsections (1) to (3) apply for all income years beginning on or after 1 July 2009.

### 414 Payment of further FDP when company no longer New Zealand resident
(1) In the heading to section OC 31, further FDP is replaced by further income tax.
(2) Section OC 31(1) to (3) are replaced by the following:LiabilityDue dateParamount section
...
(3) Section OC 31(4) is repealed.
(4) In section OC 31, in the list of defined terms,—
  (a) FDP rules and further FDP are omitted:
  (b) further income tax is inserted.
(5) Subsections (1) to (3) apply for all income years beginning on or after 1 July 2009.

### 415 Reduction of further FDP
(1) In the heading to section OC 32, further FDP is replaced by further income tax.
(2) In section OC 32(1), the words before paragraph (a) are replaced by the following:.
  (1) An FDPA company's liability for further income tax under section OC 30 or OC 31 may be reduced under subsection (2) if—
(3) In section OC 32, in the list of defined terms,—
  (a) further FDP is omitted:
  (b) further income tax is inserted.
(4) Subsections (1) and (2) apply for all income years beginning on or after 1 July 2009.

### 416 Section OC 33 replaced
(1) Section OC 33 is replaced by the following:Income tax paid satisfying liability for further income taxElectionRequirementsPayment creditedWhen treated as paidDefined in this Act: Commissioner, company, FDPA company, further income tax, income tax, income year, pay, tax year.
...
(1) Section OC 34 is replaced by the following:Further income tax paid satisfying liability for income taxElectionFDPA company statusAlternative for consolidated groupDefined in this Act: company, consolidated FDP group, FDPA company, further income tax, income tax, income year, pay, tax year.
...
(1) The heading before section OC 35 and sections OC 35 to OC 39 are repealed.
(2) Subsection (1) applies––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.
...
(1) In table O4, row 5 is replaced by the following:5Transfer or refund of tax creditday of transfer or refundsection OC 16
...
(1) In section OD 1(2), a tax year is replaced by a tax year as set out in section OD 3(2).
(2) Section OD 1(3) is repealed.
(3) Subsection (1) applies for the 2008–09 and later tax years.
(4) Subsection (2) applies for all income years beginning on or after 1 July 2009.

### 422 Choosing to become CTR company
(1) Section OD 3(1), other than the heading, is replaced by the following:
...
(2) Section OD 3(2) is replaced by the following:Maintaining CTR accountTreatment of company for certain provisions
...
(1) In section OD 4(3), the words before paragraph (a) are replaced by the following:.
...
(1) Section OD 5 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 425 Section OD 8 repealed
(1) Section OD 8 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 426 Section OD 11 repealed
(1) Section OD 11 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 427 CTRA increase in resident shareholding
(1) In section OD 16(3)(b), 34% or more is replaced by 34 percentage points or more.
(2) Subsection (1) applies for the 2008–09 and later tax years.

### 428 Section OD 23 repealed
(1) Section OD 23 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 429 Section OD 24 repealed
(1) Section OD 24 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.
...
(1) In table O6: conduit tax relief credits, row 2, FDP credit attached is replaced by CTR credit attached.
(2) Table O6, row 3 is repealed.
(3) Subsection (1) applies for the 2008–09 and later tax years.
(4) Subsection (2) applies for all income years beginning on or after 1 July 2009.

### 432 Branch equivalent tax accounts of companies
(1) Section OE 2(2) and (3) are repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 433 Heading and sections OE 12 and OE 13 repealed
(1) The heading before section OE 12 and sections OE 12 and OE 13 are repealed.
(2) Subsection (1) applies for dividends received in all income years beginning on or after 1 July 2009.

### 434 Sections OE 14 to OE 16 repealed
(1) Sections OE 14 to OE 16 are repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 435 New heading and section OE 16B inserted
(1) Before the headings before section OE 17, the following is inserted:Debit if credit balance at beginning of first affected income yearCompany with credit balance at beginning of first affected income yearDefined in this Act: BETA company, branch equivalent tax account, branch equivalent tax debit, company, income year.
  If a BETA company has a credit balance in its branch equivalent tax account at the beginning of the first income year for which this section applies to the company, a branch equivalent tax debit of an amount equal to the credit balance arises in the branch equivalent tax account at that time.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.
...
(1) In section OF 1(1), the second sentence is replaced by This section does not apply to a multi-rate PIE.
(2) In section OF 1, in the list of defined terms,—
  (a) portfolio tax rate entity is omitted:
  (b) multi-rate PIE is inserted.
(3) Subsection (1) applies for the 2010–11 and later income years.

### 439 Subpart OJ repealed
(1) Subpart OJ is repealed.
(2) Subsection (1) applies––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.

### 440 MACA payment of tax
(1) Section OK 2(3)(cb) is replaced by the following:.
...
(1) After section OK 12(6), the following is added:Relationship with section OK 14B
...
(1) After section OK 13(4), the following is added:Relationship with section OK 14B
...
(1) After section OK 14, the following is inserted:MACA refund of tax creditDebitExclusionTable referenceDebit dateDefined in this Act: amount, FDPA company, Inland Revenue Acts, Maori authority, Maori authority debit, pay.
  (1) A Maori authority has a Maori authority debit for—
    (a) the amount of a transfer under section LA 6(2)(d) (Remaining refundable credits: PAYE, RWT, and certain other items) to the extent to which the transfer does not lead to a refund of income tax:
    (b) the amount of a refund to the authority under section LA 6(2)(e):
    (c) an amount used under section LH 2(6) (Tax credits relating to expenditure on research and development) to pay an amount payable under an Inland Revenue Act to the extent to which the use does not lead to a refund of income tax.
...
(1) In table O18, after row 6, the following row is inserted:6BTransfer, refund, or use of tax creditday of transfer, refund, or usesection OK 14B
(2) Subsection (1) applies for the 2008–09 and later income years.

### 445 When credits and debits arise only in consolidated imputation group accounts
(1) In section OP 5(2)(d), credit): is replaced by credit). and paragraph (e) is repealed.
...
(1) Section OP 6(2)(a) is replaced by the following:.
...
(2) After section OP 6(3), the following is added:Tax advantage arrangements and determinationsRefunds for overpaid amountsLimits on refundsApplying for refunds
...
(3) In section OP 6, in the list of defined terms, Commissioner, consolidated group, ICA company, imputation additional tax, imputation group, income tax, notify, and tax are inserted.
(4) Subsections (1) and (2) apply for the 2008–09 and later income years.
...
(2) Section OP 7(3)(fb) is replaced by the following:.
...
(1) Section OP 14 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 449 Consolidated ICA resident withholding tax withheld
(1) In section OP 17(1), by a group company is replaced by by a group company other than as policyholder base income.
(2) In section OP 17, in the list of defined terms, policyholder base income is inserted.
(3) Subsection (1) applies––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.

### 450 Section OP 20 repealed
(1) Section OP 20 is repealed.
(2) Subsection (1) applies––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.

### 451 Section OP 21 repealed
(1) Section OP 21 is repealed.
(2) Subsection (1) applies––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.
...
(3) After section OP 30(4), the following is added:Relationship with section OP 35
...
(1) After section OP 31(4), the following is added:Relationship with section OP 35
  (5) This section does not apply to an amount that gives rise to a debit under section OP 35.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 454 New section OP 33B inserted
(1) After section OP 33, the following is inserted:Consolidated ICA debit for transfer from tax pooling account for policyholder base liabilityDebitTable referenceDebit dateDefined in this Act: ICA company, imputation credit, imputation debit, life insurer, schedular income tax liability, schedular policyholder base income, tax year.
...
(1) Section OP 35(1) is replaced by the following:DebitExclusion
...
(2) Section OP 35(3), other than the heading, is replaced by the following:
  (3) The debit date is—
    (a) for a debit referred to in subsection (1)(a), the day the amount is transferred:
    (b) for a debit referred to in subsection (1)(b), the day the amount is refunded:
    (c) for a debit referred to in subsection (1)(c), the day the amount is applied.
(3) In section OP 35, in the defined terms list, FDP, pay, and tax credit are inserted.
(4) Subsections (1) and (2) apply for the 2008–09 and later income years.

### 456 Section OP 38 repealed
(1) Section OP 38 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 457 Consolidated ICA transfer to policyholder credit account
(1) After section OP 44(5), the following are added:Mandatory transfer for group with non-standard accounting yearCreditOrdering rule
...
(2) In section OP 44, in the list of defined terms, accounting year, FDP, pay, provisional tax, and tax year are inserted.
(3) Subsection (1) applies for the 2008–09 and later income years.

### 458 Section OP 44 replaced
(1) Section OP 44 is replaced by the following:Consolidated ICA debit for policyholder base imputation creditsDebitTable referenceDebit dateDefined in this Act: consolidated imputation group, imputation credit, imputation debit, life insurer, policyholder base, tax year.
...
(2) Table O20, row 9 is replaced by the following:9Transfer, refund, or use of tax creditday of transfer, refund, or usesection OP 35
(3) Table O20, row 12 is repealed.
(4) In table O20, row 18, day of election is replaced by set out in section OP 44.
...
(1) Section OP 54(2), other than the heading, is replaced by the following:
...
(1) Section OP 56 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 463 Section OP 57 repealed
(1) Section OP 57 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 464 Section OP 61 repealed
(1) Section OP 61 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 465 Section OP 62 repealed
(1) Section OP 62 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 466 Consolidated FDPA refund of tax credit
(1) Section OP 68(1), other than the heading, is replaced by the following:
...
(2) Section OP 68(3), other than the heading, is replaced by the following:
  (3) The debit date is the day the transfer or refund is made.
(3) Subsections (1) and (2) apply for the 2008–09 and later income years.

### 467 Section OP 74 replaced
(1) Section OP 74 is replaced by the following:Consolidated FDPA debit for policyholder base FDP creditsDebitTable referenceDebit dateDefined in this Act: consolidated FDP group, FDP credit, FDP debit, life insurer, policyholder base, tax year.
...
(1) In section OP 78(1), has is replaced by must maintain.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 471 When credits and debits arise only in CTR group accounts
(1) Section OP 79(2), other than the heading, is replaced by the following:
...
(1) Section OP 81 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 473 Section OP 82 repealed
(1) Section OP 82 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 474 Section OP 88 repealed
(1) Section OP 88 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 475 Section OP 95 repealed
(1) Section OP 95 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.
...
(1) Section OP 99 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 479 Heading and sections OP 105 to OP 108 repealed
(1) The heading before section OP 105 and sections OP 105 to OP 108 are repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 480 New heading and section OP 108B inserted
(1) Before table O25, the following is inserted:Debit if credit balance at beginning of first affected income yearConsolidated BETA group with credit balance at beginning of first affected income yearDefined in this Act: branch equivalent tax account, branch equivalent tax debit, consolidated BETA group, income year.
  If a consolidated BETA group has a credit balance in its branch equivalent tax account at the beginning of the first income year for which this section applies to the group, a branch equivalent tax debit of an amount equal to the credit balance arises in the branch equivalent tax account at that time.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.
...
(1) The headings before section OP 109 and sections OP 109 to OP 116 are repealed.
(2) Subsection (1) applies––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.
...
(1) Section OZ 5(6)(a) is replaced by the following:.
  (a) non-taxable gains and losses, including exempt income; and
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 486 Modifying ratios for imputation credits and FDP credits
(1) In section OZ 10(2), section OA 5(2) and (3) (Credits) is replaced by sections LE 8, LE 9, LF 6, and LF 7 (which relate to tax credits for imputation credits and FDP credits).
(2) Subsection (1) applies for the 2008–09 and later income years.

### 487 New section OZ 18 added
After section OZ 17, the following is added:Credit-back of PCA balanceWhen this section appliesCredit-backDefined in this Act: early life regime application day, consolidated group, imputation credit, imputation credit amount, life insurer, policyholder credit account.
  (1) This section applies for a life insurer immediately before a day (the application day) that is—
    (a) 1 July 2010, if the life insurer does not have an early life regime application day, or
    (b) their early life regime application day, if the life insurer does have an early life regime application day.
...
(1) Section RA 1(g) is repealed.
(2) In section RA 1, in the list of defined terms, FDP is omitted.
(3) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 489 Tax obligations for employment-related taxes
(1) In section RA 5, the following is inserted after the section heading:Withholding and payment obligations.
(2) Section RA 5(c) is replaced by the following:
  (c) an employer's superannuation cash contribution.
(3) In section RA 5, the following is added as subsection (2):Timing for PAYE income payments
  (2) An amount of tax withheld from a PAYE income payment must be withheld at the time the person makes the payment.
(4) In section RA 5, in the list of defined terms, employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(5) Subsections (1) to (3) apply for the 2008–09 and later income years.

### 490 Withholding and payment obligations for passive income
(1) Section RA 6(3) is repealed.
(2) After section RA 6(3), the following is added:Timing for payments of passive income
  (4) An amount of tax withheld under subsections (1) and (2) must be withheld at the time the person makes the payment.
(3) In section RA 6, in the list of defined terms, FDP and foreign dividend are omitted.
(4) Subsection (1) applies for all income years beginning on or after 1 July 2009.
(5) Subsection (2) applies for the 2008–09 and later income years.

### 491 When obligations not met
(1) In section RA 10(1)(a), an employer's superannuation contribution is replaced by an employer's superannuation cash contribution.
(2) In section RA 10(1)(b), the amount; or is replaced by the amount. and paragraph (c) is repealed.
(3) In section RA 10, in the list of defined terms, employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(4) In section RA 10, in the list of defined terms, FDP is omitted.
(5) Subsection (1) applies for the 2008–09 and later income years.
(6) Subsection (2) applies for all income years beginning on or after 1 July 2009.

### 492 Payment dates for interim and other tax payments
(1) Section RA 15(2)(b) to (d) are replaced by the following:
...
(2) Section RA 15(2)(c) is replaced by the following:.
...
(3) Section RA 15(3)(c) is replaced by the following:.
...
(4) In section RA 15, in the list of defined terms, FDP is omitted.
...
(1) In section RA 20, the following is inserted after the section heading:Amalgamated company's obligation.
(2) In section RA 20, the following is added as subsection (2):Thresholds for close companies
...
(3) In section RA 20, in the list of defined terms, amalgamation, close company, gross, and income year are inserted.
(4) Subsections (1) and (2) apply for the 2008–09 and later income years.

### 494 Regulations
(1) In section RA 21(4), subsection (2) is replaced by subsection (3).
(2) Subsection (1) applies for the 2008–09 and later income years.

### 495 Application of other provisions for purposes of ESCT rules and NRWT rules
(1) In section RA 23(2), an amount of tax for an employer's superannuation contribution is replaced by ESCT.
(2) Section RA 23(2) is repealed.
(3) In section RA 23, in the list of defined terms, employer's superannuation contribution is omitted.
(4) Subsection (1) applies for the 2008–09 and later income years.

### 496 Payment of terminal tax
(1) In section RB 1, section RA 3 (Terminal tax obligations) is replaced by section RA 13 (Payment dates for terminal tax).
(2) Subsection (1) applies for the 2008–09 and later income years.

### 497 Schedular income tax liability for filing taxpayers for non-resident passive income
(1) In section RB 3(2), paragraph (h) is replaced by paragraph (f).
(2) Subsection (1) applies for the 2008–09 and later income years.

### 498 Who is required to pay provisional tax?
(1) Section RC 3(2)(d) is replaced by the following:
...
(2) In section RC 3, in the list of defined terms,—
  (a) portfolio tax rate entity is omitted:
  (b) multi-rate PIE is inserted.
(3) Subsection (1) applies for the 2010–11 and later income years.

### 499 Estimation method
(1) Section RC 7(7) is repealed.
(2) In section RC 7, in the list of defined terms, qualifying event and self-assessed adverse event are omitted.

### 500 Attribution rule for income from personal services
(1) Section RC 34(1) to (6) are replaced by the following:When this section appliesAssociated entity transferring amount to working personWorking person transferring amount to associated entityWhen transfer madeNoticeWhen transfer made and how transfer treated
...
(2) In section RC 34, in the list of defined terms, amount of tax and associated person are inserted.
(3) Subsection (1) applies for the 2008–09 and later income years.

### 501 Section RC 36 repealed
Section RC 36 is repealed.

### 502 PAYE rules and their application
Section RD 2(1)(b) is replaced by the following:.
  (b) sections LA 6, LB 1, and LD 4 (which relate to tax credits); and

### 503 PAYE income payments
(1) Section RD 3(1)(b)(iii) is replaced by the following:
...
(2) Section RD 3(3), other than the heading, is replaced by the following:
...
(3) Section RD 3(4), other than the heading, is replaced by the following:
...
### 504 Salary or wages
(1) In section RD 5(1)(b)(ii), subsections (2) to (7) is replaced by subsections (2) to (8).
(2) Section RD 5(1)(c)(v) is replaced by the following:.
  (v) an employer's superannuation contribution other than a contribution referred to in subsection (8):
(3) Section RD 5(6)(a) is replaced by the following:.
...
(4) In section RD 5(6)(c), 1987 or section 303 of the Education Act 1989 is replaced by 1987, section 303 of the Education Act 1989, or an enactment substituted for those sections.
(5) After section RD 5(7), the following is added:Accommodation benefits
...
(6) After section RD 5(8), the following is added:Cash contributions
...
(7) In section RD 5, in the list of defined terms, accommodation is inserted.
(8) In section RD 5, in the list of defined terms, employer's superannuation cash contribution, is inserted.
...
(1) Section RD 6(1)(a) and (b) are replaced by the following:.
...
(2) In section RD 6, in the list of defined terms, accommodation is inserted.

### 506 Schedular payments
In section RD 8(1)(b)(v), who does not have is replaced by who has.

### 507 Reduction in certain circumstances
(1) After section RD 11(3), the following is added:When Commissioner makes determination under section RD 8(3)
...
(2) In section RD 11, in the list of defined terms, amount and schedular payment are inserted.
(3) In section RD 11, in the compare note, NC 13 is replaced by NC 13, Income Tax (Withholding Payments) Regulations 1979, regulation 6(3).
(4) Subsection (1) applies for the 2008–09 and later income years.

### 508 Multiple payments of salary or wages
(1) Section RD 12(2)(b) is replaced by the following:
...
(2) In section RD 12, in the list of defined terms, non-resident seasonal worker is inserted.
(3) Subsection (1) applies for the 2009–10 and later income years.

### 509 Advance payments of salary or wages
(1) Section RD 13(1)(a) is replaced by the following:.
...
After section RD 13, the following is inserted:Adjustments for payroll donationsWhen this section appliesSubtracting amount of tax creditDefined in this Act: employee, employer, employer monthly schedule, pay period, PAYE income payment, PAYE intermediary, payroll donation, tax credit.
...
(1) In section RD 17(1), the sum of the extra pay and the annualised value of all PAYE income payments made is replaced by the annualised value of all PAYE income payments, excluding the extra pay, made.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 512 Schedular payments without notification
(1) Section RD 18(3) is replaced by the following:Additional amount of taxNon-application to non-resident entertainers
...
Section RD 19(2) is repealed.

### 514 PAYE income payment forms for amounts of tax paid to Commissioner
(1) In section RD 22, the heading is replaced by Returns for amounts of tax paid to Commissioner.
(2) Section RD 22(1) is replaced by the following:Paying amount withheld with returns
...
(3) In section RD 22(2), the words before paragraph (a) are replaced by the following:.
...
(4) Section RD 22(3) is replaced by the following:Returns when gross amounts of tax are less than $100,000Requirements
...
(5) In the heading to section RD 22(3), $100,000 is replaced by $500,000.
(6) In section RD 22(3B), $100,000 is replaced by $500,000.
(7) Section RD 22(4), other than the heading, is replaced by the following:
...
(8) In section RD 22(4), $100,000 is replaced by $500,000.
(9) Section RD 22(6), other than the heading, is replaced by the following:
...
(10) In section RD 22, in the list of defined terms, employer monthly schedule and employer's superannuation cash contribution are inserted.
(11) Subsections (4) and (7) apply for the 2008–09 and later income years.

### 515 Calculation of all-inclusive pay
In section RD 51(3)(a), or applied on their account is omitted.

### 516 Value of and payments towards fringe benefits
In section RD 54, in the compare note, s ND 1S is replaced by ss GC 15(3), (4), ND 1S.
...
(2) In section RD 60(1)(a), $100,000 is replaced by $500,000.
(3) In section RD 60(6), referred to in subsection (1) is replaced by withheld under section RA 5(1)(a) and (c).
(4) In section RD 60, in the list of defined terms,—
  (a) employer's superannuation contribution is omitted:
  (b) employer's superannuation cash contribution is inserted.
(5) Subsections (1) and (3) apply for the 2008–09 and later income years.

### 518 Small business option
(1) Section RD 61(1)(a) is replaced by the following:.
  (a) the gross amounts of tax for both PAYE income payments and employer's superannuation cash contributions withheld under section RA 5(1)(a) and (c) (Tax obligations for employment-related taxes) for the tax year were no more than $100,000; or
(2) In section RD 61(1)(a), $100,000 is replaced by $500,000.
(3) In section RD 61(6), referred to in subsection (1) is replaced by withheld under section RA 5(1)(a) and (c).
(4) In section RD 61, in the list of defined terms, employer's superannuation cash contribution is inserted.
(5) Subsections (1) and (3) apply for the 2008–09 and later income years.

### 519 Employer's superannuation contributions
(1) In section RD 65, the section heading is replaced by Employer's superannuation cash contributions.
(2) Section RD 65(1), other than the heading, is replaced by the following:
...
(3) In section RD 65(2), employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(4) In section RD 65(2)(b), amount of tax is replaced by amount of tax withheld.
(5) In section RD 65(3), employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(6) In section RD 65(4), employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(7) Section RD 65(4) is replaced by the following:Contributions to KiwiSaver schemes and complying superannuation funds
  (4) Subsection (3) and, as applicable, sections RD 67 to RD 69, do not apply to an employer's superannuation cash contribution (the current contribution) to the extent to which the current contribution is—
...
(8) In section RD 65(7), employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(9) In section RD 65(11), employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(10) Section RD 65(12) is repealed.
(11) In section RD 65(13), the definition of KiwiSaver calculation period is replaced by the following:.
  - **KiwiSaver calculation period** , for a current contribution relating to an employer's superannuation cash contribution, means a period—
...
(12) In section RD 65, in the list of defined terms, employer's superannuation contribution is replaced by employer's superannuation cash contribution.
...
(1) In section RD 67, the section heading is replaced by Calculating amounts of tax for employer's superannuation cash contributions.
(2) In section RD 67, employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(3) Section RD 67(a) is replaced by the following:.
...
(4) In section RD 67, in the list of defined terms, employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(5) Subsections (1) to (3) apply for the 2008–09 and later income years.

### 521 Choosing to have amount treated as salary or wages
(1) In section RD 68, the following is inserted after the section heading:Amount treated as salary or wages.
(2) In section RD 68(1), employer's superannuation contribution is replaced by employer's superannuation cash contribution in both places where it appears.
(3) After section RD 68(1), the following is added as subsection (2):Revoking election
  (2) The employee's election is valid until revoked in writing.
(4) In section RD 68, in the list of defined terms, employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(5) Subsections (1) to (3) apply for the 2008–09 and later income years.

### 522 Choosing different rates for employer's superannuation contributions
(1) In section RD 69, the section heading is replaced by Choosing different rates for employer's superannuation cash contributions.
(2) In section RD 69(1), employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(3) In section RD 69, in the list of defined terms, employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(4) Subsections (1) and (2) apply for the 2008–09 and later income years.

### 523 Calculating amounts on failure to withhold
(1) Section RD 70(1), other than the heading, is replaced by the following:
...
(2) In section RD 70, in the list of defined terms, employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(3) Subsection (1) applies for the 2008–09 and later income years.

### 524 Amounts of tax treated as paid to and received by superannuation funds
(1) In section RD 71(a), an amount of tax is replaced by an amount of tax withheld.
(2) Section RD 71(c) is replaced by the following:
...
(3) In section RD 71, in the list of defined terms, employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(4) Subsections (1) and (2) apply for the 2008–09 and later income years.

### 525 Resident passive income
(1) In section RE 2(1), resident in New Zealand is omitted.
(2) In section RE 2(3)(c), paid to a person resident in New Zealand who is acting as agent or nominee of a non-resident is omitted.
(3) In section RE 2, in the list of defined terms, resident in New Zealand is omitted.
...
(1) Section RE 3(1)(a) and (b) are replaced by the following:.
...
(1) In section RE 4(6), the words before paragraph (a) are replaced by the following:.
...
(2) In section RE 4, in the list of defined terms, FDP is omitted.
(3) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 528 Agents' or trustees' obligations in relation to certain dividends
(1) Section RE 9(2), other than the heading, is replaced by the following:
...
(2) In section RE 9, in the list of defined terms, FDP rules is omitted.
(3) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 529 Notification by companies
(1) In section RE 11(3), schedule 1, part D, clause 5 is replaced by schedule 1, part D, clause 4.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 530 Interest
(1) In section RE 12(3)(a), schedule 1, part D, clause 4 or 5 is replaced by schedule 1, part D, clause 3 or 4.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 531 Non-resident passive income
(1) The heading to section RF 2(1) is replaced by Interest, certain dividends, and royalties.
(2) Section RF 2(2)(b) is replaced by the following:
...
(3) In section RF 2(2)(c), section CX 56 (Portfolio investor allocated income and distributions of income by portfolio investment entities) is replaced by section CX 56C (Distributions to investors by listed PIEs).
(4) In section RF 2(5), consisting of interest or an investment society dividend other than those described in subsection (3)(b) and (d) is replaced by consisting of interest, investment society dividends, or a royalty other than those described in subsection (3).
(5) In section RF 2, in the list of defined terms, excluded income is inserted.
...
In section RF 8, in the list of defined terms, fully imputed is inserted.

### 533 When dividends fully imputed or fully credited
(1) In section RF 9(1), section RF 8(1)(d) to (f) is replaced by sections RF 8 and RF 10.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 534 Non-cash dividends
(1) Section RF 10(1) is replaced by the following:When subsections (2) to (5) apply
...
(2) In section RF 10(2), the formula is replaced by the following:rate A× dividend payment + rate B × amount paid.1 – rate A
(3) After section RF 10(5), the following is inserted:Fully imputed non-cash dividends
...
(4) In section RF 10, in the list of defined terms, fully imputed is inserted.
(5) In section RF 10, in the compare note, s NG 9 is replaced by ss NG 2(1)(b)(ii), NG 9.
(6) Subsections (1) and (3) apply for the 2008–09 and later income years.

### 535 Dividends paid to companies under control of non-residents
(1) The heading to section RF 11 is replaced by Dividends paid to companies associated with non-residents.
(2) Section RF 11(1)(b) and (c) are replaced by the following:.
...
(1) Section RF 12 is replaced by the following:Interest paid by approved issuers or transitional residentsWhen this section appliesZero-ratingInterest paid under registered securitiesDefined in this Act: amount, approved issuer, associated person, business, company, fixed establishment, income, interest, life insurer, New Zealand, non-resident, non-resident passive income, NRWT, NRWT rules, pay, registered security, resident in New Zealand, transitional resident2004 No 35 s NG 2(1)(b)(i), (ib)Interest derived jointly with residentsWhen payment derived jointly with residentDefinition of items in formulaTreatment as filing taxpayerDefined in this Act: amount, amount of tax, filing taxpayer, foreign withholding tax, interest, New Zealand resident, non-resident passive income, pay2004 No 35 s NG 2(1)(ab)Amount derived from non-resident life insurer becoming residentWhen this section appliesZero-ratingDefined in this Act: amount, company, life insurer, New Zealand, non-resident passive income, NRWT, pay, resident in New Zealand2004 No 35 s NG 2(1)(b)(iii).
  ...
  (3) For the purposes of the NRWT rules, an amount of interest is paid by an approved issuer under a registered security only if it is treated as paid in respect of a registered security under section 86I of the Stamp and Cheque Duties Act 1971.
...
(1) In section RG 5(2), section RF 2(5) and (6) (Non-resident passive income) is replaced by section RG 4.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 538 Using loss balances
(1) In section RG 6(3)(a), section RF 2(5) and (6) (Non-resident passive income) is replaced by section RG 4.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 539 Reduction of payments for conduit tax relief
(1) In section RG 7(2)(b), section 32M of the Tax Administration Act 1994 is replaced by section RG 6.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 540 Subpart RG repealed
(1) Subpart RG is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 541 Refunds for overpaid tax
(1) After section RM 2(1), the following is inserted:Refundable credits
...
(2) In section RM 2, in the list of defined terms, refundable tax credit is inserted.

### 542 Overpayment on income statements
(1) After section RM 5(1), the following is inserted:Refundable credits
  (1B) An amount of tax under subsection (1) includes an amount of a refundable tax credit to which section LA 5(5) (Treatment of remaining credits) applies.
(2) In section RM 5, in the list of defined terms, refundable tax credit is added.

### 543 Using refund to satisfy tax liability
(1) Section RM 10(1), other than the heading, is replaced by the following:
...
(2) In section RM 10(1), An amount of tax under this section includes an amount of a refundable tax credit under section LA 5(5) (Treatment of remaining credits). is added after RM 6.
(3) In section RM 10(4), section LA 7 (Remaining refundable credits: tax credits for families) is replaced by section LA 7 (Remaining refundable credits: tax credits under social policy schemes).
(4) In section RM 10, in the list of defined terms, refundable tax credit is added.
(5) Subsection (1) applies for the 2008–09 and later income years.

### 544 Operation of PAYE intermediaries' trust accounts
(1) In section RP 6(2)(b), employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(2) In section RP 6(3)(b), employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(3) In section RP 6(3)(d), employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(4) In section RP 6, in the list of defined terms, employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(5) Subsections (1) to (3) apply for the 2008–09 and later income years.

### 545 General responsibility of employers
(1) In section RP 7(3), the employer's superannuation contribution on the employee's behalf is replaced by the employer's superannuation cash contribution made on the employee's behalf.
(2) In section RP 7, in the list of defined terms, employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(3) Subsection (1) applies for the 2008–09 and later income years.

### 546 Information required from employers
After section RP 8(a)(ii), the following is inserted:.
...
(1) In section RP 11, the section heading is replaced by Employer's superannuation cash contributions.
(2) In section RP 11, employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(3) In section RP 11, in the list of defined terms, employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(4) Subsections (1) and (2) apply for the 2008–09 and later income years.

### 548 General responsibilities of PAYE intermediaries
(1) In section RP 13(2), employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(2) In section RP 13, in the list of defined terms, employer's superannuation contribution is replaced by employer's superannuation cash contribution.
(3) Subsection (1) applies for the 2008–09 and later income years.

### 549 Collection, payment, and information requirements
After section RP 14(a), the following is inserted:.
...
In section RP 17, provisional tax. is replaced by provisional tax, terminal tax, or an increase in an assessment of tax as described in section RP 17B(3).

### 551 New section RP 17B inserted
After section RP 17, the following is inserted:Tax pooling accounts and their useMeaningUse of funds in tax pooling accountsWhen original liability increasedTransfer within 60 days for provisional tax or terminal taxTransfer within 60 days for increased amountsTransfer within 60 days for deferrable taxDefined in this Act: amount, amount of tax, assessment, Commissioner, notice, pay, provisional tax, tax account with the Commissioner, tax pooling account, terminal tax.
  ...
  (2) An amount held in a tax pooling account on behalf of a person may be refunded, transferred, sold, or used to satisfy a person's liability for terminal tax, provisional tax, or an increased amount of tax described in subsection (3).
  (3) For the purposes of this section, an increased amount of tax—
    ...
    (c) does not include the amount of the previous assessment.
  (4) If a person chooses to use funds in a tax pooling account to satisfy an obligation for provisional tax or terminal tax for a tax year, the tax pooling intermediary must ask the Commissioner within 60 days from the person's terminal tax date for the tax year to transfer the amount to the person's tax account with the Commissioner.
  (5) If a person chooses to use funds in a tax pooling account to satisfy an obligation for an increased amount of tax under subsection (3)(a), the tax pooling intermediary must ask the Commissioner within 60 days from the date on which the Commissioner issues the notice of assessment increasing the amount to transfer the amount to the person's tax account with the Commissioner.
...
(1) In section RP 18(2)(c), person. is replaced by person: and the following is added:
...
(2) After section RP 18(2), the following is inserted:Effective date
...
(3) Section RP 18(4) is replaced by the following:Confirming receipt of deposit and details
...
(1) Section RP 19(1) is replaced by the following:Transferring amountsTreatment of transferred amounts
...
(2) In section RP 19(2), the person's tax account is replaced by the person's tax account or the account of another intermediary.
(3) Section RP 19(3), other than the heading, is replaced by the following:
...
(1) In section RZ 3(3), the preceding tax year is replaced by the tax year before the preceding tax year.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 555 GST ratio method: 2008–09 and 2009–10 income years
(1) In section RZ 4(1)(c), 2007–08 income year is replaced by 2007–08 income year or an earlier income year.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 556 New section RZ 11 added
After section RZ 10, the following is added:Refunds for life insurersDefined in this Act: amount of tax, Commissioner, imputation credit, income year, life insurer, pay, policyholder base income tax liability, tax.
...
(2) The definition of 1973 version provisions is repealed.
(3) The definition of 1988 version provisions is repealed.
(4) The definition of 1990 version provisions is repealed.
(5) After the definition of accident insurance contract, the following is inserted:.
...
(7) Before the definition of actuary, the following is inserted:.
...
(8) The definition of after-income tax earnings is repealed.
(9) The definition of after-income tax loss is repealed.
(10) In the definition of agricultural, horticultural, or viticultural company, schedule 4, part C is replaced by schedule 4, part C, clause 1(b).
(11) After the definition of approved issuer, the following is inserted:.
...
(13) The definition of associated, associated person, person associated is replaced by the following:.
...
(14) After the definition of associated mining operations, the following is inserted:.
...
(15) In the definition of associated non-attributing active CFC, paragraph (a) is replaced by the following:.
  (a) associated with the CFC under section YB 2 (Two companies); and
(16) After the definition of association rebate, the following is inserted:.
  - **attributable CFC amount** is defined in section EX 20B (Attributable CFC amount)
(17) After the definition of attributed CFC net loss, the following are inserted:.
...
(18) After the definition of attributing interest, the following is inserted:.
  - **attribution period** , for a multi-rate PIE, means a period described in section HM 34 (Attribution periods)
(19) After the definition of benefit, the following is inserted:.
...
(21) After the definition of bonus issue in lieu, the following is inserted:.
...
(22) In the definition of branch equivalent income, as that provision read immediately before being amended by section 161 of the Taxation (International Taxation, Life Insurance, and Remedial Matters) Act 2009 is added.
(23) In the definition of branch equivalent loss, as that provision read immediately before being amended by section 161 of the Taxation (International Taxation, Life Insurance, and Remedial Matters) Act 2009 is added.
(24) After the definition of calculation method, the following is inserted:.
...
(25) In the definition of cancellation, including on the liquidation of the company is replaced by including on the liquidation of a company, and when a stapled debt security ceases to be a share.
...
(28) In the definition of consideration, before paragraph (a), the following is inserted:.
...
(29) In the definition of consolidated FDPA group, consolidated FDPA group is replaced by consolidated FDP group.
(30) In the definition of continuity provisions, paragraph (i) is replaced by the following:.
  (i) section OE 10 (BETA credit for loss of shareholder continuity); and
(31) The definition of control is repealed.
(32) The definition of convert is replaced by the following:.
...
(34) In the definition of credit account continuity provisions, paragraph (c) is replaced by the following:.
...
(36) In the definition of creditable membership,—
  (a) in paragraph (b)(i), first received is replaced by a contribution for the person is first received:
...
(37) After the definition of creditable membership, the following is inserted:.
  - **creditor workout** means, in relation to financial arrangements,—
...
(38) The definition of current accounting year is repealed.
(39) After the definition of debenture holder, the following is inserted:.
  - **debt security** is defined in section FA 2B(4) (Stapled debt securities)
(40) After the definition of debt security, the following is inserted:.
...
(41) The definition of derivative instrument is replaced by the following:.
  - **derivative instrument** means a derivative as defined in NZIAS 39
(42) The definition of direct income interest is replaced by the following:.
...
(43) In the definition of dividend, paragraph (a) is replaced by the following:.
...
(47) After the definition of emergency call, the following is inserted:.
...
(48) After the definition of emigrating company, the following is inserted:.
  - **emissions unit** means a unit as defined in section 4(1) of the Climate Change Response Act 2002
(49) In the definition of employee, in paragraph (b), sections CW 17 (Expenditure on account, and reimbursement, of employees) and CW 18 (Allowance for additional transport costs) is replaced by sections CW 17, CW 17B, CW 17C, and CW 18 (which relate to expenditure, reimbursement, and allowances of employees).
(50) In the definition of employee, in paragraph (c)(ii), schedule 4 (Rates of tax for schedular payments) is replaced by schedule 4, parts A and I (Rates of tax for schedular payments).
(51) In the definition of employee's superannuation accumulation, paragraph (a) is replaced by the following:.
...
(52) In the definition of employer,—
  ...
  (b) in paragraph (c)(ii), schedule 4 (Rates of tax for schedular payments) is replaced by schedule 4, parts A and I (Rates of tax for schedular payments).
...
(54) In the definition of employer monthly schedule, paragraph (h) is replaced by the following:.
...
(55) In the definition of employer-sourced superannuation savings,—
  (a) in paragraph (a), employer's superannuation contributions is replaced by employer's superannuation cash contributions under section RA 5(1)(c) (Tax obligations for employment-related taxes):
  (b) in paragraph (c),—
    (i) that is, employer's superannuation contributions is replaced by that is, employer's superannuation cash contributions under section RA 5(1)(c):
    (ii) the employer's superannuation contributions is replaced by those employer's superannuation cash contributions.
...
(57) The definition of employer's superannuation contribution is replaced by the following:.
...
(58) The definition of ESCT is replaced by the following:.
  - **ESCT** —
...
(59) In the definition of ESCT rate threshold amount, the words before paragraph (a) are replaced by the following:.
  - **ESCT rate threshold amount** , for an employer's superannuation cash contribution, means—
(60) The definition of ETS unit is repealed.
(61) After the definition of excess debt entity, the following is inserted:.
...
(62) In the definition of excluded ancillary tax, paragraph (d) is repealed.
(63) In the definition of excluded fixed rate security, substituting debenture is replaced by substituting debenture or stapled debt security.
(64) After the definition of excluded option, the following is inserted:.
...
(68) The definition of fair dividend rate method is replaced by the following:.
...
(69) The definition of fair value method is replaced by the following:.
...
(70) The definition of FDP rules is replaced by the following:.
  - **FDP rules** means—
...
(71) After the definition of financial arrangements rules, the following is inserted:.
...
(73) The definition of financial statements is replaced by the following:.
...
(74) The definition of first tracking date is repealed.
(75) After the definition of fixed principal financial arrangement, the following is inserted:.
...
(76) In the definition of fixed-rate share,—
  (a) in paragraph (e), equity) is replaced by equity):, and the following is added::
    (f) in section FA 2B (Stapled debt securities) and the definitions of proportional-stapling company and stapled debt security, means—
...
(77) The definition of foreign dividend is repealed.
(78) The definition of foreign dividend company is repealed.
(79) The definition of foreign dividend company net earnings is repealed.
(80) The definition of foreign group is repealed.
(81) After the definition of foreign non-dividend income, the following is inserted:.
  - **foreign PIE equivalent** is defined in section HM 3 (Foreign PIE equivalents)
(82) The definition of forest land unit is replaced by the following:.
  - **forest land emissions unit** means a pre-1990 forest land emissions unit or a post-1989 forest land emissions unit
(83) After the definition of forestry company, the following is inserted:.
...
(84) After the definition of fully credited for conduit tax relief, the following is inserted:.
  - **fully imputed** ,—
...
(85) After the definition of general insurance, the following is inserted:.
  - **general insurance contract** has the meaning given in IFRS 4
(86) After the definition of goods, the following is inserted:.
...
(88) The definition of grey list company is replaced by the following:.
...
(89) The definition of grey list dividend is repealed.
...
(91) In the definition of holding company, paragraph (a) is replaced by the following:.
  (a) for a forestry company, means a company associated with the forestry company:
(92) After the definition of home vendor mortgage, the following is inserted:.
  - **honorarium** is defined in section CW 62B (Voluntary activities) for the purposes of that section and schedule 4, part B (Rates of tax for schedular payments)
(93) After the definition of IFRS, the following is inserted:.
  - **IFRS 4** means the IFRS, numbered NZ IFRS 4, that relates to insurance contracts
(94) After the definition of IFRS 4, the following is inserted:.
...
(95) In the definition of income from employment, the following is added:.
  (d) in section DA 2(4), includes excluded income derived by a person from employment
(96) In the definition of income interest, in paragraph (b), subpart OE is replaced by subparts FE (Interest apportionment on thin capitalisation) and OE.
(97) In the definition of income tax liability, paragraph (a)(ii) is replaced by the following:.
...
(98) In the definition of international tax rules, paragraph (a)(xiii) is replaced by the following:.
  (xiii) section YA 2 (Meaning of income tax varied):
(99) In the definition of international tax rules, paragraph (a)(xiv) and (xv) are replaced by the following:.
...
(100) In the definition of international tax rules, paragraph (a)(xiv) is repealed.
(101) In the definition of international tax rules, paragraph (b), sections 61 and 183 is replaced by section 61.
(102) In the definition of investor, paragraph (b) is replaced by the following:.
  (b) for a portfolio investment entity, is defined in section HM 4 (Who is an investor?)
(103) After the definition of investor, the following are inserted:.
...
(104) After the definition of joint venture agreement, the following is inserted:.
  - **jurisdictional attributed income** is defined in section IQ 2B(9) (Attributed CFC net loss from tax year before first affected year) for the purposes of that section and section LK 5B (Credits from tax year before first affected year)
  - **jurisdictional BE income** is defined in section IQ 2B(9) (Attributed CFC net loss from tax year before first affected year) for the purposes of that section and section LK 5B (Credits from tax year before first affected year)
  - **jurisdictional income ratio** is defined in section IQ 2B(9) (Attributed CFC net loss from tax year before first affected year) for the purposes of that section and section LK 5B (Credits from tax year before first affected year)
(105) The definition of Kyoto unit is repealed.
(106) After the definition of land, the following is inserted:.
...
(107) After the definition of land loss, the following is inserted:.
...
(109) In the definition of lease, in paragraph (f)(i), paragraph (c) is replaced by paragraph (d).
...
(114) The definition of limited partnership net deduction is replaced by the following:.
...
(115) After the definition of limited-recourse loan, the following is inserted:.
...
(116) After the definition of listed PAYE intermediary, the following is inserted:.
...
(117) In the definition of loan, in paragraph (b), and subpart LL (Underlying foreign tax credits (UFTC)), is omitted.
(118) In the definition of market value circumstance, paragraph (a)(ii), applies is replaced by or FA 2B (Stapled debt securities) applies.
...
(121) After the definition of motor vehicle, the following is inserted:.
...
(123) After the definition of natural resource, the following is inserted:.
...
(125) The definition of new start grant is replaced by the following:.
...
(126) In the definition of new tax rate person, in paragraph (b), portfolio tax rate entity is replaced by multi-rate PIE.
(127) The definition of New Zealand unit is replaced by the following:.
  - **New Zealand emissions unit** means a New Zealand unit as defined in section 4(1) of the Climate Change Response Act 2002
(128) After the definition of nominee, the following is inserted:.
...
(129) The definition of non-creditable dividend is repealed.
(130) In the definition of non-filing taxpayer, paragraph (b) is replaced by the following:.
...
(131) After the definition of non-integral fee, the following is inserted:.
...
(134) In the definition of non-resident entertainer, paragraphs (b) and (c) are replaced by the following:.
  (b) undertakes a Part F activity
(135) After the definition of non-resident person, the following is inserted:.
...
(136) After the definition of notice period, the following is inserted:.
...
(137) After the definition of NZIAS 17, the following is inserted:.
...
(138) The definition of offshore development is repealed.
(139) The definition of onshore development is repealed.
(140) In the definition of operating lease, means is replaced by means, except in section EW 15I(1)(b)(iib) (Mandatory use of yield to maturity method for some arrangements),.
(141) After the definition of outstanding balance, the following is inserted:.
...
(142) After the definition of overseas pension the following is inserted:.
...
(143) In the definition of ownership interest, that section is replaced by that section and section YC 18B (Corporate reorganisations not affecting economic ownership).
(144) After the definition of parental tax credit, the following is inserted:.
...
(148) In the definition of personal service rehabilitation payment,—
  ...
  (b) paragraph (c) is replaced by the following:.
    (c) in providing to a person—
      ...
      (ii) a key aspect of rehabilitation referred to in section 81(1)(h) (relating to transport for independence) of that Act to the extent provided by paragraph (a)(i) of the definition of transport for independence in schedule 1, clause 12 of that Act:
      (iii) similar rehabilitation referred to in an earlier Act corresponding to that Act
(149) After the definition of petroleum mining company, the following is inserted:.
...
(155) The definition of portfolio investment entity is replaced by the following:.
  ...
  - **portfolio investment entity** means—
    ...
    (c) a benefit fund PIE:
    (d) a life fund PIE
(156) In the definition of portfolio investor rate, in paragraph (b)(ii), the time; or is replaced by the time; and and the following is inserted:.
  (iii) the Commissioner has not notified the entity to disregard the rate that the investor has notified to the entity; or
(157) In the definition of portfolio listed company, in paragraph (e), fund is replaced by fund; and, and the following is added:.
...
(158) In the definition of portfolio tax rate entity, in paragraph (c), New Zealand; and is replaced by New Zealand that has chosen to become a portfolio listed company under section HL 12 (Unlisted company choosing to become portfolio listed company); and.
(159) The definitions of post-1989 forest land and post-1989 forest land unit are replaced by the following:.
...
(160) The definitions of pre-1990 forest land and pre-1990 forest land unit are replaced by the following:.
...
(164) In the definition of prescribed investor rate, paragraph (a)(i), none of paragraphs (b) and (c) is replaced by none of paragraphs (b), (bb), and (c).
(165) In the definition of prescribed investor rate, paragraph (a)(ii) is replaced by the following: .
...
(166) In the definition of prescribed investor rate, after paragraph (b) the following is inserted:.
...
(167) The definition of prescribed investor rate is replaced by the following:.
  - **prescribed investor rate** , for a multi-rate PIE and an investor, means an applicable tax rate under sections HM 56 to HM 59 (which relate to the default and other tax rates for investors)
...
(170) In the definition of profit-related debenture, for the purposes of that section is omitted.
(171) After the definition of property, the following is inserted:.
...
(173) The definition of qualifying event is repealed.
(174) After the definition of recognised exchange, the following is inserted:.
...
(175) The definition of redundancy payment is replaced by the following:.
...
(176) In the definition of refundable tax credit, in paragraph (d), election) is replaced by election): and the following is added:.
  (e) a tax credit under section LS 1 (Tax credits for portfolio tax rate entities and their investors)
(177) In the definition of refundable tax credit, paragraphs (d) and (e) are replaced by the following:.
...
(179) The definition of related person is replaced by the following:.
...
(180) The definition of relative is replaced by the following:.
  - **relative** ,—
...
(181) The definition of replacement ETS unit is replaced by the following:.
...
(182) The definition of required interest is repealed.
(183) After the definition of resident foreign trustee, the following is inserted:.
  - **resident group member** is defined in section IQ 2B(9) (Attributed CFC net loss from tax year before first affected year) for the purposes of that section and section LK 5B (Credits from tax year before first affected year)
(184) After the definition of resident passive income, the following is inserted:.
...
(185) The definition of retained earnings is repealed.
(186) The definition of revenue account property is replaced by the following:.
...
(187) After the definition of right, the following is inserted:.
  - **RMBS special purpose vehicle** means a company or a trustee of a trust that, ignoring section HR 9,––
...
(188) In the definition of salary or wages, in paragraph (b), for the purposes of that section is replaced by and schedule 28, clause 7 (Requirements for complying fund rules) for the purposes of those sections.
...
(191) In the definition of schedular income, paragraph (c) is repealed.
(192) In the definition of schedular income, the following is inserted after paragraph (d):.
  (db) income derived by a multi-rate PIE:
(193) In the definition of schedular income, in paragraph (f), section RE 4(4) (Persons who have withholding obligations) is replaced by section RF 2(3) (Non-resident passive income).
...
(195) After the definition of section 200, the following is inserted:.
  - **secured amounts** is defined in section HG 11(12) (Limitation on deductions by partners in limited partnerships) for the purposes of that section
(196) In the definition of settlor, after paragraph (b), the following is added:.
...
(197) In the definition of share, after paragraph (b), the following is inserted:.
  (bb) includes a stapled debt security to which section FA 2B(2) (Stapled debt securities) applies:
(198) The definition of share purchase agreement is replaced by the following:.
...
(199) In the definition of share reorganisation, held by the person, including the person, who holds attributing interests in the FIF is replaced by held by persons, including the person, who hold attributing interests in the FIF.
(200) After the definition of shareholder, the following is inserted:.
...
(202) After the definition of standing timber, the following is inserted:.
...
(203) The definition of starting date is repealed.
(204) In the definition of substituting debenture, for the purposes of that section is omitted.
...
(206) The definition of surrender is replaced by the following:.
...
(208) The definition of taxation law is replaced by the following:.
...
(209) The definition of tax pooling account is replaced by the following:.
  - **tax pooling account** is defined in section RP 17B (Tax pooling accounts and their use)
(210) The definition of tax withheld is replaced by the following:.
  - **tax withheld** means an amount of tax—
    (a) withheld from a PAYE income payment under the PAYE rules to the extent to which it is a tax credit under section LB 1 (Tax credits for PAYE income payments):
...
(211) After the definition of technology, the following is inserted:.
...
(212) The definition of tracking account is repealed.
(213) The definition of tracking associate is repealed.
(214) In the definition of trading stock,— .
  (a) in paragraph (b), in sections GC 6 is replaced by in sections EB 24 (Apportionment on disposal of business assets that include trading stock), GC 6:
  (b) paragraph (c) is replaced by the following:
...
(215) The definition of UFTC is repealed.
(216) The definition of UFTC accounting period is repealed.
(217) After the definition of unlisted widely-held trust, the following is inserted:.
...
(219) Before the definition of voting interest, the following is inserted:.
  - **volunteer** is defined in section CW 62B (Voluntary activities) for the purposes of that section
(220) The definition of widely-held GIF is replaced by the following:.
...
(221) The definition of widely-held superannuation fund is replaced by the following:.
...
(222) After the definition of working day, the following is inserted:.
  - **work-related relocation** is defined in section CW 17B(4) (Relocation payments)
(223) The definition of zero-rated portfolio investor is replaced by the following:zero-rated investor, for an investor in an investor class of a PIE, means an investor referred to in section HM 59 (Prescribed investor rates for certain investors: 0%).
...
Section YB 20(2)(d) is replaced by the following: .
...
(1) Table Y1, the heading before section YB 1, and sections YB 1 to YB 20 are replaced by the following:Associated personsWhat this subpart doesAssociated person rules and nominee rulesOther referencesTestsApplicationLoss-attributing qualifying companies and shareholdersLow-turnover tradersControl interests in foreign companiesSupplementary dividend holding companiesDefined in this Act: associated person, company, loss-attributing qualifying company, low-turnover trader, New Zealand resident, nominee, non-resident, relative, settlor, shareholder, supplementary dividend holding company, trusteeTwo companiesCommon voting interestsCommon market value interestsCommon control by other meansGeneral aggregation ruleAggregation rule for land provisionsException for certain government entitiesException for international tax rulesException for managed fundsDefined in this Act: associated person, company, Crown Research Institute, group of companies, group of persons, international tax rules, land provisions, market value circumstance, market value interest, non-resident, PIE, portfolio investment entity, state enterprise, voting interestCompany and person other than companyCompany and 25% voting interest holderCompany and 25% market value interest holderGeneral aggregation ruleAggregation rule for land provisionsPerson other than companyDefined in this Act: associated person, company, land provisions, market value circumstance, market value interest, voting interestTwo relativesDegree of relationshipException: blood relationshipsTreatment of adoptionExceptionDefined in this Act: associated person, land provisionsPerson and trustee for relativeAssociationLand provisionsDefined in this Act: associated person, land provisions, trusteeTrustee and beneficiaryAssociationLand provisionsDefined in this Act: associated person, land provisionsTwo trustees with common settlorAssociationTreatment of spouses and partnersDefined in this Act: associated person, settlor, trusteeTrustee and settlorAssociationExclusionDefined in this Act: associated person, charitable trust, settlor, trusteeSettlor and beneficiaryAssociationLand provisionsDefined in this Act: associated person, land provisions, settlor, trusteeWho is a settlor?Defined in this Act: settlorTrustee and person with power of appointment or removalDefined in this Act: associated person, trusteePartnership and partnerAssociationLimited partnershipsLimited partnerships: general aggregation ruleLimited partnerships: aggregation rule for land provisionsDefined in this Act: associated person, limited partner, limited partnership, partnership shareTripartite relationshipTestException: companies testsAssociation for purposes of research and development tax creditsDefined in this Act: associated person, company, tax creditExceptions for employee trustsBeneficiariesNon-corporate settlorsCorporate settlorsPersons with power of appointment or removalDefined in this Act: associated person, company, direct voting interest, employee, employer, market value circumstance, market value interest, settlorExceptions for certain trusts and charitable organisationsTrustee and beneficiary and trustee for relative tests: certain trustsTrustee and beneficiary and settlor and beneficiary tests: charitable organisationDefined in this Act: charitable organisation, lines trust, unit trust.
  ...
  (5) A special rule provides that a shareholder in a loss-attributing qualifying company and that LAQC are treated as associated persons for the purposes of section DS 4 (Meaning of film reimbursement scheme), see section DS 4(5).
  ...
  (8) A special rule applies for the purposes of section LP 2 (Tax credits for supplementary dividends) to determine when a company is associated with a supplementary dividend holding company, see section LP 2(6).
  ...
  (3) Subsection (1) does not apply in relation to the association of a company and a person, for the purposes of section LH 1(2) (Who this subpart applies to).
...
In section YB 21, in the compare note, s OD 9 is replaced by ss HH 1(1), OD 9.

### 565 Heading for subpart YC
The heading for subpart YC is replaced by Measurement of company ownership.

### 566 Heading and section YC 1 repealed
(1) The heading before section YC 1, and section YC 1, are repealed.
(2) Subsection (1) applies for the 2010–11 and later income years.

### 567 Look-through rule for corporate shareholders
In section YC 4, in the compare note, OD 4(4) is replaced by OD 4(3)(d), (4).

### 568 Disregarding certain securities
(1) In section YC 6(4), section YC 19 is replaced by section YC 20.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 569 Reverse takeovers
(1) In section YC 18(6),––
  (a) in paragraph (a), , if paragraph (b) does not apply is omitted:
  (b) in paragraph (b), , if a market value circumstance exists for the company is omitted.
(2) In section YC 18, in the list of defined terms, market value circumstance is omitted.

### 570 New section YC 18B inserted
After section YC 18, the following is inserted:Corporate reorganisations not affecting economic ownershipWhen subsection (3) appliesDescription of arrangementLoss balance and credit account continuityEffect of subsection (3)DefinitionsDefined in this Act: arrangement, company, continuity provision, dividend, excluded preference share, limited attribution company, ownership interest, share, shareholder.
  ...
  (2) The description of the arrangement for the purposes of subsection (1) is as follows:
    ...
    (b) the ownership of the initial parent is reorganised so that another company (the new parent) is a limited attribution company that is treated under section YC 11(3) and (4) as holding ownership interests in the initial parent after the arrangement is implemented; and
    (c) the percentage ownership interests (the final percentage) that a person receives in the new parent is the same as their percentage ownership interests (the inital percentage) in the initial parent that they cease to hold as a result of the arrangement. For the purposes of this paragraph, a difference between the initial and final percentages is ignored if the difference is caused by a transfer or non-transfer of ownership interests that—
  ...
  (4) Subsection (3) does not prevent a change in shareholders, the holdings of ownership interests, or other circumstances, after the implementation of the arrangement from having an effect on the application of the continuity provisions and the provisions described in subsection (3) after the implementation of the arrangement.
  (5) In this section,––
    (a) ownership interest has the same meaning as in section YC 18(6), except that for the purposes of this section, excluded preference shares are ignored:
...
(1) Section YD 1(9) and (10) are repealed.
(2) After section YD 1(8), the following is added:Treatment of non-resident seasonal workers
...
(3) In section YD 1, in the list of defined terms, transitional resident is omitted.
(4) In section YD 1, in the list of defined terms, non-resident seasonal worker and recognised seasonal employment scheme are inserted.
(5) Subsection (2) applies for the 2009–10 and later income years.

### 572 Country of residence of foreign companies
(1) In section YD 3(4)(b), head is replaced by head office.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 573 Classes of income treated as having New Zealand source
In the compare note to section YD 4, s OE 4(1) is replaced by ss FB 2(2).

### 574 Apportionment of income derived partly in New Zealand
(1) After section YD 5(1), the following is inserted:Relationship with source rules
...
(2) In section YD 5(3), The result of the apportionment is replaced by The result of the apportionment, to the extent consistent with subsection (2),.
(3) In section YD 5, in the compare note, FB 2 is replaced by FB 2(1A).

### 575 General rules for currency conversion
(1) Section YF 1(1)(c) is replaced by the following:
...
(2) In section YF 1(3), the heading is replaced by Alternative use of monthly average rates.
(3) Section YF 1(3)(b) is replaced by the following:
  (b) a provision in this Act specifically allows it.
(4) Section YF 1(4) is repealed.

### 576 New section YZ 2 inserted
(1) After section YZ 1, the following is added:Saving of effect of section 394L(4A) of Income Tax Act 19762004 No 35 s YA 5B.
...
(1) In schedule 1, part A, clause 8,—
  (a) in the heading policyholder income is replaced by schedular policyholder base income:
  (b) in the words after the heading, policyholder income is replaced by schedular policyholder base income.
(2) In schedule 1, part E, the list of sections is replaced by CB 28, CD 53, CS 1, EK 8, EK 12, EK 23, EX 20, EX 50, EY 43, FE 22, FM 28, HA 15, HA 24, HC 22, HC 34, HF 1, HL 29, LC 1, LC 2, LE 2, LJ 5, LP 8, LP 10, OA 18, OB 19, OB 42, OB 46, OB 69, OB 73, OB 75, OB 78, OB 80, OC 36, OC 38, OE 7, OE 8, OP 100, OP 102, RD 50, RD 51, RD 66, RD 67, RD 69, RD 70, RD 72, RE 11–RE 19, RF 9, RF 12, RM 21, YA 1.
(3) Subsection (1) applies—
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.

### 578 Schedule 2—Basic tax rates for PAYE income payments
In schedule 2, part A, the following is inserted after clause 7:`NSW' tax code
...
(1) In schedule 4, part C, clause 1,—
  ...
  (b) paragraph (e) is repealed.
(2) In schedule 4, part C, clause 2, the definition of horticultural contract work is repealed and the following is inserted before the definition of farming contract work:.
...
(3) In schedule 4, the heading to Part F is replaced by Payments for activities related to sports, media, entertainment, and public speaking.
(4) In schedule 4, part F, clause 4, schedular entertainment activities is replaced by a Part F activity.
(5) In schedule 4, part F, clauses 5 and 6, schedular entertainment activities is replaced by a Part F activity in both places where it appears.
(6) In schedule 4, part F, clause 7, the following is inserted after the definition of modelling fee:.
...
(7) In schedule 4, part F, clause 7, the definition of schedular entertainment activities is repealed.
(8) Subsections (3) to (7) apply for the 2008–09 and later income years.

### 580 Schedule 5—Fringe benefit values for motor vehicles
(1) Schedule 5, clause 3(c) is replaced by the following:
...
(1) In schedule 13, after item 16, the following is added:17pipes
(2) In schedule 13, after item 17, the following is added:18purpose-built surfaces for outdoor sports facilities
(3) Subsections (1) and (2) apply for the 2008–09 and later income years.

### 582 Schedule 20—Expenditure on farming, horticultural, aquacultural, and forestry improvements
(1) In schedule 20, clause 1, unless clause 2 applies is replaced by unless clause 2 applies, preparation.
(2) In schedule 20, clause 2, column 2, 6 is replaced by 45.
(3) Subsections (1) and (2) apply for the 2008–09 and later income years.

### 583 Schedule 21—Expenditure and activities related to research and development
(1) Schedule 21, part A, clause 8 is replaced by the following:
...
(2) In schedule 21, part B, clause 7 is replaced by the following:
...
In schedule 24, the shoulder reference is replaced by ss DZ 11, YA 1.

### 585 Schedule 25—Foreign investment funds
(1) In schedule 25, the shoulder references are replaced by ss CQ 5, DN 6, EX 28, EX 29, EX 31, EX 32, EX 35–EX 39, EX 46, EZ 32.
(2) In schedule 25, the heading to part B is replaced by Foreign entities to which the FIF exemptions do not apply.
(3) Subsection (2) applies for the 2008–09 and later income years.

### 586 Schedule 27—Countries and types of income with unrecognised tax
In schedule 27, the shoulder reference is replaced by ss LJ 1, LK 2.

### 587 Schedule 28––Requirements for complying fund rules
Schedule 28, clause 7 is replaced by the following:
  (7) The sixth requirement is that the rules require, as a minimum, contributions to be deducted for an employee at the rate of 2% of gross salary or wages (as defined in section 4 of the KiwiSaver Act 2006).

### 588 New schedule 29—Portfolio investment entities: listed investors
After schedule 28, the following is inserted:ss HM 21, HM 22Portfolio investment entities: listed investors
  ...
  (5) A superannuation fund that—
    ...
    (ii) would, if treated as a unit trust, meet the requirements of 1 or more of paragraphs (a) and (c) to (e) of the definition of public unit trust; and
...
(1) In schedule 32, the following is omitted: Bright Hope International Trust.
(2) In schedule 32, the following are inserted: Educational Aid for International Development Trust Board, Global Hope, Ingwavuma Orphan Trust Fund of New Zealand, Kyrgyzstan New Zealand Rural Trust, L Women of Africa Fund, Partners Relief and Development NZ, Tender Trust, The Band Aid Box, The Destitute Children's Home, Pokhara, Charitable Trust, The Palestine Children's Relief Fund Charitable Trust, Triyog Himalaya Trust, and UNHCR (United Nations High Commissioner for Refugees).
(3) Subsections (1) and (2) apply for the 2008–09 and later income years.

### 590 Schedule 49—Enactments amended
In the amendments to the Injury Prevention, Rehabilitation, and Compensation Act 2001 (2001 No 49),—
  (a) the second item amending section 204(1)(b) relating to section HG 16 of the Income Tax Act 2004 is omitted:
  (b) in the item amending schedule 4, clause 1(c), an amount of tax, amount of tax is replaced by an amount of tax, which amount.

### 591 Schedule 50—Amendments to Tax Administration Act 1994
(1) The item amending section 3(4)(b) is repealed.
(2) The item inserting the new Part 2B is repealed.
(3) The item amending section 125(d) is repealed.

### 592 Schedule 51—Identified changes in legislation
In schedule 51, the following is inserted in the table:MC 6The reference to veteran's pension is omitted because the in-work tax credit is an incentive to return to work.

### 593 Schedule 52—Comparative tables of old and rewritten provisions
(1) In schedule 52, part A, the entry for FB 2(1), (2) is replaced by—
  (a) an entry for FB 2(1), (1A) having YD 5 in the second column:
  (b) an entry for FB 2(2) having YD 4 in the second column.
(2) In schedule 52, part A, in the first column of the entry for GC 15(1)–(3), GC 15(1)–(3) is replaced by GC 15.
(3) In schedule 52, part A, in the second column of the entry for GC 15(3), (4), CX 18 is replaced by CX 18, RD 54.
(4) In schedule 52, part A, the entry for HH 1(1)–(4), (8), (10) is replaced by—
  (a) an entry for HH 1(1) having YB 21 in the second column:
  (b) an entry for HH 1(2)–(4), (8), (10) having HC 28 in the second column.
(5) In schedule 52, part A, in the second column of the entry for KD A1, MC 1(2) is replaced by omitted.
(6) In schedule 52, part A, in the first column of the entry for KD 3(1), KD 3(1) is replaced by KD 3(1) qualifying person.
(7) In schedule 52, part A, in the second column of the entry for KD 3(1), MC 4 is replaced by MC 3.
(8) In schedule 52, part A, in the second column of the entry for ND 1, RA 5(b), RA 10 is replaced by RA 5(1)(b), RA 10.
(9) In schedule 52, part A, in the second column of the entry for NE 3, RA 5(c), RD 66(3)–(7), (13) is replaced by RA 5(1)(c), RD 66(3)–(7), (13).
(10) In schedule 52, part A, the entry for NG 2(1)(ab), (b)(ib), (c) is replaced by—
  (a) an entry for NG 2(1)(b)(i), (ib) having RF 12 in the second column:
  (b) an entry for NG 2(1)(ab) having RF 12B in the second column:
  (c) an entry for NG 2(1)(b)(iii) having RF 12C in the second column:
  (d) an entry for NG 2(1)(b)(ii) having RF 10(5B) in the second column.
(11) In schedule 52, part A, in the first column of the entry for OD 4(4), OD 4(4) is replaced by OD 4(3)(d), (4).
(12) In schedule 52, part A, the entry for OD 4(5A)–(5C) is omitted.
(13) In schedule 52, part A, after the entry for OD 5(5), a new entry is inserted for OD 5(5A)–(5C) having YC 12 in the second column.
(14) In schedule 52, part B, in the second column of the entry for GB 32, GC 15(1)–(3) is replaced by GC 15.
(15) In schedule 52, part B, in the second column of the entry for IC 7, IG 2(d), (11) is replaced by IG 2(2)(d), (11).
(16) In schedule 52, part B, in the second column of the entry for MC 1, KD A1, KD 1A is replaced by KD 1A.
(17) In schedule 52, part B, in the second column of the entry for MC 6, KD 3(1) is replaced by KD 3(1) qualifying person.
(18) In schedule 52, part B, in the second column of the entry for RD 54, ND 1S is replaced by GC 15(3), (4), ND 1S.
(19) In schedule 52, part B, in the second column of the entry for RF 10, NG 9 is replaced by NG 2(1)(b)(ii), NG 9.
(20) In schedule 52, part B, in the second column of the entry for RF 12, NG 2(1)(ab), (b)(ib), (c) is replaced by NG 2(1)(b)(i), (ib), (iii).
(21) In schedule 52, part B, after the entry for RF 12, the following are inserted:
  (a) an entry for RF 12B having NG 2(1)(ab) in the second column:
  (b) an entry for RF 12C having NG 2(1)(b)(iii) in the second column.
(22) In schedule 52, part B, in the second column of the entry for YB 21, OD 9 is replaced by HH 1(1), OD 9.
(23) In schedule 52, part B, the second column of the entry for YC 4 is replaced by OD 3(3)(d), OD 4(3)(d), (4).
(24) In schedule 52, part B, the second column of the entry for YC 12 is replaced by OD 5(5A)–(5C).
(25) In schedule 52, part B, in the second column of the entry for YD 4, OE 4(1) is replaced by FB 2(2).
(26) In schedule 52, part B, in the second column of the entry for YD 5, FB 2 is replaced by FB 2(1A).

### 594 Consequential amendments: associated person and list of defined terms
In the sections listed in schedule 1, the list of defined terms is amended in the manner indicated in the schedule.
...
(2) After the definition of disclosure notice, the following is inserted:.
...
(3) The definition of late filing penalty is replaced by the following:.
...
(4) The definition of response period, is replaced by the following: .
  - **response period** is defined in section 89AB
(5) In the definition of tax, paragraphs (a)(iii)(A) and (d)(iii)(A) are repealed.
...
(7) Subsection (3), for a tax return required to be filed under sections 16 to 18 of the Goods and Services Tax Act 1985, applies for a return due on or after 1 April 2008.
(8) Subsection (4) applies for the 2008–09 and later income years.
(9) Subsection (5) applies for all income years beginning on or after 1 July 2009.

### 597 Construction of certain provisions
(1) Section 4A(2)(a) is repealed.
(2) In section 4A(2)(c), paragraph (a) or is omitted.
(3) In section 4A(2)(d), paragraph (a) or is omitted.
(4) In section 4A(2)(d), unpaid tax. is replaced by unpaid tax: and the following is added:
...
(5) In section 4A(4), in the words before paragraph (a), RF 13, RG 3, or RG 6 is replaced by or RF 13.
(6) Subsections (1) to (3) and (5) apply for all income years beginning on or after 1 July 2009.

### 598 Part 2B replaced
(1) Part 2B is replaced by the following:Intermediaries for PAYE, provisional tax, and resident passive incomePAYE intermediariesPAYE intermediaries and listed PAYE intermediaries2004 No 35 ss NBA 1, NBB 3Application for approval as PAYE intermediary2004 No 35 s NBA 2(1)(a)–(c), (2), (3)Revocation of approval2004 No 35 s NBA 2(4)Fitness of applicants2004 No 35 s NBA 2(1)(c)Application for approval as listed PAYE intermediary2004 No 35 s NBB 2Grounds for revocation of listing2004 No 35 s NBB 4(1)Procedure for revocation of listing2004 No 35 s NBB 4(2)–(5)Employers’ arrangements with PAYE intermediaries2004 No 35 ss NBA 3, NBA 8, NBB 7Privacy requirements2004 No 35 s NBA 5(3)Amended monthly schedules2004 No 35 s NBA 5(4)Subsidy claim forms2004 No 35 ss NBB 3(2), NBB 5(1)–(3)RWT proxiesRWT proxies2004 No 35 s NF 2AA.
...
(2) After section 15N, the following is inserted:Tax pooling intermediariesEstablishing tax pooling accounts2004 No 35 s MBA 3(1)Role of Commissioner2004 No 35 s MBA 4(5), (6)Applications to establish tax pooling accounts 2004 No 35 s MBA 4Fitness of applicants2004 No 35 s MBA 3(d)Requirements for applications to establish tax pooling accounts2004 No 35 s MBA 3Winding up tax pooling accounts2004 No 35 s MBA 8.
...
(1) In section 17(1C)(a)(ii), paragraph (b) is replaced by paragraph (a).
(2) Section 17(1C)(a) is replaced by the following:.
...
(1) In section 20B(1), or under a discovery obligation is inserted after under 1 or more of sections 16 to 19.
...
(1) In section 20C(1), request for information is replaced by request for, or discovery obligation for disclosure of, information.
(2) Section 20C(2)(a) is replaced by the following:.
  (a) from the time of the request for, or discovery obligation for disclosure of, information:
(3) Section 20C(3)(a) is replaced by the following:.
...
(1) In section 20D(4)(d), information. is replaced by information: and the following is added:
...
(1) In section 20F(2)(d), information. is replaced by information: and the following is added:
  (e) if the requirement to disclose information is under a discovery obligation, by the date by which the discovery obligation requires the disclosure of information.
(2) In section 20F(5), the words before paragraph (a) are replaced by the following:.
...
(3) After section 20F(5), the following is added:
...
(1) In section 20G(1), in the words before paragraph (a), District Court Judge is replaced by District Court Judge, or to the court or Taxation Review Authority hearing the proceedings giving rise to the claim,.
(2) Section 20G(1)(b) is replaced by the following:.
  (b) information provided or withheld by the person is tax contextual information in relation to the book or document:
(3) In section 20G(2), District Court Judge is replaced by District Court Judge, court, or Taxation Review Authority in both places where it appears.
(4) After section 20G(3), the following is added:
...
In section 24(1), withheld from it is replaced by withheld from it, and the amount of any payroll donation.

### 607 PAYE tax codes
(1) In section 24B(3), the following is inserted after paragraph (g):.
  (gb) NSW for salary or wages for employment as a non-resident seasonal worker:
(2) Subsection (1) applies for the 2009–10 and later income years.

### 608 Special tax code certificates
(1) After section 24F(5), the following is inserted:
  (5B) This section does not apply to an employee who is a non-resident seasonal worker.
(2) Subsection (1) applies for the 2009–10 and later income years.

### 609 Variation of requirements
(1) In section 24P, 24B, 24H, and 24I is replaced by RD 22 of the Income Tax Act 2007, and 24B, 24H, 24I, and 24L.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 610 New heading and section 24Q inserted
After section 24P, the following is inserted:Payroll donationsTransfer of payroll donations by employers
...
(1) Section 28B is replaced by the following:Notification of investors’ tax rates
...
(1) Section 31B(1) is repealed.
(2) Section 31B(2B) is replaced by the following:
...
(3) In section 31B(2B), subsection (1) or (2) is replaced by subsection (2).
(4) In section 31B(3), subsections (1) and (2) do not apply are replaced by subsection (2) does not apply.

### 613 Section 31B replaced
(1) Section 31B is replaced by the following:Notification requirements for PIEsNotification requirements for multi-rate PIEs
...
(1) In section 32A(1), employer's superannuation contributions is replaced by employer's superannuation cash contributions.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 615 Certification requirements for withdrawals subject to section CS 1 of Income Tax Act 2007
(1) In section 32B(1)(a), (b), (c), (k), and (l), employer's superannuation contributions is replaced by employer's superannuation cash contributions.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 616 Applications for RWT exemption certificates
(1) After section 32E(2)(eb), the following is inserted:.
  (ec) the trustee of the Niue International Trust Fund:
  (ed) the trustee of the Tokelau International Trust Fund:
(2) Section 32E(2)(i)(ii) is replaced by the following:.
...
(1) The heading before section 32N and section 32N are repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 618 Returns of income
(1) Section 33(1) is replaced by the following:
...
(2) Section 33(1C) is replaced by the following:
...
(1) After section 33A(1)(b)(ixa), the following is inserted:.
  (ixb) salary or wages from employment as a non-resident seasonal worker if the employee has used the NSW tax code; and
(2) After section 33A(1)(b)(ixb), the following is inserted:.
  (ixc) salary or wages from employment as a non-resident seasonal worker; and
(3) In section 33A(1)(i), Student Loan Scheme Act 1992. is replaced by Student Loan Scheme Act 1992; and and the following is added:
  (j) is a non-resident seasonal worker.
(4) Section 33A(2)(a) is replaced by the following:.
...
(1) In section 36A(2), that certificate in an electronic format is replaced by that payment form in electronic format.
(2) After section 36A(2), the following is inserted:
...
(1) Section 36AB is replaced by the following:Electronic return requirements for multi-rate PIEs
...
(1) Section 38(1B) is replaced by the following:
...
(1) Section 41A(1) is replaced by the following:
...
(2) Section 41A(3) is replaced by the following:
...
(1) The section heading to section 41B is replaced by Return by person applying for tax credit on redundancy payment.
(2) Section 41B(1) is replaced by the following:
  (1) A person who has a tax credit under section ML 2 of the Income Tax Act 2007 may apply to the Commissioner for a refund.
(3) Section 41B(4) is replaced by the following:
...
(1) The subsection between section 57B(3) and section 57B(4) is replaced by the following:
...
(2) In section 57B(6)(c), by the end of the second month is replaced by by the end of the third month.

### 626 Section 57B replaced
(1) Section 57B is replaced by the following:Return requirements for multi-rate PIEs
...
In section 59(2),—
  (a) sections HC 27(4) and YB 21 is replaced by section YB 21:
  (b) section HH 1(1) of that Act is replaced by section YB 21 of that Act.

### 628 Disclosure of interest in foreign company or foreign investment fund
(1) In section 61(1), the words before paragraph (a) are replaced by the following:.
...
(2) In section 61(1), the words before paragraph (a) are replaced by the following:.
...
(3) In section 61(1), in the proviso, EX 3(b) or (d) is replaced by EX 3(1)(b) or (d).
(4) Section 61(1C) is replaced by the following:
...
(5) Section 61(1C) is replaced by the following:
...
(1) In section 68C(2),––
  (a) in the words before the paragraphs, section KJ 1 of the Income Tax Act 2004 is replaced by section MK 1(1) of the Income Tax Act 2007:
  (b) in paragraph (b), meets the requirements of section KJ 2(d) of that Act is replaced by resides mainly in New Zealand:
  (c) in paragraph (c), section KJ 2(a) to (c), and (e) and (f) is replaced by section MK 2(1)(a) to (c), and (d)(i) and (ii).
(2) Section 68C(3)(b) is repealed.

### 631 Statements in relation to research and development tax credits: single persons
(1) Section 68D(1) is repealed.
(2) In section 68D(2), The person is replaced by A person who is not a member of an internal software development group.
(3) In section 68D(3)(b)(i), or 2009–10 is omitted.
(4) Section 68D(4) is repealed.
(5) Subsections (1) to (4) apply for the 2008–09 and later income years.

### 632 Section 68E replaced
(1) Section 68E is replaced by the following:Statements in relation to research and development tax credits: internal software development groups
...
(1) After section 68E, the following is inserted:Requirements for statements in relation to research and development tax credits
...
(1) Section 78E is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 635 Section 78F repealed
(1) Section 78F is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 636 New section 80KLB inserted
(1) After section 80KL, the following is inserted:Recovery of excess tax credits
  (1) This section applies when—
...
(1) Section 80KW(1)(b) is replaced by the following:
...
(2) In section 80KW(2)(b), under section 80KI is omitted.
(3) In section 80KW(5)(b), under section 80KN is omitted.
(4) In section 80KW(6), the formula is replaced by the following:(tax credit – parental tax credit)× 53.52
(5) Section 80KW(7)(b) is replaced by the following:
...
(1) Section 81(4)(p) is replaced by the following:.
...
(2) In section 81(4)(s)(ii), section 85K. is replaced by section 85K: and the following is added:
...
(1) In the heading to section 85F, large budget screen production grant is replaced by government screen production payment.
(2) Section 85F(1) and (2) are replaced by the following:
...
(3) In section 85F(3), in the definition of company, refers: is replaced by refers. and the definition of large budget screen production grant is repealed.

### 640 Disclosure of information in relation to Working for Families tax credits
(1) In section 85G(1)(b), sections MD 1, or MD 1 and ME 1 of that Act is replaced by section MD 1, or sections MD 1 and ME 1, of the Income Tax Act 2007.
(2) In section 85G(1)(c), of that Act is omitted.
(3) Subsection (2) applies for the 2008–09 and later income years.

### 641 Further secrecy requirements
Section 87(5)(d) is replaced by the following:.
...
(1) After section 89A, the following is inserted:Response periods
...
(1) After section 89D(2D), the following is added:
...
(1) After section 89DA(2), the following is added:
...
(1) Section 89N(1)(c)(iii) is replaced by the following:.
...
(2) Section 89N(1)(c)(v) is replaced by the following:.
...
(1) After section 91AAF(1), the following is inserted:
...
(2) Section 91AAF(4)(b) is replaced by the following:
...
(3) After section 91AAF(5), the following is added:
...
(1) Section 91AAH(3)(a) is replaced by the following:.
...
(1) In section 91AAK, of issuing a determination is replaced by of issuing or revoking a determination.
(2) Subsection (1) applies for the 2008–09 and later income years.

### 650 Applications for determinations
(1) In section 91AAM(4), of issuing a determination under section 91AAG(4) is replaced by of issuing a determination under section 91AAG(4) or revoking a determination under section 91AAG(7).
(2) Subsection (1) applies for the 2008–09 and later income years.

### 651 Determination on type of interest in FIF and use of fair dividend rate method
(1) In section 91AAO(1), section EX 40 of the Income Tax Act 2004 is replaced by section EX 46 of the Income Tax Act 2007.
(2) Section 91AAO(2)(b)(i) is replaced by the following:.
...
(3) After section 91AAO(3B), the following is inserted:
...
(4) Section 91AAO(3C) and (3D) are replaced by the following:
...
After section 91AAP, the following is inserted:Determinations relating to non-attributing active CFCsDetermination on insurer as non-attributing active CFC
  ...
  (8) A determination must be published in the Gazette within 30 days of the making of the determination.

### 653 New heading and section 91AAR inserted
After section 91AAQ, the following is inserted:Determinations relating to relocation paymentsDetermination relating to eligible relocation expenses
  ...
  (6) Within 30 days of issuing or changing a determination under this section, the Commissioner must publish a notice in the Gazette that—
...
(1) In section 94A(2), separately from the tax. is replaced by separately from the tax. However, this subsection does not apply to a penalty under section 141ED.
(2) Subsection (1) applies for a tax position taken on or after 1 April 2008.

### 655 Section 102 repealed
(1) Section 102 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 656 Section 103 repealed
(1) Section 103 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 657 Section 103A repealed
(1) Section 103A is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 658 Section 104 repealed
(1) Section 104 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 659 Time bar for amendment of income tax assessment
(1) Section 108(1B)(b) is replaced by the following:.
...
(2) Section 108(1B)(c) is replaced by the following:
  (c) the taxpayer—
...
(1) In section 108B(3)(d), section 108(1) is replaced by section 108(1) and (1A).
(2) Subsection (1) applies for the 2008–09 and later income years.

### 661 Amended assessments for research and development tax credits
(1) In section 113D, the following is added as subsection (2):
...
### 662 Definitions
In section 120C(1), the definition of tax paid is replaced by the following:.
...
(1) Section 120EA is repealed.
(2) Subsection (1) applies––
  (a) on and after 1 July 2010, unless paragraph (b) applies:
  (b) for an income year that includes 1 July 2010 and later income years, if the life insurer chooses to apply the new life insurance rules in this Act in a return of income for the tax year corresponding to the first relevant income year.

### 664 Provisional tax instalments in transitional years
(1) In section 120KD, in the example to the section, the entry Three interest start dates apply: 16 January, 29 April, and 29 June (s 120KD(2)). is replaced by Three interest start dates apply: 16 January, 8 May, and 29 June (s 120KD(2)).
(2) Subsection (1) applies for the 2008–09 and later income years.

### 665 Where provisional tax paid by company does not count as overpaid tax
In section 120M(a), but for that section is replaced by but for those sections.

### 666 Variation to definition of date interest starts
(1) Section 120O(e) is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 667 Interest paid on deposits in tax pooling accounts
Section 120OE(1), is replaced by the following:
...
(1) Section 120R is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 669 Certain rights of objection not conferred
Section 125(d) is replaced by the following:.
...
In section 138E(1)(e)(iv), 34B, is inserted in the list of sections.

### 671 Non-electronic filing penalty
(1) In section 139AA(1)(a), RD 23(2) is replaced by RD 22(2).
(2) Subsection (1) applies for tax on income derived in the 2008–09 and later income years.

### 672 Late payment penalty
(1) After section 139B(5A), the following is inserted:
...
(2) Section 139B(6)(c) is replaced by the following:
...
(1) Section 139BA(3)(b) is replaced by the following:
...
(1) In section 140B(1), section OB 65 is replaced by section OB 65 or OC 30.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 675 Imputation penalty tax payable in some circumstances
(1) In section 140BB, the section heading is replaced by Transitional imputation penalty tax payable in some circumstances.
(2) In section 140BB(1), as only having–– is replaced by as having only the balances and adjustments referred to in subsections (1B) and (1C)..
(3) Section 140BB(1)(a) and (b) are repealed.
(4) After section 140BB(1), the following is inserted:
...
(5) After section 140BB(3), the following is added:
...
(1) Section 140C is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 677 FDP penalty tax payable in some circumstances
(1) In section 140CA, the section heading is replaced by Transitional FDP penalty tax payable in some circumstances.
(2) In section 140CA(1), as only having–– is replaced by as having only the balances and adjustments referred to in subsections (1B) and (1C).
(3) Section 140CA(1)(a) and (b) are repealed.
(4) After section 140CA(1), the following is inserted:
...
(5) After section 140CA(3), the following is added:
...
(1) Section 140CA is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 679 Tax shortfalls
(1) Section 141(7)(c) is replaced by the following:.
  (c) the 2 taxpayers are associated persons,—
(2) In section 141(7D), of this Act is omitted.

### 680 Unacceptable tax position
(1) In section 141B(8), subsection (2)(b) is replaced by subsection (2).
(2) Subsection (1) applies for a tax position taken on or after 1 April 2008.

### 681 Abusive tax position
Section 141D(3B)(b) is replaced by the following:.
...
Section 141E(1)(c) is replaced by the following:.
...
(1) After section 141ED(3)(a), the following is inserted:.
...
(2) After section 141ED(5), the following is inserted:
...
After section 142A(3)(a), the following is inserted:.
...
(1) The heading to section 142E is replaced by Due dates for payment of imputation penalty tax.
(2) Section 142E(2) is repealed.
(3) Subsections (1) and (2) apply for all income years beginning on or after 1 July 2009.

### 687 Knowledge offences
(1) Section 143A(3) and (6) are repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 688 Evasion or similar offence
(1) Section 143B(3) is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 689 Recovery of civil penalties
Section 156A(1)(a) and (b) are replaced by the following:
...
(1) In section 173D, the following is added as subsection (2):
...
(1) After section 173L(2)(b), the following is inserted:.
...
(2) Section 173L(3) is replaced by the following:
...
In section 177D(3), qualifying event, as defined by section OB 1 of the Income Tax Act 1994 is replaced by emergency event, as declared by the Governor-General by Order in Council under section 183ABA.

### 695 Section 181 repealed
(1) Section 181 is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.
...
(1) Section 183A(1)(e) is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 698 Section 183ABA replaced
Section 183ABA is replaced by the following:Remission in circumstances of emergency event
...
Section 183F(1) is replaced by the following:
...
(1) Section 183H(a)(ii) is repealed.
(2) Subsection (1) applies for all income years beginning on or after 1 July 2009.

### 701 Payments into, and out of, Listed PAYE Intermediary Bank Account
Section 185D(1) is replaced by the following:
...
(1) In section 225A(2)(b)(iii), under that Act is omitted.
(2) In section 225A(2)(b)(iv), under that Act is omitted.
...
(2) The definition of emissions unit is replaced by the following:.
  - **emissions unit** means a unit as defined in section 4(1) of the Climate Change Response Act 2002
(3) After the definition of local authority, the following is inserted:.
...
(4) The definition of New Zealand unit is repealed.
(5) In the definition of public authority and includes offices of Parliament; is replaced by and includes offices of Parliament, the Parliamentary Service, and the Office of the Clerk of the House of Representatives;.

### 705 Meaning of term supply
Section 5(14) is replaced by the following:
...
In section 5B, sections 8(1), 15, 15A is replaced by sections 8(1), 15A to 15E.

### 707 Time of supply
After section 9(8), the following is added:
...
In section 10(4), section 11(3) is replaced by section 11(3) or (3C).

### 709 Zero-rating of goods
After section 11(3), the following is inserted:
...
(2) Section 11A(1)(v) is replaced by the following:
...
(3) In section 11A(1)(v), price. is replaced by price; or and the following is added:
...
After section 11B, the following is inserted:Treatment of supplies by operators of loyalty programmes
...
In section 21I(5), section CW 17 or CW 18 is replaced by section CW 17, CW 17B, CW 17C, or CW 18.

### 713 Group of companies
In section 55(1)(a)(iii), portfolio tax rate entity is replaced by multi-rate PIE.
...
(2) In the definition of Crown contribution, in paragraph (b),––
  (a) section KJ 1 of the Income Tax Act 2004 is replaced by section MK 1 of the Income Tax Act 2007:
  (b) section KJ 5(2) is replaced by section MK 5.
(3) In the definition of PAYE period, in paragraph (a) of the definition of payment period in section MK 10 is replaced by payment period as defined in section MK 10(3).
(4) The definition of PAYE period is replaced by the following:.
...
In section 14(1)(d), section OE 1(5) of the Income Tax Act 2004 is replaced by section YD 1(7) of the Income Tax Act 2007.

### 718 Eligibility to be exempt employer
Section 25(1)(b) is replaced by the following:.
...
In section 57(1)(d), paragraph (h) of the definition of complying fund rules in section OB 1 of the Income Tax Act 2004 is replaced by clauses 4(a) and 5(a) in schedule 28 of the Income Tax Act 2007.

### 720 What happens when initial back-dated validation ends, with no confirmed back-dated validation?
In section 59D(4), paragraph is replaced by subsection (3).
...
### 722 Interest rate
In section 86(1), in the item lowest tax rate, column 2 is replaced by column 3.

### 723 How and when interest is paid on refunds
Sections 89(3) and (4) are repealed.

### 724 Refunds of employer contribution by Commissioner if employee opts out
In section 100, may is replaced by must.

### 725 General
After section 101A(2), the following is inserted:
...
(1) In section 101D(5)(b)(iii)(B), ; and is replaced by ; or, and the following is inserted:.
...
(2) In section 101D(8)(b), percentage of the employee's total contributions is replaced by percentage (inclusive of amounts payable under the ESCT rules) of the employee's total contributions.

### 727 New sections 101FB and 101FC inserted
After section 101F, the following is inserted:Grace periods: employersDe minimis: other contributions and hybrid schemes amount
  ...
  For a payment of gross salary or wages to an employee, an employer does not have to pay a compulsory employer contribution for the employee, if, in respect of the payment of gross salary or wages, one of the following amounts is equal to or more than the relevant CEC rate in section 101D(4):
    ...
    (b) the hybrid schemes amount that meets the requirements of sections 101D(6) to (8) divided by the employee's salary or wages (as defined for the relevant registered superannuation scheme).

### 728 Rules: providers
(1) In section 101G(3),—
  (a) or complying superannuation fund is omitted:
  (b) or a rule the same as that clause is omitted.
(2) After section 101G(3), the following is added:
...
In section 128A(1), section KJ 1 of the Income Tax Act 2004 is replaced by section MK 1 of the Income Tax Act 2007.

### 730 Terms relating to lump sum payments by complying superannuation funds
In section 128C(1), paragraph (cc) of the definition of complying fund rules in section YA 1 of the Income Tax Act 2007 is replaced by clause 2(c) in schedule 28 of the Income Tax Act 2007.

### 731 Crown contribution
(1) In section 226(1), a contribution is replaced by 1 contribution.
(2) Section 226(4) is replaced by the following:
...
(1) In section 229(2)(i), in the words before the subparagraphs, is a fixed dollar amount, and is omitted.
(2) After section 229(2)(i), the following is inserted:.
...
(1) Schedule 1, clause 8(1) is replaced by the following:
...
(2) Schedule 1, clause 9 is replaced by the following:Withdrawal on death
...
(3) In schedule 1, clause 14(1), section KJ 1 of the Income Tax Act 2004 is replaced by section MK 1 of the Income Tax Act 2007.
(4) In schedule 1, clause 17, paragraph (a) is replaced by the following:.
  (a) before the member, the personal representative, or the relevant person under section 65 of the Administration Act 1969 (as the case may be) gives the fund provider (as defined in the Income Tax Act 2004) a statutory declaration stating, to the best of their knowledge, the periods for which the member has their principal place of residence in New Zealand; and
(5) In schedule 1, clause 17––
  (a) in the words before the paragraphs, section KJ 1 of the Income Tax Act 2004 is replaced by section MK 1 of the Income Tax Act 2007:
  (b) in paragraph (a), Income Tax Act 2004 is replaced by Income Tax Act 2007:
  (c) in paragraph (b), the number of included days under section KJ 3 of the Income Tax Act 2004 is wrong is replaced by they have got the time for which the member meets the requirements of section MK 2 of the Income Tax Act 2007 wrong.
...
(1) After section CC 8, the following is inserted:Certain commercial bills: non-resident holdersWhen this section appliesIncome: disposalIncome: redemptionDefined in this Act: amount, associated person, commercial bill, financial arrangements rules, income, non-resident, old financial arrangements rules.
...
(1) After section CD 4(2), the following is inserted:When shares are cancelled
  (2B) The market value of any transfer from the shareholder to the company on the cancellation of a share of the shareholder's rights as a shareholder is zero.
(2) In section CD 4, in the list of defined terms, market value, share, and shareholder are inserted.
(3) Subsection (1) applies for the 2005–06 and later income years.

### 737 Returns of capital: off-market share cancellations
In section CD 14(9), in the definition of non-participating redeemable share, paragraph (b)(iii), ; or is replaced by or section FC 2B(2) (Stapled debt securities); or.

### 738 Treasury stock acquisitions
(1) Section CD 17(4), other than the heading, is replaced by the following:
  (4) If subsection (2) applies, then, with effect from the cancellation or the first anniversary, depending on which first causes subsection (2) to apply, the available subscribed capital of the class of the share is reduced by the lesser of—
    (a) the amount paid to the shareholder on the acquisition; and
...
(1) In section CD 26, before paragraph (a), Amount not dividend is inserted as a subsection heading.
(2) In section CD 26(b)(iv), method; and is replaced by method., and paragraph (c) is repealed.
(3) After section CD 26(b), the following are inserted as subsections (2) and (3):Exclusion for interests in grey list companies Application of rule for certain managed funds
  (2) Subsection (1)(b)(iv) does not apply if—
    (a) the FIF is a grey list company; and
    (b) the person holds a direct income interest of 10% or more in the FIF at the beginning of the income year in which the period falls.
  (3) Subsection (2) does not apply if—
    (a) the person is a portfolio investment entity, an entity eligible to be a portfolio investment entity, or a life insurance company; and
    (b) the FIF is a foreign investment vehicle.
(4) In section CD 26, in the list of defined terms, direct income interest, foreign investment vehicle, life insurance, and portfolio investment entity are inserted.

### 740 Available subscribed capital amount
In section CD 32, in the list of defined terms, consideration is inserted.

### 741 Amounts derived in connection with employment
(1) In section CE 1, before paragraph (a), Income is inserted as a subsection heading.
(2) Section CE 1(c) is replaced by the following:.
...
Section CF 1(2)(f) and subsequent paragraphs are replaced by the following:
  (f) a payment under the Injury Prevention, Rehabilitation, and Compensation Act 2001 paid by the Corporation as defined in that Act, of weekly compensation that is not recovered or recoverable under section 248 of that Act:
  (g) a payment under section 81(1)(b) of the Injury Prevention, Rehabilitation, and Compensation Act 2001 paid by the Corporation as defined in that Act, for attendant care as defined in schedule 1, clause 12 of that Act.

### 744 New section CR 3 added
(1) After section CR 2, the following is added:Income for general insurance outstanding claims reserveWhen this section appliesFormula for insurer's OCR incomeDefinition of items in formulaDefined in this Act: amount, general insurance contract, IFRS 4, income, income year, insurer, life insurer, outstanding claims reserve.
  (1) This section applies for—
...
(1) After section CW 13(3), the following is added:Relationship with sections CW 13B and CW 13C
...
(2) After section CW 13(4), the following is added:Depreciation loss included
  (5) In this section, expenditure includes an amount of depreciation loss.
(3) In section CW 13, in the list of defined terms, depreciation loss is inserted.
...
After section CW 13, the following is inserted:Relocation paymentsExempt incomeActual expenditureTime limitMeaning of work-related relocationExemption from distance testDeterminationsDefined in this Act: amount, Commissioner, employee, employer, exempt income, tax year, work-related relocationPayments for overtime meals and certain other allowancesExempt income: overtime mealsExempt income: certain sustenance allowancesEligibility requirements: overtime mealsEligibility requirements: sustenance allowancesActual cost or reasonable estimateMeaning of overtimeDefined in this Act: amount, employee, employer, exempt income, overtime, pay.
  (1) An amount that an employer pays to or on behalf of an employee in connection with the expenses of the employee in a work-related relocation is exempt income of the employee.
  (2) The amount paid must be no more than the actual cost incurred by or on behalf of the employee on an expense that the Commissioner lists as an eligible relocation expense in a determination made under subsection (6).
  (3) Subsection (1) applies only to expenditure incurred to the end of the tax year following that in which the relocation occurs. For the purposes of this subsection, a temporary move that has not been treated as a work-related relocation under this section is ignored.
...
In section CW 33, in the list of defined terms, associated person is omitted.

### 749 Benefits provided instead of allowances
In section CX 17(1)(b), transport costs). is replaced by transport costs); or and the following is added:
...
(1) Section CX 24 is replaced by the following:AccommodationDefined in this Act: accommodation, employee, employer, employment, fringe benefit.
  The value of accommodation that an employer provides to an employee in connection with the employment or services is not a fringe benefit.
(2) Subsection (1) applies for the 2005–06 and later income years.

### 751 Government grants to businesses
(1) In section CX 41(1)(d)(i), for which they are allowed a deduction is replaced by for which they would be allowed a deduction in the absence of section DF 1 (Government grants to businesses).
(2) In section CX 41(3)(b)(ii), (Government grants to businesses) is omitted.
...
After section CX 44F, the following is inserted:Disposal of pre-1990 forest land unitsWho this section applies toExcluded income: disposalDefined in this Act: amount, excluded income, income, pre-1990 forest land, pre-1990 forest land unit, surrender.
...
After section DB 8, the following is inserted:Interest or expenditure connected to stapled debt securityNo deductionRelationship with sections DB 5 to DB 8Link with subpart DADefined in this Act: deduction, general permission, interest, pay, stapled debt security.
...
(3) In section DD 4, in the defined terms list, amount is inserted.

### 761 Interpretation: reimbursement and apportionment
In section DD 10(a), section CW 13 (Expenditure on account, and reimbursement, of employees) is replaced by sections CW 13, CW 13B, and CW 13C (which relate to expenditure and reimbursement of employees).

### 762 Forestry business on land bought from the Crown, Maori owners, or holding company: no deduction
(1) In the heading to section DP 7(3), and FZ 2 is replaced by , FC 2B, and FZ 2.
(2) In section DP 7(3), do is replaced by and section FC 2B (Stapled debt securities) do.

### 763 New section DT 1A inserted
(1) Before section DT 1, the following is inserted:Ring-fenced allocationsWhen this section appliesBasis for allocation of deductionsExcess allocations: carrying forward and re-instating next yearRestriction on reinstating excess allocationsDefined in this Act: deduction, income year, net loss, New Zealand, petroleum development expenditure, petroleum exploration expenditure, petroleum mining operation, residual expenditure.
...
(1) Section DT 2(1)(c)(ii) and (iii) are replaced by the following:
  (ii) a petroleum permit; or
  (iii) material or a permit that relates to petroleum mining operations undertaken outside New Zealand, and that material or permit are substantially the same as those described in subparagraphs (i) or (ii), with necessary modifications made to this subpart and the Crown Minerals Act 1991.
(2) After section DT 2(5), the following is inserted:Meaning of associated person
...
(1) Section DT 9(1)(b) is replaced by the following:
...
(1) After section DW 2, the following is added:Deduction for general insurance outstanding claims reserveWhen this section appliesNo deduction on account of claimsFormula for insurer's OCR deductionDefinition of items in formulaDeduction for payments of current claimsLink with subpart DADefined in this Act: amount, deduction, general insurance contract, general limitation, general permission, IFRS 4, income year, insurer, life insurer, outstanding claims reserve.
  (1) This section applies for—
    (a) an insurer who uses IFRS 4, Appendix D for general insurance contracts; and
...
### 769 Prepayments
In section EA 3(7), sections CW 13 (Expenditure on account, and reimbursement, of employees) and CW 14 (Allowance for additional transport costs) is replaced by sections CW 13, CW 13B, CW 13C, and CW 14 (which relate to expenditure, reimbursement, and allowances of employees).
...
(1) Section EE 25E(1)(b) is replaced by the following:.
...
(1) In section EE 26(2), paragraph (a) and the words in paragraph (b) before subparagraph (i) are replaced by the following:.
  (a) the item's economic rate, special rate, or provisional rate, for an item not described in either paragraph (b) or (c):
  (b) the item's economic rate, special rate, or provisional rate multiplied by 1.2, for an item that—
(2) Subsection (1) applies for the 2005–06 and later income years.

### 773 Meaning of adjusted tax value
(1) Section EE 46(1)(b) is replaced by the following:
  (b) for a pool, the total adjusted tax value determined under section EE 21.
(2) Subsection (1) applies for the 2005–06 and later income years.

### 774 Section EJ 11 replaced
(1) Section EJ 11 is replaced by the following:Petroleum development expenditure: default allocation ruleWhen this section appliesDefault allocation ruleRelationship with other petroleum mining provisionsDefined in this Act: amount, deduction, income year, permit, petroleum development expenditure, petroleum miner, petroleum mining developmentPetroleum development expenditure: reserve depletion methodWhen this section appliesChoice: first year of commercial production and later yearsReserve depletion method expense allocation ruleDefinition of items in formulaReserve expenditurePrevious expenditureReserve depletion for the yearProbable reservesRelationship with other petroleum mining provisionsDefined in this Act: amount, deduction, income year, permit area, petroleum development expenditure, petroleum miner, petroleum mining development.
  ...
  (9) Sections EJ 12 to EJ 14 override subsection (3). Sections DT 7, DT 8, DT 10, DT 11, DT 16, and IH 3 (which relate to petroleum miners) override this section.
(2) Subsection (1) applies for expenditure incurred on or after 1 April 2008.

### 775 Relinquishing petroleum permit
(1) Section EJ 12(2)(b) is replaced by the following:
...
(1) After section EJ 12, the following is inserted:Dry well drilledWhen this section appliesAllocationDefined in this Act: amount, deduction, income year, petroleum development expenditureWell not producingWhen this section appliesAllocationDefined in this Act: amount, deduction, income year, petroleum development expenditure.
  (1) This section applies when—
    (a) the petroleum miner has petroleum development expenditure for a well, the drilling of which stops in an income year, and, from the time of stopping, the well—
      (i) will never produce petroleum in commercial quantities; and
      (ii) is abandoned; and
  ...
  (1) This section applies when—
    ...
    (c) part of a deduction under section DT 5 (Petroleum development expenditure) for the petroleum development expenditure described in paragraphs (a) and (b) has not been allocated under section EJ 11B.
  (2) The part of the deduction described in subsection (1) is allocated to the income year.
(2) Subsection (1) applies for expenditure incurred on or after 1 April 2008.

### 777 Disposal of petroleum mining asset
(1) Section EJ 13(2)(b) is replaced by the following:
...
(1) Sections EJ 17 and EJ 18 are replaced by the following:Meaning of petroleum mining developmentMeaningActivities: inclusionsActivities: exclusionsDefined in this Act: permit area, petroleum, removal or restoration operations.
...
(1) After section EW 14(2)(d), the following is inserted:.
  (e) a financial reporting method, to which sections EW 21 and EW 23 are relevant; or
(2) Subsection (1) applies for the 2007–08 and later income years.

### 780 IFRS taxpayer method
(1) After section EW 15B(2), the following is inserted:Functional currencyFinancial statements
...
(2) After section EW 15B(4)(b)(ii), the following is inserted:.
  (iib) is, under NZIAS 17 and in the person's financial statements, classified as an operating lease:
(3) In section EW 15B, in the list of defined terms, NZIAS 17 is inserted.
...
### 781 IFRS method
(1) After section EW 15C(2), the following is inserted:Fair value method not used for certain financial arrangements
  (2B) A person must not use the fair value method for a financial arrangement if—
    (a) the financial arrangement is treated under IFRSs by the person as a hedge of another financial arrangement; and
    (b) the person uses a method other than the IFRS method for the other financial arrangement.
(2) Section EW 15C(3)(a) is replaced by the following:.
...
(3) After section EW 15C(3)(a), the following is inserted:.
  (ab) borrowing costs are not capitalised under NZIAS 23:
(4) In section EW 15C, in the list of defined terms, derivative instrument and NZIAS 23 are inserted.
...
(1) Section EW 15D(1)(d) is replaced by the following:
  (d) the financial arrangement––
    (i) is not treated under IFRSs by the person as a hedge; or
    (ii) is treated under IFRSs by the person as a hedge of other financial arrangements, for each of which the person does not use the fair value method.
(2) In section EW 15D(2), the words before paragraph (a) are replaced by The person must use 1 of the following methods for the financial arrangement, as modified by subsection (3) or (4):.
...
(1) Section EW 15E(1)(c) is replaced by the following:.
  (c) the financial arrangement––
    (i) is not treated under IFRSs by the person as a hedge; or
    (ii) is treated under IFRSs by the person as a hedge of other financial arrangements, for each of which the person does not use the fair value method; and
(2) Section EW 15E(1)(f) is replaced by the following:
...
(3) In section EW 15E(3), the first sentence is replaced by If the person chooses under subsection (1)(f) to use the equity-free IFRS method for the financial arrangement, the person must use a method that is the fair value method under section EW 15C.
(4) Section EW 15E(4) is repealed.
(5) In section EW 15E, in the list of defined terms, associated person is inserted.
...
(1) After section EW 20, the following is inserted:Financial reporting methodDefined in this Act: amount, Commissioner, financial arrangement, IFRS taxpayer method, income year.
  A person who is a party to a financial arrangement may use a financial reporting method if––
    (a) the person cannot use the yield to maturity method or an alternative; and
    (b) the person––
      (i) may not use the straight-line method or a market valuation method; or
...
### 785 Default method
(1) In section EW 22(c), alternative is replaced by alternative, or a financial reporting method.
(2) Subsection (1) applies for the 2007–08 and later income years.

### 786 Failure to use method for financial reporting purposes
(1) In section EW 23(1), EW 18(f), and EW 20(2)(f) is replaced by EW 18(1)(f), EW 20(2)(f), and EW 21(f).
(2) In section EW 23(2), EW 18(f), and EW 20(2)(f) is replaced by EW 18(1)(f), EW 20(2)(f), and EW 21(f).
...
(2) In section EW 26(2), the first sentence is replaced by A person may change from any spreading method to any other method if the Commissioner's written authorisation under subsection (1) is not required for the change, and they have a sound commercial reason for the change.
(3) In section EW 26(6), the first sentence is replaced by Despite subsection (3), that subsection, subsection (4), and section EW 27 do not apply to the extent to which the person's spreading method change involves, for a financial arrangement, a change from the fair value method under the IFRS method described in section EW 15C or a change from the market value method to the IFRS taxpayer method.
(4) Section EW 26(7)(a) is replaced by the following:.
...
(1) In section EW 31(7), in the words before the paragraphs,––
  (a) ignoring non-contingent fees, is omitted:
  (b) , ignoring–– is replaced by . For the purposes of this subsection, the following are ignored:.
(2) In section EW 31(9)(a), , under section CC 3 (Financial arrangements), is omitted.
...
In section EX 5(5)(c), shares) is replaced by shares) or FC 2B (Stapled debt securities).

### 791 Direct income interests
In section EX 9(6)(c), shares) is replaced by shares) or FC 2B (Stapled debt securities).

### 792 Direct income interests in FIFs
In section EX 31(6)(c), shares) is replaced by shares) or FC 2B (Stapled debt securities).

### 793 Exemptions: direct income interests in FIF in grey list country
(1) In section EX 33(4)(d), the words before subparagraph (i) are replaced by the following:.
...
(2) Section EX 33(4)(e) is replaced by the following:.
...
(3) In section EX 33, in the list of defined terms, voting interest is inserted.

### 794 Use of particular calculation methods required
Section EX 40B(b) is replaced by the following:
  (b) the deemed rate of return method, if use of the comparative value method is not practical because the person cannot determine the market value of the attributing interest at the end of the income year.

### 795 Comparative value method
Section EX 44(5), other than the heading, is replaced by the following:
...
(1) After section EX 44C(4), the following is inserted:Exclusion for certain managed funds
  (4B) Subsection (4)(c) does not apply if—
    (a) the person is a portfolio investment entity, an entity eligible to be a portfolio investment entity, or a life insurance company; and
    (b) the FIF is a foreign investment vehicle.
(2) In section EX 44C, in the list of defined terms, company, foreign investment vehicle, life insurance, and portfolio investment entity are inserted.

### 797 Fair dividend rate method: method for unit valuers and persons valuing interests daily
(1) After section EX 44D(4), the following is inserted:Exclusion for certain managed funds
  (4B) Subsection (4)(c) does not apply if—
    (a) the person is a portfolio investment entity, an entity eligible to be a portfolio investment entity, or a life insurance company; and
    (b) the FIF is a foreign investment vehicle.
(2) In section EX 44D, in the list of defined terms, company, foreign investment vehicle, life insurance, and portfolio investment entity are inserted.

### 798 Cost method
(1) In section EX 45B(4)(ac)(ii), income year; or is replaced by income year; and and the following is inserted:.
  (iii) the interest was not an attributing interest for the income year before the relevant income year; or
(2) In section EX 45B, in the list of defined terms, attributing interest is inserted.

### 799 Codes: comparative value method, deemed rate of return method, fair dividend rate method, and cost method
(1) Section EX 47(1)(c) is replaced by the following:.
  (c) the fair dividend rate method:
(2) After section EX 47(1), the following are inserted:Exclusion for interests in grey list companies Application of rule for certain managed funds
  (1B) Subsection (1)(c) does not apply if—
    (a) the FIF is a grey list company; and
    (b) the person holds a direct income interest of 10% or more in the FIF at the beginning of the income year in which the period falls.
  (1C) Subsection (1B) does not apply if—
    (a) the person is a portfolio investment entity, an entity eligible to be a portfolio investment entity, or a life insurance company; and
    (b) the FIF is a foreign investment vehicle.
(3) In section EX 47, in the list of defined terms, direct income interest, foreign investment vehicle, life insurance, and portfolio investment entity are inserted.

### 800 Measurement of cost
Section EX 56(2B) is repealed.

### 801 Transitional rule for IFRS financial reporting method
(1) In section EZ 50(1)(b), EW 18(f) is replaced by EW 18(1)(f).
(2) In section EZ 50(2), EW 18(f) is replaced by EW 18(1)(f).

### 802 New sections EZ 51 and EZ 52 added
After section EZ 50, the following is added:Transitional rule for financial reporting methodDefined in this Act: financial arrangement, IFRS, IFRS taxpayer method, income year, return of incomeTransitional rule for changes from the fair value methodDefined in this Act: financial arrangement, IFRS taxpayer method, income year, return of income, sound commercial reason.
...
(1) After section FC 2, the following is inserted:Stapled debt securitiesExclusion: small company shareholder agreementsExclusion: stapling before 25 February 2008
...
(1) In section FG 8G(1), in the formula, FRS is replaced by FRS – SDS.
(2) In section FG 8G(1), after the item FRS, the following is inserted:SDS is the financial value for the measurement day of stapled debt securities, each of which is—.
  (a) owned by a person resident in New Zealand; and
  (b) included in the value of item EQV; and
  (c) stapled to shares other than shares of a company that is a proportional-stapling company

### 808 Section GC 14EB repealed
Section GC 14EB is repealed.

### 809 Dividends from qualifying company
(1) Section HG 13(3)(a) is replaced by the following:.
  (a) the maximum imputation credit which may be attached to that dividend by virtue of section ME 8(1); and
(2) Section HG 13(4)(a) is replaced by the following:.
...
In section HK 13(1), debentures issued is replaced by debentures that are a stapled debt security to which section FC 2B applies, or to debentures issued.
...
(2) Section HL 4(2)(a) is replaced by the following:.
  ...
  (ab) the entity fails to meet a requirement under section HL 10 on the last day of a quarter—
    (i) beginning 6 months or more after the date on which the entity becomes a portfolio investment entity; and
    (ii) ending more than 3 months before an announcement by the entity to its investors that the entity is winding up within 12 months of the announcement; and
(3) Section HL 4(2)(b)(ii) is replaced by the following:
...
(1) After section HL 6(1)(i), the following is inserted:.
  (ib) Auckland Regional Holdings:
(2) In section HL 6(1)(j)(iii), entity: is replaced by entity and paragraph (k) is repealed.
(3) Section HL 6(3) is replaced by the following:No investor membership requirement for public unit trustsNo investor membership requirement for certain superannuation funds and others
  (3) There is no investor membership requirement for a portfolio investor class that, if treated as a unit trust, would meet the requirements of 1 or more of paragraphs (a) and (c) to (e) of the definition of public unit trust.
  (3B) There is no investor membership requirement for a portfolio investor class that includes an investor that is—
    ...
    (c) a superannuation fund that—
      ...
      (iii) has no investor, other than the fund's manager or trustee, that can control the investment decisions relating to that class:
    (d) a public unit trust.
(4) Section HL 6(4)(a) and (b) are replaced by the following:.
  (a) the investor is not listed in subsection (1)(b) to (ib); and
  (b) the associated person is not listed in subsection (1)(b) to (ib); and

### 813 Investor interest size requirement
(1) After section HL 9(4)(i), the following is inserted:.
  (ib) Auckland Regional Holdings:
  (ic) a portfolio investor class of less than 20 persons, treating all interests held by associated persons and included by subsection (6) as being held by 1 person, if—
    ...
    (ii) no investor in the class, other than the entity's manager or trustee, can control the investment decisions relating to that class; and
    (iii) investors for which the entity would not meet the investor membership requirement in the absence of this paragraph have portfolio investor interests with a total value of less than 10% of the total value of portfolio investor interests in the entity:
(2) In section HL 9(4)(j), subsection (5): is replaced by subsection (5) and paragraph (k) is repealed.
(3) In section HL 9(5), replace subsection (4)(a) to (i) with subsection (4)(a) to (ic).
(4) Section HL 9(6)(a) and (b) are replaced by the following: .
...
Section HL 12(1)(b) is replaced by the following:
  (b) the entity, if treated as becoming a portfolio investment entity when the election would be effective, would cease under section HL 4 to be eligible through a failure to meet 1 or more of the requirements in section HL 6, HL 9, or HL 10 in each quarter of the 12-month period.

### 817 Credits received by portfolio tax rate entity or portfolio investor proxy
In section HL 27(7), the words before paragraph (a) are replaced by the following:.
  (7) The investor is treated as receiving for the allocated credits, for the tax year corresponding to the investor's income year or, in the case of an investor having a portfolio investor exit period, for the quarter to which the portfolio investor exit period relates,—

### 818 Determination of amount of credit in certain cases
Section LB 1(1)(c) to (e) is replaced by the following:.
...
(1) Section LB 2(2) is replaced by the following:
...
(2) In section LB 2(8), from an interest in an attributing interest in a foreign investment fund is replaced by from an attributing interest in a foreign investment fund.

### 820 Credit of tax for dividend withholding payment credit in hands of shareholder
Section LD 8(1)(a) is replaced by the following:.
...
Section LE 2(13) is repealed.

### 822 Special rules for holding companies
In section LE 3(6), item T is replaced by the following:.
...
(1) After section ME 4(1)(ed), the following is inserted:.
...
(2) After section ME 4(2)(cd), the following is inserted:.
...
(2) After section MF 10(4), the following is inserted:
...
(3) Before the definition of actuary, the following is inserted:.
  - **actuarially determined** , for an amount, means a requirement that is met when an actuary has calculated the amount using relevant actuarial standards and a proper and reasonable calculation methodology
(4) In the definition of cancellation, including on the liquidation of the company is replaced by including on the liquidation of a company, and when a stapled debt security ceases to be a share.
(5) In the definition of consideration, before paragraph (a), the following is inserted:.
...
(6) In the definition of creditable membership, subparagraph (b)(i) is replaced by the following:.
...
(7) After the definition of debentures, the following is inserted:.
  - **debt security** is defined in section FC 2B(4) (Stapled debt securities)
(8) The definition of derivative instrument is replaced by the following:.
  - **derivative instrument** means a derivative as defined in NZIAS 39
(9) In the definition of employee, paragraph (b), sections CW 13 (Expenditure on account, and reimbursement, of employees) and CW 14 (Allowance for additional transport costs) is replaced by sections CW 13, CW 13B, CW 13C, and CW 14 (which relate to expenditure, reimbursement, and allowances of employees).
(10) In the definition of excluded security, shares) is replaced by shares) or FC 2B (Stapled debt securities).
(11) The definition of fair value method is replaced by the following:.
...
(12) In the definition of fixed rate share, paragraph (e), section LF 2(3) is replaced by section LF 2(3):, and the following is added:.
  ...
  (g) for the purposes of paragraph (f)(iii), the factors are––
    ...
    (ii) any security provided to the shareholder, including put or call options over the share or any amount payable determined by reference to the amount of dividend payable:
    (iii) the variability or lack of variability of the dividend payable
(13) After the definition of general insurance, the following is inserted:.
  - **general insurance contract** has the meaning given in IFRS 4
(14) After the definition of identical share, the following is inserted:.
  - **IFRS 4** means the IFRS, numbered 4, that relates to insurance contracts
(15) In the definition of income interest, in paragraph (b), EX 14 is replaced by EX 8.
(16) In the definition of market value circumstance, paragraph (a)(ii), applies is replaced by or FC 2B (Stapled debt securities) applies.
(17) After paragraph (a)(ii) of the definition of member credit contributions, the following is inserted:.
  (iib) Crown contribution (as that term is defined in the KiwiSaver Act 2006) for the person:
(18) After the definition of NZIAS 17, the following is inserted:.
  - **NZIAS 23** means New Zealand Equivalent to International Accounting Standard 23, approved by the Accounting Standards Review Board and as amended from time to time, or an equivalent standard issued in its place
(19) The definition of offshore development is repealed.
(20) The definition of onshore development is repealed.
(21) In the definition of operating lease, means is replaced by means, except in section EW 15B(4)(b)(iib) (IFRS taxpayer method),.
(22) After the definition of outstanding balance, the following is inserted:.
...
(23) After the definition of overseas pension, the following is inserted:.
  - **overtime** is defined in section CW 13C(4) (Payments for overtime meals) for the purposes of that section
(24) After the definition of petroleum mining company, the following is inserted:.
...
(25) In the definition of portfolio investor rate, in paragraph (a), 33%, if is replaced by 30%, if the investor has provided their tax file number to the Commissioner and.
(26) In the definition of prescribed investor rate, paragraph (a)(ii) is replaced by the following: .
  (ii) the person is a resident who derives income as a trustee of a trust other than a trust referred to in paragraph (c)(i) and who chooses to be subject to this paragraph for the tax year; or
(27) After the definition of property, the following is inserted:.
  - **proportional-stapling company** means a company if—
    ...
    (b) for each participating share in the company, the amount payable for the issue of its stapled debt security is the same proportion of the available subscribed capital calculated under the slice rule of the participating share as it is for each other participating share
(28) In the definition of share, paragraph (b), shares) is replaced by shares) or FC 2B (Stapled debt securities).
(29) After the definition of shareholder, the following is inserted:.
  - **shareholder agreement** , for a company,––
    ...
    (b) does not include an arrangement that is––
      ...
      (ii) the terms of a debt security:
      (iii) the terms of the company's shares
(30) After the definition of standing timber, the following is inserted:.
...
(31) After the definition of working day, the following is inserted:.
...
(1) In schedule 16, after item 16, the following is added:17pipes
(2) Subsection (1) applies for the 2005–06 and later income years.
...
Sections 847 to 854 amend the Income Tax Act 1994.

### 847 Exempt income—employee allowances and expenditure on account of employee
(1) In section CB 12(1)(b), employee. is replaced by employee; or and the following is added:
...
In section EF 1(5A), section CB 12(1) is replaced by section CB 12(1) or (1B) to (1D).
...
### 852 Definitions
(1) This section amends section OB 1.
(2) In the definition of expenditure on account of an employee, the following is added after paragraph (d):.
  (e) an amount paid under section CB 12(1B):
(3) In the definition of monetary remuneration, after paragraph (a)(iii), but does not include any employer superannuation contribution: is replaced by but does not include any employer superannuation contribution, or for the purposes of paragraph (a)(iii), any amount paid under section CB 12(1B):.
(4) After the definition of overseas company, the following is inserted:.
  - **overtime** , for a person and a day, means time worked for an employer on the day beyond the person's ordinary hours of work as set out in their employment agreement
(5) After the definition of working partner, the following is inserted:.
...
### 857 Interpretation
In section 2(2) of the Estate and Gift Duties Act 1968, after the definition of dutiable gift, the following is inserted:.
...
### 858 Interpretation
(1) In section 86F of the Stamp and Cheque Duties Act 1971, in the definition of paid or payment, paragraph (c) of the definition of pay in section YA 1 of the Income Tax Act 2007 is replaced by paragraph (d) of the definition of pay in section OB 1 of the Income Tax Act 2004.
(2) In section 86F of the Stamp and Cheque Duties Act 1971, in the definition of paid or payment, paragraph (d) of the definition of pay in section OB 1 of the Income Tax Act 2004, as inserted by subsection (1), is replaced by paragraph (a) of the definition of pay in section YA 1 of the Income Tax Act 2007.
(3) Subsection (1) applies for the 2005–06 and later income years.
(4) Subsection (2) applies for the 2008–09 and later income years.
...
(1) In section 16(3)(b) of the Taxation Review Authorities Act 1994, section 22 is replaced by section 22 or 22B.
(2) Subsection (1) applies for the 2008–09 and later income years.
...
In section 287(2) of the Taxation (Business Taxation and Remedial Matters) Act 2007, 2005–06 is replaced by 1997–98.

**Acts referring to associated person**

### 861 Consequential amendments to other Acts: associated person
The enactments listed in schedule 2 are amended in the manner indicated in the schedule.

**Companies Act 1993**

### 862 Schedule 7—Preferential claims
In schedule 7 of the Companies Act 1993, after clause 1(2)(a), the following is inserted:.
...
In the Insolvency Act 2006, after section 274(2)(a), the following is inserted:.
...
(1) In the Income Tax (Depreciation Determinations) Regulations 1993, 91AE is replaced by 91AAG in the following:
  (a) regulation 2, paragraph (a) of the definition of depreciation determination:
  (b) regulation 3(1)(c) and (2):
  (c) regulation 6(1)(a):
  (d) regulation 9(1).
(2) In the Income Tax (Depreciation Determinations) Regulations 1993, 91AJ is replaced by 91AAL in the following:
...
In the schedule of the Goods and Services Tax (Grants and Subsidies) Order 1992, clause 5,—
  (a) under the Income Tax Act 2004 is replaced by under the Income Tax Act 2007, Income Tax Act 2004,:
  (b) under subpart KJ of the Income Tax Act 2004 is replaced by under subpart MK of the Income Tax Act 2007 or subpart KJ of the Income Tax Act 2004.

**KiwiSaver Regulations 2006**

### 866 KiwiSaver Regulations 2006 amended
Sections 628 and 629 amend the KiwiSaver Regulations 2006.

### 867 What member of KiwiSaver scheme must do next to participate in mortgage diversion facility
Regulation 26(a) is replaced by the following:.
...
In regulation 27(b), section 229(2)(i) is replaced by section 229(2)(i) and (ia).

## Schedule 1 — Consequential amendments to lists of defined terms: associated person

| Section reference in Income Tax Act 2007 | Term to be omitted from list |
| --- | --- |
| CD 44 Available capital distribution amount | related person |
| CW 12 Proceeds of share disposal by qualifying foreign equity investor | 1990 version provisions |
| EW 43 Consideration when debt sold at discount to associate of debtor | 1988 version provisions |
| EW 49 Income and deduction when debt sold at discount to associate of debtor | 1988 version provisions |
| EX 1 Meaning of controlled foreign company | control |
| EX 7 Indirect control interests | control |
| EX 21 Branch equivalent income or loss: calculation | 1973 version provisions, 1988 version provisions, 1990 version provisions |
| FA 3 Recharacterisation of certain dividends: recovery of cost of shares held on revenue account | control |
| FE 1 What this subpart does | control |
| FE 2 When this subpart applies | control |
| FE 9 Elections | control |
| FE 12 Calculation of debt percentages | control |
| FE 21 Banking group's New Zealand net equity | 1973 version provisions, 1988 version provisions, 1990 version provisions |
| FE 25 New Zealand group for excess debt entity that is a company | control |
| FE 26 Identifying New Zealand parent | control |
| FE 27 Establishing companies under parent's control | control |
| FE 28 Identifying members of New Zealand group | control |
| FE 30 Ownership interests in companies outside New Zealand group | control |
| FE 35 Persons who may be excluded from banking groups | control |
| FE 39 Direct ownership interests | control |
| GB 28 Interpretation of terms used in section GB 27 | 1973 version provisions, 1988 version provisions, 1990 version provisions |
| GB 48 Defined terms for sections GB 45 and GB 46 | 1973 version provisions, 1988 version provisions, 1990 version provisions |
| HC 15 Taxable distributions from non-complying and foreign trusts | 1973 version provisions, 1988 version provisions, 1990 version provisions |
| HD 6 When relationship effectively that of principal and agent | control |
| HD 19 Persons receiving absentees' income | control |
| HL 6 Investor membership requirement | 1988 version provisions |
| RF 11 Dividends paid to companies under control of non-residents | control |
