...
(2) Any provisions of this Act that have not earlier been brought into force come into force on the second anniversary of the day on which this Act receives the Royal assent.

### 3 Principal Act
This Act amends the Forests Act 1949 (the principal Act).
...
(2) In section 2(1), definition of registered, after paragraph (b), insert:
  (c) in Part 2A, registered as a log trader or forestry adviser under Part 2A

### 5 New sections 2A and 2B inserted
After section 2, insert:Transitional, savings, and related provisionsParts of this Act that bind the Crown
...
(1) In section 13, delete or to an Authority under section 71A.
(2) In section 13, insert as subsection (2):
...
After Part 2, insert:Regulation of log traders and forestry advisersPurpose of this PartRegistration and related mattersForestry AuthorityForestry AuthorityFunctionsFunctions or powers may be delegated outside Public ServiceOversight of functions and powers delegated outside Public ServiceDecision making must comply with natural justicePower to obtain information from registered personsLog trader registrationLog traders must be registeredMeaning of log traderEntitlement to be registered log traderObligations of registered log traderForestry adviser registrationForestry advisers must be registeredMeaning of forestry adviser serviceEntitlement to be registered forestry adviserObligations of registered forestry adviserApplications for registrationApplication for registrationDecision on application for registrationRenewal of registrationRegistrations expire unless renewedApplication for renewal of registrationDecision on application for renewal of registrationRegistration conditionsConditions of registrationMeasures to address unsatisfactory conduct or misconductMeasures to address unsatisfactory conduct or misconductNotice requiring log trader to address unsatisfactory conductSuspension and revocation of registrationSuspension of registration for misconductRevocation of registrationReview of decisionsRight of review of certain decisions of Forestry AuthorityWho reviews decisionHow review is conductedAppeal to courtAppeal to High CourtTime for appeal to High CourtHigh Court may make interim orderDetermination of appealAppeal to Court of Appeal on question of lawTime for appeal to Court of AppealComplaints and dispute resolutionComplaints about unsatisfactory conduct or misconductDisputes about commercial mattersOffences and penaltiesOffencesPenaltiesForestry registersMeaning of forestry registerRegister of log tradersRegister of forestry advisersForm of forestry registersAccess to forestry registersObligation to notify Forestry Authority of changesCost recoveryObligation to recover costs1949 No 19 s 67ZH(1)Principles of cost recovery1949 No 19 s 67ZH(2), (5)Requirement for consultation1949 No 19 s 67ZH(3), (4)Methods of cost recovery1949 No 19 s 67ZICost recovery to relate generally to financial year1949 No 19 s 67ZJMinister may review levels and methods of cost recovery1949 No 19 s 67ZKTrust accounts required to be kept by persons collecting levies1949 No 19 s 67ZOFees, levies, and charges payable are debt due to the Crown1949 No 19 s 67ZQServices may be withdrawn until debt paid1949 No 19 s 67ZR; 1997 No 100 s 16Obligation to pay fee, levy, charge, or penalty not suspended by dispute1949 No 19 s 67ZSRegulationsRequirements before making regulationsRegulations may subdelegate power to make rulesRegulations: registrationRegulations: complaintsRegulations: disputesRegulations: fees and chargesRegulations: leviesLevies regulations are confirmable instrumentsRules and exemptionsRequirements before making rules and exemptionsRules: forestry practice standardsRules: code of ethicsExemptions from registration requirements
...
### 9 Section 72A amended (Remuneration and expenses)
In section 72A,—
  (a) delete to the members of any Authority constituted under section 71A or; and
  (b) delete authority or.

## Part 2 — Transitional schedule inserted in principal Act
...
### 11 Consequential amendments to Climate Change Response (Emissions Trading Reform) Amendment Act 2020
(1) This section amends the Climate Change Response (Emissions Trading Reform) Amendment Act 2020.
(2) In Schedule 6 (which amends the Forests Act 1949), repeal the item that inserts new section 2A.
(3) In Schedule 6, replace the item that inserts new Schedule 1AA with:In Schedule 1AA, after clause 3, insert the Part 2 set out in Schedule 7 of this Act.
(4) In Schedule 7 (which amends the Forests Act 1949), in the schedule heading, replace New Schedule 1AA inserted in with New Part inserted into Schedule 1AA of.
(5) In Schedule 7, new Schedule 1AA, replace the Schedule 1AA heading and Part 1 heading with:Provisions relating to Climate Change Response (Emissions Trading Reform) Amendment Act 2020
(6) In Schedule 7, new Schedule 1AA, renumber clauses 1 and 2 as clauses 4 and 5.
...
### 1 Interpretation
In this Part,—
  - **amendment Act** means the Forests (Regulation of Log Traders and Forestry Advisers) Amendment Act 2020
...
(1) The new provisions do not apply (and the old provisions continue to apply) in relation to the following:
  (a) a transaction or transfer described in section 63I(1) that is agreed to before the commencement date of that section:
  (b) an agreement to provide a forestry adviser service, in a particular case, that is made before that commencement date.
(2) It does not matter whether the transaction or transfer occurs, or the advice is provided, before, on, or after that commencement date.
(3) To avoid doubt, the reference in subclause (1)﻿(b) to an agreement does not include a contract of employment to provide forestry adviser services generally.
