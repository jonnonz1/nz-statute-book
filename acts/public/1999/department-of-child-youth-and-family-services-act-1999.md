...
In this Act, unless the context otherwise requires,—
  ...
  - **designated successor** means,—
    ...
    (c) in relation to a person specified in paragraph (c) of the definition of the term designated party, an appropriate Social Worker employed by the responsible department
  - **designated unit** means any of the following units of the Department of Social Welfare:
    (a) the Children, Young Persons and Their Families Agency:
...
## Part 2 — Transfer of obligations and functions, and other matters
