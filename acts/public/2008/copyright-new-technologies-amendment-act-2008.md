...
Section 3 is repealed and the following section substituted:Associated definitions for communication works
...
Section 20 is repealed and the following section substituted:Qualification by reference to origin of communication work
...
Section 24 is repealed and the following section substituted:Duration of copyright in communication works
...
Section 33 is repealed and the following section substituted:Infringement by communicating to public
...
Section 41 is repealed and the following section substituted:Incidental copying of copyright work
...
The following section is inserted after section 43:Transient reproduction of work
...
The following section is inserted after section 44:Storing copies for educational purposes
...
Section 48 is repealed and the following section substituted:Copying and communication of communication work for educational purposes
...
The following sections are inserted after section 56:Library or archive may communicate digital copy to authenticated usersAdditional conditions for supply of copy of work in digital format by librarian or archivist under section 51, 52, or 56Additional condition for making digital copies under section 53 or 54
...
The following sections are inserted after section 80:Decompilation of computer programCopying or adapting computer program if necessary for lawful useObserving, studying, or testing of computer programCertain contractual terms relating to use of computer programs have no effect
...
The following section is inserted after section 81:Copying sound recording for personal use
...
Sections 82 to 84, and the heading immediately above section 82 are repealed and the following heading and sections substituted:Communication worksRecording for purposes of maintaining standards in programmesRecording for purposes of complainingRecording for purposes of time shiftingExampleA records a movie to be screened on television because she will be at work when it screens. She watches the movie on the weekend and then later tapes over it. Provided the conditions in s 84(1) are met, the copy that A makes is not an infringing copy.B copies music from a streamed Internet audio service and keeps the copy as part of B’s music collection, in order to listen to it multiple times on demand. Copies made for the home library or collection in this way are infringing copies.
...
Section 89 is repealed and the following section substituted:Provision of subtitled copies of communication work
...
The following heading and sections are inserted after section 92:Internet service provider liabilityInternet service provider must have policy for terminating accounts of repeat infringersInternet service provider liability if user infringes copyrightInternet service provider liability for storing infringing materialRequirements for notice of infringementInternet service provider does not infringe copyright by caching infringing material
...
(2) Section 105(3)(a) is amended by omitting broadcast or cable programme and substituting or communication work.

### 63 New sections 112 to 112B substituted
The principal Act is amended by repealing section 112 and substituting the following sections:Warranty implied in certain licencesDamages for falsely claiming copyright ownership or licenceProvisions of sections 112 and 112A to have effect no matter what licence says
...
The principal Act is amended by repealing section 163 and substituting the following section:Licences for educational establishments in respect of works included in communication works
...
Section 172 is repealed and the following section substituted:Infringement by use of recording made without performer’s consent
...
The following section is inserted after section 175:Transient reproduction of recording of performance
...
Section 187 is repealed and the following section substituted:Incidental recording for purposes of communication work
...
Section 190 is repealed and the following section substituted:Provision of subtitled copies of communication work
...
Section 191 is repealed and the following section substituted:Recording of communication work for archival purposes
...
Section 226 and the heading immediately above section 226 are repealed and the following heading and sections substituted:Technological protection measuresDefinitions of TPM termsProhibited conduct in relation to technological protection measureRights of issuer of TPM workOffence of contravening section 226AWhen rights of issuer of TPM work do not applyUser’s options if prevented from exercising permitted act by TPMCopyright management informationMeaning of copyright management informationInterference with CMI prohibitedCommercial dealing in work subject to CMI interferenceContravention of section 226G or 226HOffence of dealing in work subject to CMI interference
