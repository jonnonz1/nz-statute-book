...
The following section is inserted after section 1:Purpose
...
Section 16 is repealed and the following section substituted:Dealing in foreign exchange by Bank
...
### 9 New section 33 substituted
Section 33 is repealed and the following section substituted:Policy advice
...
### 16 Further matters that may be prescribed
(1) Section 81AA(2) is amended by adding the following paragraph:
...
(2) Section 81AA is amended by adding the following subsection:
...
The following Part is inserted after section 156ZE:Deposit takersPreliminary provisionsExercise of powers under this PartInterpretationDeposit taker definedApplication of PartBank to consult before recommending making of regulations under this PartPrinciples to be taken into account under this PartExemptions from PartEffect of exemptionCredit ratingsDeposit taker must have current credit ratingBank may approve rating agenciesRegulations relating to credit ratingsGovernance requirementsGovernance requirementsRisk managementDeposit taker must have and comply with risk management programmeRisk management programme must be provided to trustee and must be amended if required by trusteeTrustee may require deposit taker to have risk management programme auditedMinimum capital requirementRegulations may impose requirement that trust deed sets out minimum capital that deposit taker is required to maintainDeposit takers and trustees must ensure trust deed sets out minimum capital deposit taker is required to maintainDeposit taker must maintain not less than minimum capital prescribedCapital ratio requirementRegulations may impose requirement that trust deed includes capital ratioDeposit takers and trustees must ensure capital ratio included in trust deedDeposit taker must maintain capital ratio required to be included in trust deedRestrictions on related party exposuresRegulations may impose requirement that trust deed includes maximum limit on exposures to related partiesRegulations may incorporate by reference framework for calculation of maximum limit on exposures to related partiesDeposit takers and trustees must ensure maximum limit on exposures to related parties is included in trust deedDeposit taker must not exceed maximum limit on related party exposuresLiquidity requirementsRegulations may impose requirement that liquidity requirements be included in trust deedDeposit takers and trustees must ensure liquidity requirements are included in trust deedsDeposit takers must comply with liquidity requirements in trust deedsOther matters relating to trust deedsAmendment to trust deed must be treated as if authorised to be madeTrustee may execute amendment to trust deedObligations of trustees to BankBank may require trustee to attest as to deposit taker’s compliance with requirementsTrustee must report to Bank non-compliance or likely non-compliance by deposit takerObligation on trustees to disclose information to Bank in certain circumstancesProtection of trusteesInvestigation and enforcement powers of BankBank may require report relating to deposit takerPower to obtain information and documentsLimitation on information to be providedLimitations on entering and searching placeSearch warrant may be issuedPrivilegesConfidentiality of informationConfidentiality of informationPerson who does not comply with section 157ZO commits offenceApplication of Official Information Act 1982, etcOffences and penaltiesOffences by deposit takers against this PartOther offences by deposit takers against this PartDefence for deposit takers charged with offences against this PartPower of court to discharge deposit takerLiability of directorsOffences by trustees against this PartPenalties for offencesMiscellaneousMatters relating to regulation-making powers under this PartBank must review and report on operation of this Part
...
### 18 Section 158 repealed
Section 158 is repealed.

### 19 Funding agreements
Section 159(1) is amended by inserting the following paragraph after paragraph (d):
  (da) Part 5D:

### 20 New section 162 substituted
Section 162 is repealed and the following section substituted:Determination of annual dividend
...
(2) Section 162B(1) is amended by adding the following paragraphs:
...
### 25 Process for providing statement of intent to Minister
Section 162C is amended by adding the following subsection as subsection (2):
...
The following heading and section are inserted above section 166:Financial stability reportsFinancial stability reports
...
### 29 New heading inserted
The following heading is inserted above section 166: Audits.

### 30 New Schedules 3 and 4 added
...
If it is not possible for the person charged with executing the warrant to have it in his or her possession at the time of execution, one of the following documents (which is deemed for all legal purposes to constitute the warrant) may be executed:
