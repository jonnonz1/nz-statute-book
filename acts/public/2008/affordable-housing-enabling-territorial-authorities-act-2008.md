...
In this Act, unless the context requires another meaning,—
  ...
  - **affordable housing policy** means a policy that—
    (a) covers the matters described in sections 9 to 15; and
...
(7) In resolving the conflict, the court must take into account—
  (a) the following provisions of the Resource Management Act 1991:
    (i) Part 2 (Purpose and principles):
    (ii) section 74 (Matters to be considered by territorial authority):
  (b) the following sections of the Local Government Act 2002:
    (i) section 10 (Purpose of local government):
    (ii) section 14 (Principles relating to local authorities):
    (iii) sections 76 to 81 (which are about decision-making).
...
(2) Schedule 10 is amended by inserting the following clause after clause 7:Affordable housing policy
