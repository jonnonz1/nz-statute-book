...
### 2 Commencement
(1) Part 1 comes into force as follows:
  (a) on a date set by Order in Council; but
  (b) on 1 July 2025, if it has not come into force by then.
...
## Part 1 — Amendments relating to land information memoranda
...
### 6 Cross-heading above section 44A replaced
Replace the cross-heading above section 44A with:Land information memoranda

### 7 Section 44A amended (Land information memorandum)
Replace section 44A(2)﻿(a) with:
...
### 9 Section 55 amended (Regulations)
...
In Schedule 1, Part 1, item relating to territorial authorities, delete within the meaning of the Local Government Act 2002.

## Part 2 — Amendments relating to official information

### 11 Section 6 amended (Conclusive reasons for withholding official information)
(1) In section 6, renumber paragraphs (a) and (b) as paragraphs (c) and (d).
(2) Before section 6(c), insert:
...
(3) In section 6, replace the compare note with:1982 No 156 s 6(a)–(d)

### 12 Section 7 amended (Other reasons for withholding official information)
In section 7(2)﻿(f)﻿(i), delete , or any persons to whom section 2(5) applies,.

### 13 Section 31 replaced (Disclosure of certain information not to be recommended)
Replace section 31 with:Disclosure of certain information not to be recommended1982 No 156 s 31
