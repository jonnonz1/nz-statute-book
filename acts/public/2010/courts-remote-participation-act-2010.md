...
In this Act, unless the context otherwise requires,—
  - **audio-visual link** , or , in relation to a participant's appearance at any proceeding, means facilities that enable both audio and visual communication between participants, when some or all of them are not physically present at the place of hearing for all or part of the proceeding
...
## Part 2 — Use of audio-visual links in proceedings
