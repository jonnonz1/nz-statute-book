...
(9) Sections 5, 10, 11, 17, 25, 26, 27, 30, 31, 36, 37, 38, 42, 52, 53, 54, 55, 57, 58, 59, 60, 61, 62, 63, 64, 65, 75, 81, 82, 83, 84, 86, 87, 89, 90, 92, 95, 97, 98, 99, 100, 105, 106, 107, 108, 112, 116, 117(2), (4), (5), (8), (10), (23), (28), and (33), 118, 119, 121(1), (2), and (4), 127, 128, 130(1) to (3), 136, 138, 145, 195(5), and 211(2) and (4) are treated as coming into force on 1 April 2008.
...
Sections 5 to 124 amend the Income Tax Act 2007.

### 5 Amounts derived by mutual associations
(1) Section CB 33(2) is replaced by the following:Income: other income provisions
...
(1) After section CB 36(4), the following is inserted:Surrender of unit: under forest sink covenant
...
(2) Section CB 36(6) is replaced by the following:Surrender of post-1989 forest land emissions unit or forest sink emissions unit: for other purposes
...
(4) After section CB 36(9), the following is added:Excluded income: fishing quota emissions unit
...
Section CD 34 is repealed.

### 9 New section CD 34B inserted
Before section CD 35, the following is inserted:Distributions to members of co-operative companiesWhat this section applies toGeneral rule: co-operative company distributions not dividendsException: distributions for excess shareholdingsRequirementsMeaning of transaction sharesMeaning of limited non-transaction sharesMeaning of projected transactions shareholdingMeaning of trading transactionsCompanies Act 1993Commissioner, company, co-operative company, dividend, limited non-transaction shares, projected transaction shareholding, resident in New Zealand, share, trading stock, trading transactions, transaction shares.
...
Subpart CS is repealed.

### 13 New section CW 29B inserted
After section CW 29, the following is inserted:Amounts from Australian complying superannuation schemes reinvested in KiwiSaver schemesamount, Australian complying superannuation scheme, exempt income, income, income year, KiwiSaver scheme.
...
Section CW 57(1)(b) is replaced by the following:
...
(1) Section CX 10(2)(c) is repealed.
(2) In section CX 10, in the list of defined terms, superannuation fund is omitted.
...
After section CX 51B, the following is inserted:Disposal of fishing quota emissions unitsWho this section applies toExcluded income: disposalamount, emissions unit, excluded income, exempt income, fishing quota emissions unit.
...
Section DB 61 is replaced by the following:Surrender of certain emissions units for post-1989 forest land emissionsWhen this section appliesTreated as disposal and reacquisitionamount, emissions unit, fishing quota emissions unit, pre-1990 forest land emissions unit, surrender.
...
(1) After section EE 60(3), the following is inserted:Treatment of mothballed assets
...
After section EW 26(7), the following is added:Modification
...
After section EW 27(8), the following is added:Modification
...
In section EW 31(8), EW 48 is replaced by EW 48, or EZ 52D.
...
In section EX 21D(7), item attributable is replaced by item attributable.
...
(3) Section EY 5(6) and (7) are replaced by the following:Part-year calculations: end of transitional adjustments
...
(1) After section EY 30(1), the following is inserted:Separation of products into separate policies for purposes of transitional adjustment
...
(8) After section EY 30(5), the following is inserted:When this section does not apply: life insurance cover increase for whole cover review periodWhen this section does not apply: continuity
...
(14) Section EY 30(14) is replaced by the following:Meaning of multiple life policy
...
After section EZ 52B, the following is inserted:Change of spreading method: Determination G22 to Determination G22AHow and when this section appliesSpreading method adjustmentPart years under Determinations instead of spreading method adjustmentamount, assessment, financial arrangement, spreading methodBase price adjustment: financial arrangements to which Determination G22 and Determination G22A appliedHow and when this section appliesConsideration adjustmentIssuerHolderCalculationDefinition of items in formulaamount, consideration, financial arrangement.
...
(1) Section GC 1 is replaced by the following:Disposals of trading stock at below market valueWhen this section appliesMarket value considerationMarket value expenditureShares in trading stockExclusionsamount, associated person, business, relationship agreement, self-assessed adverse event, share, share-lending arrangement, share supplier, share user, trading stock.
...
After section GC 3, the following is inserted:Disposals of emissions unitsWhen section GC 1 appliesExclusionsdisposal, emissions unit, trading stock.
...
(1) After section HA 11, the following is inserted:When requirements no longer met: LAQCsWhen status lostRegaining statuscompany, income year, LAQC, qualifying company.
...
(1) Section HA 24(5) is replaced by the following:Treatment of losses incurred before company has LAQC statusUsing pre-LAQC loss balanceContinuity requirements and ordering rules
...
(1) Section HL 4(2) is replaced by the following:Failure to meet other requirementsParticular circumstances
...
(2) After section HL 32(3), the following is added:Investment types
...
(1) Section HM 37(3) is repealed.
(2) In section HM 37, in the list of defined terms, investor interest is omitted.

### 69 New section HM 42B
After section HM 42, the following is inserted:Part-year tax calculations for PIEs under the exit calculation option for the 2010–11 tax yearWhen this section appliesPart-year tax calculations: descriptionPart-year tax calculations: effectForeign tax credits: special rulededuction, income, income tax liability, income year, notified investor rate, PIE, tax credit, tax year.
...
(1) In section HM 58(1), 21% is replaced by 19.5%, 21%.
(2) In section HM 58(2)(b), 21% is replaced by 19.5% or 21%.
...
(2) After section HM 60(3), the following is inserted:Exception
...
(2) After section HM 65(3), the following is added:Investment types
...
After section HR 9, the following is inserted:Bankruptcy-remote property during application of section HR 9dispose, financial institution, financial institution special purpose vehicle, income tax, provisional tax, tax.
...
(1) Section IC 3(3) and (4) are replaced by the following:Measuring common voting interestsMeasuring common market value interestsCommon interest percentages
...
(2) Section IC 12(2) is replaced by the following:Limitation on loss grouping
...
(2) The formula in section LP 10(1) is replaced by the following:company's income −total credits + supplementary dividendstax rate.
...
In section OB 16(1), 42.86 is replaced by 38.89.
...
(1) After section OB 71(1), the following is inserted:Sources of liability
...
(3) Section OB 71(4) is replaced by the following:Liability arising from excess entitlement
...
(2) Section OB 72(5), other than the heading, is replaced by the following:Possible liability under section OB 72B
...
After section OB 72, the following is inserted:Limit on using entitlement to refund after joining wholly-owned groupWhen this section appliesRestricted refund amount for company and new groupDefinition of items in formulaPayment to CommissionerUse of restricted refund amountRestriction additional to other requirementsReducing restricted refund amountLiability for imputation additional tax Commissioner, common voting interest, company, dividend, ICA company, imputation additional tax, imputation credit, income tax, provisional tax, tax pooling account, wholly-owned group of companies.
...
(1) After section OE 11, the following is inserted:Treatment of debits from conduit relief Company with debit balance, including debits from conduit relief, in some income yearsWhen this section appliesUse of CTR-relief amountDetermination of CTR-relief amountattributed CFC income, BETA company, branch equivalent tax account, branch equivalent tax credit, branch equivalent tax debit, Commissioner, company, FDP, foreign dividend, income tax liability, income year.
...
The heading before section OE 16B and section OE 16B are repealed.
...
(1) After section OP 104, the following is inserted:Treatment by consolidated BETA groups of BETA debits from conduit reliefConsolidated BETA group with debit balance, including debits from conduit relief, in certain income yearsWhen this section appliesUse of CTR-relief amountDetermination of CTR-relief amountattributed CFC income, branch equivalent tax account, branch equivalent tax credit, branch equivalent tax debit, Commissioner, company, consolidated BETA group, FDP, foreign dividend, income tax liability, income year.
...
The heading before section OP 108B and section OP 108B are repealed.

### 111 Tax credits for non-resident investors
(1) In section OZ 12(2), 24/53 is replaced by 54/119.
(2) In section OZ 12(3), 24/53 is replaced by 54/119.
...
In section RD 59(3)(b), 49% is replaced by 49.25%.

### 114 Heading and section RD 72 repealed
The heading before section RD 72 and section RD 72 are repealed.
...
(1) After section YF 1(3), the following is added:General conversion rates and calculation methods approved by CommissionerSpecific conversion rates and calculation methods approved by Commissioner
...
(1) After section YF 1, the following is added:Other rules for currency conversion: approved alternativesWhen this section appliesRepresentative ratesamount, Commissioner, New Zealand.
  (1) This section applies when—
...
(2) Schedule 1, part D, clause 4 is replaced by the following:Interest: most companies
...
Schedule 6, table 1 is replaced by the table set out in schedule 2 of this Act.
...
Sections 126 to 174 amend the Tax Administration Act 1994.
...
Section 32B is repealed.

### 133 Section 32C repealed
Section 32C is repealed.
...
After section 91EI, the following is inserted:Treatment of information
...
After section 91FJ, the following is inserted:Treatment of information
...
After section 120V, the following is inserted:Commissioner's official opinions
...
## Part 4 — Amendments to KiwiSaver Act 2006

### 175 KiwiSaver Act 2006
Sections 176 to 189 amend the KiwiSaver Act 2006.
...
In section 67(3)(a), to RD 11 is replaced by , RD 10.
...
Sections 191 to 194 amend the Goods and Services Tax Act 1985.
...
After section 78, the following is inserted:Exceptions to effect of increase of tax
...
Sections 197 to 208 amend the Income Tax Act 2004.

### 197 Foreign investment fund income
Section CD 26(1) is replaced by the following:Amount not dividend
...
(1) After section EE 51(3), the following is inserted:Treatment of mothballed assets
...
(1) Section HL 30(3)(a)(i) is replaced by the following:.
  (i) are an investment of the type listed in subsection (4); and
(2) After section HL 30(3), the following is added:Investment types
  (4) For the purposes of subsection (3)(a)(i), the investment must be—
    (a) an investment in land:
    (b) an investment in a portfolio land company that is resident in New Zealand:
    (c) an investment in a non-resident portfolio land company in which the portfolio investor class has a voting interest of more than 20%.
...
(1) In schedule 22A, after the entry for CW 15(1), the following is inserted:CW 31(3)The amounts excepted from the exemption are amounts that a public authority receives as trustee.
(2) Subsection (1) applies for the 2005–06 and later income years.
...
### 212 Waiver of fees
In the Tax Administration (Binding Rulings) Regulations 1999, regulation 6 is replaced by the following:Waiver of fees
...
In the Tax Administration (Binding Rulings) Regulations 1999, regulation 7 is replaced by the following:Goods and services tax
...
## Schedule 1 — Amendments to Income Tax Act 2007, schedule 1

| Row | Conditions |  | Payment rate |
| --- | --- | --- | --- |
| 3B | For a person who chooses the payment rate of 0.390 before 1 April 2010, the payer of the interest— |  |  |
...
| 4 | The payer of the interest has not been supplied with the tax file number of a person who is paid the interest. |  |  | 0.38 |
| How to use this table |  |  |  |  |
| Find the applicable condition, in the second column, in order to find the relevant rate to apply, in the third column. |  |  |  |  |

## Schedule 2 — Amendments to Income Tax Act 2007, schedule 6
