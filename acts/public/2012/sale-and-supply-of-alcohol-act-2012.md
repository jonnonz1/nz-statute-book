...
(3) This section is overridden by sections 45A to 45H (Rugby World Cup 2023 extended trading hours).
(3)
(3)
...
(1) In section 45A, this section, and sections 45C to 45H,—
...
(2) Permitted trading hours, and other terms defined in section 5(1), have, in section 45A, this section, and sections 45C to 45H, the same meanings given to them by section 5(1).
...
(1) Sections 45D to 45F apply to any licensed premises for which an on-licence or a club licence—
  (a) is held, and not suspended or cancelled, immediately before a night—
    (i) on or after 9 September 2023 (New Zealand standard time); and
    (ii) before or on 29 October 2023 (New Zealand daylight time); and
...
(2) However, sections 45D to 45F apply to the premises only if the licensee has given the territorial authority and the Police at least 7 days’ written notice—
  (a) that the licensee intends to televise in the premises on the night the game, all games, or any 1 or more stated games; and
  (b) of the details of a noise management plan that is, or the other arrangements for managing noise levels that are, appropriate to the locality and that the licensee is to have in place during every proposed extension under section 45D to the permitted trading hours.
...
(5) Sections 45D to 45F cease to apply to the premises if—
  (a) an application for an order under section 280 suspending or cancelling a licence is made on the grounds, expressly stated in the application, that the premises have clearly been conducted in breach, without reasonable excuse, of any of sections 45D to 45F; and
...
(7) If notice is given under subsection (6), sections 45D to 45F cease to apply.
...
(1) While the premises are open under an extension under section 45D,—
  ...
  (c) the licensee must comply with the following conditions:
    (i) open areas cannot be used for any purpose (despite section 12 of the Smokefree Environments and Regulated Products Act 1990):
    (ii) audio equipment (for example, loudspeakers, amplifiers, or audio relay equipment) cannot be used in an open area:
    (iii) bottles, or other rubbish, cannot be disposed of, or left for collection in an open area.
...
(3) Any one-way door restriction (whether imposed on the licence, or in a relevant local alcohol policy) applicable to the premises during the permitted trading hours does not operate—
  ...
  (c) within 1 hour after the premises are required under section 45D(5) to close for the sale of alcohol.
(4) Section 45D and this section—
  ...
  (b) do not affect closure of the premises under section 265 or 266, or the operation of subpart 9 of Part 2 (other enforcement provisions) in respect of the premises.
...
(6) For the purposes of subsection (1)﻿(c), open area has the same meaning as in section 2(1) of the Smokefree Environments and Regulated Products Act 1990.
...
(3) To avoid doubt, a person who fails or refuses to comply with subsection (2) commits an offence against section 259(1).
...
(1) The Police must keep records of the notices given under section 45C for research purposes.
(2) The records must—
  (a) specify the number of notices given under section 45C(2); and
  (b) specify the number of notices given under section 45C(6); and
  (c) classify the premises to which the notifications relate (including size, type, and location); and
  (d) specify, for each premises,—
    (i) the period of extended hours that have been notified (hours and times); and
    (ii) the period of time between the giving of a notice and the start of the extended hours to which the notice relates.
...
| NotesNZST means New Zealand Standard Time, and NZDT means New Zealand Daylight Time.CEST means Central European Summer Time.Pool games involving New Zealand, and playoff games, are in bold. |
| --- |
...
| Sun 24 Sep, 4.45 NZDT | Sat 23 Sep, 17.45 CEST | England v Chile |
...
| Sat 30 Sep, 8.00 NZDT | Fri 29 Sep, 21.00 CEST | New Zealand v Italy |
