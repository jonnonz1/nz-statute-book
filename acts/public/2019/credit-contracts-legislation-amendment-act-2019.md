...
(1) In section 4(d), after a defence,, insert enforceable undertakings, pecuniary penalties,.
(2) After section 4(e), insert:
  (ea) Part 5A requires creditors under consumer credit contracts and mobile traders to be certified:
(3) In section 4(f), after relating to, insert disclosure about debt collection,.
...
(2) In section 5, definition of credit fees, after paragraph (b)﻿(v), insert:
  (vi) cancellation charges as referred to in section 36F of the Fair Trading Act 1986
(3) In section 5, replace the definition of creditor with:
  - **creditor** —
...
### 7 New section 8C inserted (Status of examples)
After section 8B, insert:Status of examples
...
### 8 Section 9A amended (Outline of Part)
(1) In section 9A(2)﻿(a), replace and 96(1)﻿(aa) with 96(1)﻿(aa), 98A, 98B, and 107A.
(2) After section 9A(2)﻿(a), insert:
...
(3) In section 9A(2)﻿(d), delete , more than once,.

### 9 Section 9B amended (Interpretation)
(1) In section 9B(1), insert in their appropriate alphabetical order:
...
(2) In section 9B(1), replace the definition of relevant guarantee with:
...
### 10 Section 9C amended (Lender responsibility principles)
(1) In section 9C(3)﻿(a), after before entering into the agreement,, insert and before making a material change referred to in subsection (8),.
(2) Replace section 9C(3)﻿(b)﻿(i) with:
  (i) any advertising—
...
(3) After section 9C(3)﻿(b)﻿(iii), insert:
...
(4) After section 9C(4)﻿(b)﻿(ii), insert:
...
(5) In section 9C(5)﻿(b)﻿(i), delete distributed by the lender.
(6) After section 9C(5), insert:
...
(7) Repeal section 9C(7).
(8) After section 9C(7), insert:
...
### 11 New section 9CA inserted (Records about inquiries made)
After section 9C, insert:Records about inquiries made
...
### 12 Section 9F amended (Content of Responsible Lending Code)
(1) In section 9F(1)﻿(b)﻿(i), after agreements, insert complies with the advertising standards set in the regulations and.
(2) In section 9F(1)﻿(b)﻿(ii), after those paragraphs, insert and to comply with the regulations relating to those requirements.
(3) In section 9F(1)﻿(b)﻿(iii), replace (including where the borrower’s or guarantor’s first language is not English) with (including where the borrower or guarantor may not have a good understanding of the language in which the lender is otherwise providing information).
(4) After section 9F(1)﻿(d), insert:
...
After section 16, insert:Mobile trader credit sales treated as consumer credit contract
...
(1) In section 22(3)﻿(d), after increases, insert or decreases.
...
After section 26A, insert:Disclosure about dispute resolution schemes and financial mentoring services: hardship applications, arrears, credit declined, and complaints
...
In section 32(4), after giving, insert or making available.

### 23 Section 35 amended (How disclosure is made)
(1) Replace section 35(1)﻿(c) with:
...
(5) Replace section 35(5) and (6) with:
...
After section 41, insert:Records and reviews about how fees calculated
...
After section 45, insert:Provisions relating to debtors under high-cost consumer credit contractsPurpose, outline, and interpretationPurpose of this subpartOutline of this subpartMeaning of high-cost consumer credit contractPower to increase interest rate that defines high-cost consumer credit contractRulesCosts of borrowing must not exceed loan advanceCertain high-cost consumer credit contracts with other creditors prohibitedHigh-cost consumer credit contracts with certain repeat debtors prohibitedRate capCompound interest prohibitedDefault feesProhibition on avoidanceReview of subpartReview of subpart
...
After section 59A, insert:Duty of directors and senior managers of creditors under consumer credit contractsDuty of directors and senior managers of creditors
...
Replace section 83ZH with:Extinguishment of creditor’s security interest and subordinate security interests on sale
...
(2) In section 88(2), replace 24 to 26 with 9C(4)﻿(a) to (d), 24 to 26,.

### 31 Section 89 amended (Amount of statutory damages)
Before section 89(1)﻿(a), insert:
...
In section 92(b), replace has with had.

### 33 Section 93 amended (Court’s general power to make orders)
In section 93(a), replace or 3A with , 3A, or 5A.
...
After section 95, insert:Court may reduce effect of failure to make disclosureGuidelines for reducing effect of failure to make disclosure
...
(1) In section 96(1)﻿(a), replace and 3A with 3A, and 5A.
(2) In section 96(1)﻿(b), replace or 3A with 3A, or 5A.

### 37 New sections 98A and 98B and cross-heading inserted
After section 98, insert:Compliance and similar ordersCompliance orders2003 No 114 s 110A; 2013 No 69 s 469Order to disclose information or publish advertisement1986 No 121 s 42
...
(2) In section 100(2), after “Failure to comply with”, insert section 9C(4)﻿(a) or.

### 39 Section 102A amended (Infringement offences)
(1) In section 102A(1)﻿(a)﻿(i), after or section 19(1) requires, insert , or regulations prescribing information that must be disclosed under section 132A require,.
(2) After section 102A(4), insert:
  (4A) Every person commits an offence if the person is subject to a disclosure requirement under section 26B and the person breaches the requirement.
(3) After section 102A(7), insert:
...
(4) In section 102A(11), replace the definition of disclosure section with:
  - **disclosure section** means any of sections 17, 18, 25, 64, 70, 72, and 132A

### 40 Section 103 amended (Other offences)
(1) In section 103(1), after to 74, insert (except sections 41 and 41A, subpart 6A of Part 2, and section 59B).
(2) In section 103(1), replace and 83ZN with , 83ZN, and 132A.
(3) After section 103(5), insert:
...
In section 106(1), replace or a prosecution under section 103(1) with a prosecution under section 103(1), or proceedings for pecuniary penalties under subpart 5A.

### 42 Section 107 amended (Relevance of compliance programme)
In section 107, replace has with had.

### 43 New subpart 5A of Part 4 inserted
After section 107, insert:Pecuniary penaltiesPecuniary penalties1986 No 5 s 80Proceedings for pecuniary penalties1986 No 5 s 79ARelationship between pecuniary penalties and criminal liability1986 No 5 s 79BRestriction on indemnities1986 No 5 s 80ARestriction on insurance
...
(1) In section 108(1)﻿(a)﻿(v), delete , more than once,.
(2) After section 108(1)﻿(a)﻿(v), insert:
...
Before Part 5, insert:MiscellaneousDirectors and senior managers may also be liable for statutory damages or compensation2013 No 69 s 534
...
After section 131, insert:Certification and fit and proper person requirementsInterpretation for this PartRequirement for certificationWhen person needs to be certified2013 No 69 s 388Exemptions from need for certification2013 No 69 s 389Prohibitions on holding out that person is certified2013 No 69 s 391Issue of certificationsCommission may issue certification2013 No 69 s 394Application for certification2013 No 69 s 395When certification must be issued2013 No 69 s 396Procedural requirements2013 No 69 ss 319, 397Notice of decision2013 No 69 s 398Commission must send certification details to Registrar2013 No 69 s 401Conditions of certificationConditions of certification2013 No 69 s 402When Commission may impose conditions2013 No 69 s 403Certified person may apply for variation of conditions2013 No 69 s 404Procedure for variation of conditions2013 No 69 s 405Expiry, suspension, or cancellation of certificationsDuration of certification2013 No 69 s 407When Commission may suspend or cancel certification2013 No 69 s 408Procedural requirements on suspension or cancellation of certification2013 No 69 s 397Changes relating to certified personsDuty to notify changes2008 No 97 s 17Other provisions about certificationsAppeals against certification decisions2013 No 69 s 531Fees, charges, and costs in connection with this subpart2011 No 5 s 67(3), (4)
...
After section 132, insert:Disclosure about debt collectionApplicationDuty to make disclosureExceptionsHow it works
...
After section 137, insert:Declarations about credit contracts and consumer credit contractsClass declarations about credit contracts and consumer credit contractsDeclarations about particular arrangements or facilitiesGeneral provisions about all declarations
...
(1) After section 138(1)﻿(ab), insert:
...
(2) Replace section 138(1)﻿(da) with:
...
(3) After section 138(1)﻿(db), insert:
...
(4) After section 138(1)﻿(f), insert:
...
(5) After section 138(1)﻿(ha), insert:
...
(6) After section 138(1)﻿(ja), insert:
...
(7) In section 138(1A), replace or (ab) with to (aba).
(8) In section 138(1A)﻿(c)﻿(i), after subsection (1)﻿(a), insert or (aba).
(9) In section 138(1B), replace or (ab) with to (aba).
(10) After section 138(1B), insert:
...
(1) In Schedule 1, after paragraph (n), insert:
  (na) if the contract is a high-cost consumer credit contract, a statement to that effect:
  (nb) if the contract is a high-cost consumer credit contract or a related consumer credit contract, a statement of the effect of section 45E, which must include the maximum costs of borrowing, how the costs are calculated, and the total amount that is recoverable:ExampleOn 1 February 2023, Ms D borrows $100 from a creditor (C). By 1 March 2023, Ms D has paid $32 in interest and fees and $60 of the principal. Ms D refinances by entering into a further high-cost consumer credit contract with C to repay the remaining $40, and will receive a further advance of $160, ie, $200 in total. C includes the following in the initial disclosure statement:“The maximum costs of borrowing that you can be charged under this contract is $68. No other costs of borrowing may be charged or debited to your account.“The maximum amount is calculated as follows:your first advance under this contract or a related contract − previous interest and fees charged on related contracts“Your first advance was $100 under the contract dated 1 February 2023.“Your previous interest and fees were $32, paid under that contract.“The total amount that you can be required to pay under this contract is $268. This is the $200 advanced to you plus the $68 maximum amount.”
  (nc) if the contract is a high-cost consumer credit contract, a statement of the rate of charge under the contract, as required to be calculated in accordance with section 45H and the regulations:
(2) In Schedule 1, after paragraph (s), insert:
  (saa) if the consumer credit contract is also a layby sale agreement,—
    (i) a statement of the debtor’s cancellation rights under section 36F(1) of the Fair Trading Act 1986; and
    (ii) whether or not a cancellation charge under section 36F(3) of that Act will be imposed; and
    (iii) if a cancellation charge will be imposed, the amount of the charge (if a fixed charge will be imposed) or a clear description of how the charge will be calculated:
(3) In Schedule 1, after paragraph (ua), insert:
  (uaa) a statement that the scheme will not charge a fee to any complainant to investigate or resolve a complaint, if the consumer credit contract is a high-cost consumer credit contract or a related consumer credit contract:

## Part 2 — Amendments to other Acts and legislative instruments

### Subpart 1 — Amendments to Fair Trading Act 1986
...
### 60 Section 4 amended (Interpretation)
(1) In section 4, replace the definitions of credit contract and creditor with:
  - **credit contract** —
...
After section 67, insert:Duty to communicate information about mobile traders
...
### Subpart 3 — Amendments to legislative instruments

### 68 Amendment to Financial Service Providers (Registration) Regulations 2010
(1) This section amends the Financial Service Providers (Registration) Regulations 2010.
(2) In Schedule 2, after clause 4, insert:If the registered financial service provider is a creditor or a mobile trader,—
  (a) whether that person is a creditor under consumer credit contracts:
  (b) whether that person is certified under Part 5A of the Credit Contracts and Consumer Finance Act 2003 and, if so,—
    (i) the termination date of that certification:
    (ii) any conditions of certification:
    (iii) whether the certification is suspended:
  (c) whether an exemption from certification applies.

### 69 Amendments to Credit Contracts and Consumer Finance Regulations 2004
(1) This section amends the Credit Contracts and Consumer Finance Regulations 2004.
(2) Before the cross-heading above regulation 4A, insert:Advertisements for high-cost consumer credit contractsAdvertisements for high-cost consumer credit contracts: financial mentoring servicesAdvertisements for high-cost consumer credit contracts: risk statements
  (1) This regulation applies to the following types of advertisement for a high-cost consumer credit contract:
    (a) the home page of the creditor’s Internet site:
    (b) any pages on an Internet site to which an advertisement links other than an advertisement on that Internet site:
    (c) print advertisements (for example, in newspapers, magazines).
  (2) The advertisement must disclose in a prominent manner the information about financial mentoring services described in regulation 5A(6) (disclosure about dispute resolution and financial mentoring services).
...
(3) After regulation 5, insert:Disclosure about dispute resolution and financial mentoring servicesDisclosure about dispute resolution and financial mentoring services: hardship applications, arrears, credit declined, and complaintsWhen information needs to be providedWhat information must be provided
  (1) This regulation is for the purposes of section 26B of the Act.
  (2) The information required under section 26B(1)﻿(c) must be disclosed by the creditor as soon as practicable after the creditor receives an expression of dissatisfaction related to its services to which a response or a resolution is explicitly or implicitly expected (a complaint).
  (3) The information required under section 26B(2)﻿(a) must be disclosed in every payment reminder sent by a creditor to a borrower under a consumer credit contract.
  (4) The information required under section 26B(2)﻿(c) must be disclosed at the time when the creditor advises the person that their application for a high-cost consumer credit contract has been declined.
  (5) The following information must be disclosed about dispute resolution schemes:
    (a) the name of and contact details for the dispute resolution scheme of which the creditor is a member (unless the Financial Service Providers (Registration and Dispute Resolution) Act 2008 does not require the creditor to be a member of such a scheme):
    (b) an explanation of what that scheme provides:
    (c) that the scheme will not charge a fee to any complainant to investigate or resolve a complaint.
  (6) The following information must be disclosed about financial mentoring services:
    (a) that the person can ask for free and confidential budgeting and financial capability advice from MoneyTalks:
    (b) the contact details for MoneyTalks:
    (c) a link to MoneyTalks’ Internet site.
  (7) In this regulation, MoneyTalks means the financial capability helpline that is funded and directed by the Ministry of Social Development.
(4) After regulation 6, insert:High-cost consumer credit contractsHigh-cost consumer credit contracts for which costs of borrowing must not exceed loan advancesRate of chargeRate of charge
  For the purposes of the definition of high-cost consumer credit contract, the weighted average annual interest rate must be calculated as follows:weighted average annual interest rate = R∑n = 1 [(rn × Un) ÷ U]where—Ris the number of annual interest rates applying on a dayrnis each annual interest rateUnis the unpaid balance to which rn appliesUis the total unpaid balance.Example 1Ms C has a credit card that says that the first $1,000 was charged at an interest rate of 20%, and the rest of the unpaid balance (say, the next $2,000) was charged at an annual interest rate of 30%. R = 2r1 = 20%; r2 = 30%U1 = $1,000; U2 = $2,000U = $3,000This gives a weighted average annual interest rate that day of 26.7%. The contract is not a high-cost consumer credit contract. Example 2An interest rate of 40% applies to the first $1,000 of the unpaid balance, and another 45% applies to the entire unpaid balance of $3,000.R = 2r1 = 40%; r2 = 45%U1 = $1,000; U2 = $3,000U = $3,000This gives a weighted average annual interest rate that day of 58.3%—so it will be a high-cost consumer credit contract, even though each individual annual interest rate is below 50%.
  (1) For the purposes of section 45H of the Act, the rate of charge must be calculated as follows:where—cis the total amount of charges (as defined in section 45H(5) of the Act) that is payable under the contract ris the rate of charge (percent)Tis the number of days between the first advance under the contract and the final payment made, or anticipated to be made, under the contracttis day tUt is the unpaid daily balance on that day excluding the amount of the costs of borrowing within the meaning of section 45E of the Act that have accrued under the contract.ExampleA contract provides for a $500 loan with 200% interest pa and a $20 establishment fee with 4 weekly repayments. The contract provides for total interest and fees of $70.80 to be charged under the contract. The rate of charge calculation requires that amount to be divided by the sum of the daily balances of credit provided. In this case, that sum is $9,131.19. So the rate of charge is 0.775%.
  (2) For purposes of the definition of credit provided in section 45H(5) of the Act, the amount that must be excluded from the unpaid balance is the amount of the costs of borrowing within the meaning of section 45E of the Act that have accrued under the contract.

## Schedule 1 — Amendments to Schedule 1AA of Credit Contracts and Consumer Finance Act 2003
...
## Schedule 2 — New Part 2 of Schedule 1AA of Financial Service Providers (Registration and Dispute Resolution) Act 2008 inserted
