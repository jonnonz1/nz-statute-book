...
### 2 Commencement
(1) Section 4, in so far as it inserts new section 4(gaaa), section 13, in so far as it replaces subpart 3 of Part 4, and section 18 come into force on a date to be appointed by the Governor-General by Order in Council, and different dates may be appointed for different provisions.
(2) The rest of this Act comes into force on the 15th day after the date on which it receives the Royal assent.

### 3 Principal Act
This Act amends the Telecommunications Act 2001 (the principal Act).

## Part 1 — Amendments to Parts 1, 3, 4, and 4AA

**Amendments to Part 1 (preliminary)**

### 4 Section 4 amended (Overview)
After section 4(g), insert:
...
### 5 Interpretation
(1) In section 5, definition of existing works, paragraph (c), after may be, insert ; and.
(2) In section 5, definition of existing works, after paragraph (c), insert:
...
**Amendments to subpart 2 of Part 3 (amounts payable by liable persons to the Crown)**

### 7 Section 79 amended (When 2 or more bodies corporate must be treated as 1 person)
After section 79(3), insert:
...
### 8 Section 80 amended (Interpretation)
...
### 9 Section 81 amended (Subpart does not apply to certain liable persons)
Replace section 81(2)﻿(a) with:
...
### 10 New section 81A inserted (Application of subpart if non-liable person acquires assets of liable person)
After section 81, insert:Application of subpart if non-liable person acquires assets of liable person
...
### 11 Section 83 amended (Liable persons must produce information for purposes of liability allocation determination)
(1) Replace section 83(1)﻿(b) with:
  (b) either—
...
(2) Repeal section 83(2).

### 12 Section 91(2) repealed (Commission must notify final liability allocation determination before notifying TSO cost calculation determination)
Repeal section 91(2).

**Amendment to Part 4 (networks)**

### 13 Subpart 3 of Part 4 replaced
Replace subpart 3 of Part 4 with:Access to property, involving rights of multiple parties, to deploy fibre optic media and other technologyPreliminaryPurposeOverviewStatus of examplesInterpretationReferences to fibre optic media, etc, include other prescribed technologyRelationship with other statutory rights of accessNotices under this subpartNature and application of statutory rights of access under subpartHow long statutory rights of access apply forNature of statutory rights of accessGeneral preconditions for statutory rights of access to applyParticular preconditions for category 1 and category 2 installations (in properties other than body corporate administered properties)Particular preconditions before exercising statutory right of access to carry out category 1 installationParticular preconditions before exercising statutory right of access to carry out category 2 installationRequirements in respect of preliminary notice and design plan for category 2 installationsObjections to exercise of statutory right of access to carry out category 2 installationsGrounds and time for objecting to exercise of statutory right of access to carry out category 2 installationEffect of objection to exercise of statutory right of access for category 2 installationDeemed consent to category 2 installationStatutory rights of access to body corporate administered propertiesStatutory right of access to common areas of body corporate administered properties for designing installationsParticular preconditions before exercising statutory right of access to body corporate administered property for carrying out category 1 and 2 installationsRequirements in respect of preliminary notice and design plan given to body corporateGrounds and time for body corporate objecting to statutory right of access to carry out category 1 or category 2 installationFTTP service provider or network operator may extend time for body corporate objectionsEffect of body corporate objectionsRequirement for governing bodies to give unit owners reasons for objectionsDeemed consent of body corporate to category 1 or category 2 installationExercising statutory rights of access for category 1 and category 2 installationsApplication of sections 155Z to 155ZBHow statutory rights of access must be exercisedRestrictions on use of access areas during installations, reinstatements, etcObligation to reinstate propertyNon-prescribed installationsNon-prescribed installationsOngoing rights of access to installed fibre infrastructureOngoing rights of access1992 No 122 s 23(3)Conditions of ongoing rightsProtection of interests in installationsProtection of interests in installations2001 No 103 s 155 Dispute resolution processDispute resolution scheme2010 No 116 s 95FTTP service providers and network operators exercising statutory access rights must be members of dispute resolution scheme2010 No 116 s 96Disputes may be referred to dispute resolution schemeExampleThis example refers to the situation set out in the example in section 155D(1) concerning the meaning given to the term affected person.The method that the FTTP service provider has to use in order to get fibre optic media from the road to Mark’s flat via the driveway is prescribed as a category 2 installation. The FTTP service provider therefore gives the flat-owning company and each of the 2 neighbours a notice and high-level design plan that set out the information required under section 155R.Within 15 working days after receiving the notice, 1 of the neighbours objects, on the grounds that the work involved may worsen a subsidence problem in one corner of that person’s property (section 155N). The body corporate also objects, on the ground that it considers the installation will result in an unacceptable disruption to telephone services, during business hours, for other flat owners (section 155T(a)).The FTTP service provider is unable to reach an agreed settlement with either the neighbour or the body corporate concerning the validity of their objections and therefore refers each dispute to the dispute resolution scheme. After further unsuccessful attempts to settle each dispute, the FTTP service provider requests that a determination be made on each dispute under the rules of the scheme.The person determining the disputes concludes that there are no grounds for the body corporate’s objection. This determination is binding on the FTTP service provider as a member of the scheme (section 155ZJ(2)) but not on the body corporate, which can, within 5 working days of being notified of the determination, appeal against it to the District Court (sections 155ZK and 155ZL).However, the neighbour’s objection is determined to be valid, meaning that the FTTP service provider cannot exercise a statutory right of access to carry out the installation. This is binding on the FTTP service provider and it cannot appeal to the District Court (section 155ZJ(2)).The owner of Mark’s flat, as the person who placed the order for the installation, does not have a right to refer a dispute to the dispute resolution scheme, either in relation to the body corporate’s objection or in relation to the neighbour’s objection (subsection (2) of this section). Any dispute between the owner of Mark’s flat and the body corporate over the body corporate’s objection to the FTTP service provider entering the block of flats and carrying out the installation would be a matter to be resolved in accordance with the relevant provisions (if any) of the owner’s licence and the rules of the body corporate (or, if the flat is part of a unit title development instead of a company share property, in accordance with the provisions of Part 4 of the Unit Titles Act 2010).Mark does not have any right to refer a dispute to the dispute resolution scheme under this section either. He is not the person who placed the order for the installation (see section 155D(2)) and he is not an affected person (see section 155D(1)).Determinations binding on members and certain other partiesAppeals against determinationsProcedure on appealCompliance with rules, binding settlements, and determinations2010 No 116 s 97Levy for regulated dispute resolution schemeRegulations and exemptionRegulationsExemption from body corporate duties of repair and maintenanceRelationship to other enactmentsRight of access to use existing electricity works for telecommunications and deploying fibre optic cablePurposesInterpretation1992 No 122 s 23(3)Right for owners of existing works to enter land and carry out fibre optic worksFibre optic connections that owners of existing works must provide to landownersStandard connectionsNon-standard connectionsRights and obligations of owner of existing works and landowner where aerial installation not possibleVariationsThird party use of existing worksThird party use of existing works for carrying out fibre optic worksThird party request to use existing works for carrying out fibre optic worksOwner of existing works must consider requestRequirements on owner of existing works if request refusedMinister may interveneArrangements for third party to use existing worksConditions of right under section 155ZVCondition concerning communicationsCondition concerning compensationRights and obligations concerning exercise of rightsPowers and duties of owners of existing works and landownersCompensation for damage, etc1992 No 122 s 57; 2001 No 103 s 154Open access obligationsServices provided using rights under subpartPower to grant relief in respect of breach of open access obligationsUndertaking under Part 4AA overrides open access obligations under subpartRight of entry does not affect existing works owner’s rights and obligations under Electricity Act 1992Regulations
...
**Amendments to Part 4AA (services provided using networks developed with Crown funding: undertakings regime and Commerce Act 1986 authorisations)**

### 14 Section 156AB amended (Interpretation)
(1) In section 156AB, definition of relevant service, after initiative, insert ; and.
(2) In section 156AB, definition of relevant service, after paragraph (b), insert:
  (c) in subpart 7, has the same meaning as in section 156AZE
(3) In section 156AB, replace the definition of UFB initiative with:
...
### 15 Section 156AD amended (Main requirements for undertakings)
(1) In section 156AD(2)﻿(b), (c)﻿(ii), and (c)﻿(iii), replace 1 January 2020 with the specified date.
(2) After section 156AD(5), insert:
  (6) In this section,—
...
### 16 Section 156AZC amended (Restrictive trade practices authorisations in respect of participation in Ultra-fast Broadband Initiative)
After section 156AZC(2), insert:
...
### 17 Section 156AZD amended (Business acquisition authorisations in respect of participation in Ultra-fast Broadband Initiative)
(1) In section 156AZD(2), after the date on which this section comes into force, insert , except an acquisition under UFB 2.
(2) After section 156AZD(2), insert:
...
(3) After section 156AZD(3), insert:
...
### 18 New subpart 7 of Part 4AA inserted
After section 156AZD, insert:Commerce Act 1986 authorisations in respect of Rural Broadband Initiative 2 and Mobile Black Spot FundInterpretation for this subpartRestrictive trade practices authorisations in respect of transactional arrangements for RBI2 and MBSF
  In this subpart, unless the context otherwise requires,—
...
### 19 Amendment to Electricity Act 1992
...
## Part 2 — New schedules concerning transitional and related matters and dispute resolution scheme
...
### 21 New Schedule 3C inserted
After Schedule 3B, insert the Schedule 3C set out in Schedule 2 of this Act.
...
## Schedule 2 — New Schedule 3C inserted
