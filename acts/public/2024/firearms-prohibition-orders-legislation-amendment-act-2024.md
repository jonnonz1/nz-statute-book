...
In section 24A(6), repeal the definitions of—
  (a) gang; and
  (b) organised criminal group.

### 6 Section 39 replaced (Interpretation)
Replace section 39 with:Interpretation
  In this Part,—
...
(1) Replace section 39A(1)﻿(b)﻿(ii) with:
  (ii) after 15 November 2022.
(2) After section 39A(1), insert:
...
After section 39F, insert:Varying, modifying, or revoking FPOs
...
Replace section 39G with:Varying, modifying, or replacing FPO on subsequent conviction
...
Replace section 111A with:Firearms prohibition order
...
After section 18, insert:Warrantless searches associated with FPOs
