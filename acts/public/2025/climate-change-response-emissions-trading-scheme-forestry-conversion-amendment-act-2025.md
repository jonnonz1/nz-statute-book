...
(2) In section 4(1), replace the definition of permanent forestry with:
  - **permanent forestry** means an activity listed in Part 1A of Schedule 4
(3) In section 4(1), replace the definition of standard forestry with:
  - **standard forestry** means an activity listed in Part 1 of Schedule 4
(4) After section 4(7), insert:
...
In section 30M(1)﻿(a)﻿(i), replace 132(1)﻿(a), (b), and (f) to (i), with 132(1)﻿(a), (b), (ea), and (f) to (i), 133(1)﻿(ca),.
...
After section 167, insert:Regulations relating to methodologies and mapping standardsRegulations relating to LUC class 6 land permits
...
In section 181B(2)﻿(f), after under section 57, insert (but need not comply with the restriction under section 182AB).

### 13 Section 182 amended (Standard and permanent forestry on post-1989 forest land)
In section 182(1), repeal the definitions of—
  (a) permanent forestry; and
  (b) standard forestry.

### 14 New section 182AB inserted (Restriction on registration as participant in relation to restricted forest land)
After section 182A, insert:Restriction on registration as participant in relation to restricted forest land
...
After section 182C, insert:Further requirements for ETS application in respect of LUC class 1–6 unfarmed landFurther requirements for ETS application in respect of mapped land other than LUC class 1–6 landFurther requirements for ETS application if property-scale assessment of land usedRetention of property-scale assessment records
...
After section 190K, insert:The 25% allowance for restricted forest landFurther requirements for registration as participant in relation to restricted forest landMore than one 25% allowance application permittedNotification of 25% allowance to be recorded against record of titleThe 25% allowance is in addition to LUC class 6 land permitThe 25% allowance is not increased if LUC class 1–6 land area increasesLUC class 6 land permitsApplication of this subpartApplication of this subpartBallots for LUC class 6 land permitsPermit allocation in addition to 25% allowanceAnnual hectare limitBallots for LUC class 6 land permitsFirst ballotSecond ballotReallocating unused small applications hectaresBallot processConditions of eligibilityApplication ineligible if current permit includes record of titleMultiple applications with same record of title in commonRetention of property-scale assessment recordsConducting ballotReview and appeal not available for decisions about entering application into ballotIssuing permitsEffect of permit being issuedEPA may decline applicationExceeding remaining available hectaresUse of LUC class 6 land permitUsing LUC class 6 land permitPermit not transferable to other personPermit not transferable to other land or when land subdividedLUC class 6 land permit durationLUC class 6 land permit durationExtension of permit durationExpiry of LUC class 6 land permit through useHolder of LUC class 6 land permit may cancel permitEPA may report on ballotsEPA may report publicly about ballotsReview of annual hectare limitReview of annual hectare limitRegulations for changing annual hectare limit
...
In section 192B(2)﻿(f)﻿(ii), replace section 182A with sections 182A and 182AB.
