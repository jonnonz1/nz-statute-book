...
(1) In Schedule 1, replace clause 7(3)﻿(b) and (c) with:
...
(2) In Schedule 1, replace clause 7(5) with:
  (5) In this clause,—
...
(3) In Schedule 1, clause 13(1)﻿(b), replace medical practitioner with health practitioner.
