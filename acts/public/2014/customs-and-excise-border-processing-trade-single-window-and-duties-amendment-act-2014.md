...
### 2 Commencement
(1) Section 39 (which inserts section 134C of the Customs and Excise Act 1996, which imposes a duty to use the JBMS (Joint Border Management System) to supply border information) comes into force on 1 July 2016 or an earlier date appointed by the Governor-General by Order in Council.
(2) Before the date appointed for section 39 by an order, the order may be amended, revoked, or revoked and replaced.
(3) The rest of this Act comes into force on the day immediately after the expiry of the period of 3 months that starts on the date on which this Act receives the Royal assent.
...
After section 3, insert:Transitional and savings provisions relating to amendments to this Act
...
After section 21, insert:Inward cargo report
...
In section 34(a), replace outward report with advance notice of departure in each place.

### 9 New section 34AA inserted (Advance notice of departure may be provided by, or by agent of, owner or operator of craft)
After section 34, insert:Advance notice of departure may be provided by, or by agent of, owner or operator of craft
...
### 10 New section 37A inserted (Outward cargo report)
After section 37, insert:Outward cargo report
...
After section 48, insert:Transhipments: international or domesticTranshipment requests
  (1) This section applies to cargo on a craft if—
    (a) the craft—
...
In section 79A(2), replace the definition of motor spirits with:
...
Replace section 109 with:Reimportation of goods exported
...
### 16 Part 11 replaced
Replace Part 11 with:Joint Border Management System (JBMS)Joint Border Management System (JBMS) definedAccess generally restricted to registered usersApplication to be registered JBMS userChief executive must determine applicationBorder-related offence, dishonesty offence, and drugs offence definedAssignment, use, and security of unique user identifierUse of unique user identifier presumed secureConditions on registration of registered usersBorder information supplied using JBMS must be supplied in approved form and mannerCancellation or suspension of registrationCustoms must keep records of transmissions
...
(1) In section 184(1), replace a Customs computerised entry processing system with the JBMS.
...
In section 195, replace 194A with 194C.

### 26 New section 204A inserted (Offence relating to failure to update information supplied in advance)
After section 204, insert:Offence relating to failure to update information supplied in advance
...
(1) In section 282D, repeal the definition of biosecurity-related border management function, and insert in its appropriate alphabetical order:.
...
(2) In section 282D, definition of border protection purpose, paragraph (a), replace biosecurity-related with Ministry-related.
(3) In section 282D, repeal—
  (a) the definition of computer system; and
  (b) the definition of Joint Border Management System or JBMS.

### 28 Section 282E amended (Purpose of sections 282F to 282H)
(1) In section 282E, before operational, insert fully.
(2) In section 282E(b), replace biosecurity-related with Ministry-related.

### 29 Section 282I amended (Expiry of sections 282E to 282H and agreements made under section 282H)
(1) After section 282I(1), insert:
...
(2) In section 282I(2), replace implementation with full operationalisation.

### 30 New section 282JAA inserted (Application of sections 282J to 282L)
Before section 282J, insert:Application of sections 282J to 282L
...
(10) In section 288(5), replace paragraph (a), (b), (c), (g), (h), or (i) with any paragraph (except paragraph (d), (e), or (f)).

### 36 New section 306A inserted (Transitional and savings provisions relating to amendments to this Act)
After section 306, insert:Transitional and savings provisions relating to amendments to this Act
...
After section 134B (as inserted by section 16 of this Act), insert:Duty to use JBMS to supply border information to Customs
  (1) This section applies to a requirement by or under this Act to supply to the Customs any border information (as defined in section 282D).
...
## Schedule  — New Schedule 1AA of Customs and Excise Act 1996
