...
(1) After section 54(1)﻿(aa), insert:
...
(2) In section 56(2A), insert in its appropriate alphabetical order:
...
(1) In section 209(1)﻿(c), replace is knowingly with except for the conduct described in paragraph (cab), is knowingly.
(2) After section 209(1)﻿(ca), insert:
