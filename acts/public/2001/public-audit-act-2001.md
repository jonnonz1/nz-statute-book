...
When appointing an auditor under section 32 or section 33, the Auditor-General may authorise the appointed auditor to exercise such of the following powers of the Auditor-General in relation to the public entity concerned as the Auditor-General specifies:
  ...
  (c) require a public entity or other person to produce a document or to provide information under section 25:
  (d) inspect bank accounts under section 27:
...
## Schedule 1 — Classes of public entities
...
The Auditor-General must not do any of the following without the written approval of the Minister of Finance:
  (a) borrow money (as defined in section 2(1) of the Public Finance Act 1989):
